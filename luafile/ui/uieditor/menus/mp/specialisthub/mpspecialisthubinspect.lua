...
LUI.createMenu.MPSpecialistHUBInspect = function ( f1_arg0, f1_arg1 )
	...
	BackingFrame.CommonHeader.subtitle.StageTitle:setText( LocalizeToUpperString( "menu/personalization" ) )
	...
	f1_local1:AddButtonCallbackFunction( RightArrow, f1_arg0, Enum.LUIButton[0x865DD2DB1EFE9F8], "MOUSE1", function ( element, menu, controller, model )
	...
	f1_local1:AddButtonCallbackFunction( LeftArrow, f1_arg0, Enum.LUIButton[0x865DD2DB1EFE9F8], "MOUSE1", function ( element, menu, controller, model )
	...
	f1_local1:AddButtonCallbackFunction( MouseWheelFocusable, f1_arg0, Enum.LUIButton[0x865DD2DB1EFE9F8], "MWHEELUP", function ( element, menu, controller, model )
		CoD.GridAndListUtility.NavigateGridItemInChild( self.SpecialListTab, controller, "positions", false )
		return true
	end, function ( element, menu, controller )
	...
	f1_local1:AddButtonCallbackFunction( MouseWheelFocusable, f1_arg0, Enum.LUIButton[0x865DD2DB1EFE9F8], "MWHEELDOWN", function ( element, menu, controller, model )
		CoD.GridAndListUtility.NavigateGridItemInChild( self.SpecialListTab, controller, "positions", true )
		return true
	end, function ( element, menu, controller )
	...
	f1_local1:AddButtonCallbackFunction( HubWeaponsButton, f1_arg0, Enum.LUIButton[0x755DA1E2E7C263F], nil, function ( element, menu, controller, model )
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum.LUIButton[0xC083113BC81F23F], "ui_contextual_2", function ( element, menu, controller, model )
		...
		CoD.Menu.SetButtonLabel( menu, Enum.LUIButton[0xC083113BC81F23F], "menu/preview", nil, "ui_contextual_2" )
		return true
	end, false )
