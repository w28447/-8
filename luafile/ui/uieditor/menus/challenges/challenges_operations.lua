...
CoD.Challenges_Operations = InheritFrom( CoD.Menu )
LUI.createMenu.Challenges_Operations = function ( f1_arg0, f1_arg1 )
	local self = CoD.Menu.NewForUIEditor( "Challenges_Operations", f1_arg0 )
	local f1_local1 = self
	self:setClass( CoD.Challenges_Operations )
	...
	SafeAreaWidget.FETabBar.Tabs.grid:setDataSource( "OperationsTabs" )
