...
CoD.Challenges_Career = InheritFrom( CoD.Menu )
LUI.createMenu.Challenges_Career = function ( f1_arg0, f1_arg1 )
	local self = CoD.Menu.NewForUIEditor( "Challenges_Career", f1_arg0 )
	local f1_local1 = self
	self:setClass( CoD.Challenges_Career )
	...
	SafeAreaWidget.FETabBar.Tabs.grid:setDataSource( "CareerTabs" )
...
CoD.Challenges_Career.__onClose = function ( f8_arg0 )
