...
LUI.createMenu.ChallengesOperationsWZ = function ( f1_arg0, f1_arg1 )
	local self = CoD.Menu.NewForUIEditor( "ChallengesOperationsWZ", f1_arg0 )
	local f1_local1 = self
	self:setClass( CoD.ChallengesOperationsWZ )
	...
	MenuFrame.CommonHeader.subtitle.StageTitle:setText( LocalizeToUpperString( 0x2177A3C9161B05A ) )
	...
	local FETabBar = CoD.StartMenu_challengesOperationTab.new( f1_local1, f1_arg0, 0, 0, 0, 1920, 0, 0, 0, 62 )
	FETabBar.TabBacking.TabBackingBlur:setAlpha( 0 )
...
CoD.ChallengesOperationsWZ.__onClose = function ( f8_arg0 )
