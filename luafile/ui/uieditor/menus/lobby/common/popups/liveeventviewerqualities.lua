...
LUI.createMenu.LiveEventViewerQualities = function ( f1_arg0, f1_arg1 )
	...
	f1_local1:AddButtonCallbackFunction( qualityList, f1_arg0, Enum.LUIButton[0x755DA1E2E7C263F], nil, function ( element, menu, controller, model )
	...
	f1_local1:AddButtonCallbackFunction( qualityList, f1_arg0, Enum.LUIButton[0x805EFA15E9E7E5A], nil, function ( element, menu, controller, model )
		GoBack( self, controller )
		return true
	end, function ( element, menu, controller )
