...
LUI.createMenu.LobbyServerBrowserOverlay = function ( f1_arg0, f1_arg1 )
	...
	HostNameText:setText( Engine[0xF9F1239CFD921FE]( "menu/host_caps" ) )
	...
	PlayerCountText:setText( Engine[0xF9F1239CFD921FE]( "menu/numplayers_caps" ) )
	...
	GameMode:setText( Engine[0xF9F1239CFD921FE]( "menu/gametype_caps" ) )
	...
	StatusTextBox:setText( Engine[0xF9F1239CFD921FE]( "menu/status_caps" ) )
	...
	DetailsTextBox:setText( Engine[0xF9F1239CFD921FE]( "menu/details_caps" ) )
	...
	HeaderPixelGridTiledBackingL:setImage( RegisterImage( "uie_ui_hud_notifications_pixelpattern" ) )
	...
	HeaderPixelGridTiledBackingR:setImage( RegisterImage( "uie_ui_hud_notifications_pixelpattern" ) )
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum.LUIButton[0xE6DB407A2AF8B09], nil, function ( element, menu, controller, model )
		...
		CoD.Menu.SetButtonLabel( menu, Enum.LUIButton[0xE6DB407A2AF8B09], "menu/refresh_caps", nil, nil )
		return true
	end, false )
