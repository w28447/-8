...
CoD.PurchaseContractConfirmation = InheritFrom( CoD.Menu )
LUI.createMenu.PurchaseContractConfirmation = function ( f1_arg0, f1_arg1 )
	local self = CoD.Menu.NewForUIEditor( "PurchaseContractConfirmation", f1_arg0 )
	...
	self:setClass( CoD.PurchaseContractConfirmation )
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum.LUIButton[0x755DA1E2E7C263F], nil, function ( f23_arg0, f23_arg1, f23_arg2, f23_arg3 )
		...
		if IsElementInState( self.FullscreenPopupTemplate, "FinishedState" ) then
			...
			return true
		elseif IsElementInState( self.FullscreenPopupTemplate, "ErrorState" ) then
			CoD.Menu.SetButtonLabel( f24_arg1, Enum.LUIButton[0x755DA1E2E7C263F], 0x70A9FDC87CD3D48, nil, nil )
			return true
		elseif not IsElementInState( self.FullscreenPopupTemplate, "WorkingState" ) and not MenuPropertyIsTrue( f24_arg1, "__keepPopupButtonListPC" ) then
			CoD.Menu.SetButtonLabel( f24_arg1, Enum.LUIButton[0x755DA1E2E7C263F], 0x85952ACC6D0C1B0, nil, nil )
			return true
		else
			return false
		end
...
CoD.PurchaseContractConfirmation.__onClose = function ( f27_arg0 )
