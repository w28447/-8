...
LUI.createMenu.WZPersonalizeCharacterMain = function ( f1_arg0, f1_arg1 )
	...
	CommonInformationFrame.altHeader:setText( Engine[0xF9F1239CFD921FE]( 0x93E719493E9E18F ) )
	CommonInformationFrame.header:setText( LocalizeToUpperString( 0x93E719493E9E18F ) )
	CommonInformationFrame.description:setText( Engine[0xF9F1239CFD921FE]( 0x93E719493E9E18F ) )
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum.LUIButton[0x805EFA15E9E7E5A], "ESCAPE", function ( f6_arg0, f6_arg1, f6_arg2, f6_arg3 )
		...
		CoD.Menu.SetButtonLabel( f7_arg1, Enum.LUIButton[0x805EFA15E9E7E5A], 0x70A9FDC87CD3D48, nil, "ESCAPE" )
		return true
	end, false )
