...
require( "ui/uieditor/widgets/aar_t8/tierreward/aartierskipnotification" )
...
LUI.createMenu.AARTierReward = function ( f1_arg0, f1_arg1 )
	...
	NoiseTiledBackingLeft:setImage( RegisterImage( "uie_ui_menu_specialist_hub_repeat_bg" ) )
	...
	BlackMarketIcon:setImage( RegisterImage( "ui_icon_blackmarket_lockskull_256" ) )
	...
	Rewards:setText( Engine[0xF9F1239CFD921FE]( "menu/black_market" ) )
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum.LUIButton[0x755DA1E2E7C263F], "ui_confirm", function ( f25_arg0, f25_arg1, f25_arg2, f25_arg3 )
		...
		CoD.Menu.SetButtonLabel( f26_arg1, Enum.LUIButton[0x755DA1E2E7C263F], "menu/continue", nil, "ui_confirm" )
		return true
	end, false )
