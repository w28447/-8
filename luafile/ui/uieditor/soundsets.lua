SoundSet = {
	...
	default = {
		...
		list_action = "uin_list_action_generic",
		menu_go_back = "uin_cmn_backout",
		list_up = "uin_list_vertical_generic",
		list_down = "uin_list_vertical_generic",
		list_left = "uin_list_horizontal_generic",
		list_right = "uin_list_horizontal_generic",
		partyease_slide_left = "uin_party_ease_slide",
		partyease_slide_right = "uin_party_ease_slide_back",
		toggle = "uin_toggle_generic",
		...
		value_changed = "uin_toggle_generic",
		wheel_action = "uin_radial_confirm",
		wheel_changed = "uin_radial_scroll"
	},
	FrontendMain = {
		action = "cac_grid_equip_item",
		gain_focus = "cac_grid_nav",
		list_action = "uin_list_action_generic",
		menu_go_back = "uin_cmn_backout",
		list_up = "cac_grid_nav",
		list_down = "cac_grid_nav",
		list_left = "cac_grid_nav",
		list_right = "cac_grid_nav",
		partyease_slide_left = "uin_party_ease_slide",
		partyease_slide_right = "uin_party_ease_slide_back",
		toggle = "uin_toggle_generic",
		value_changed = "cac_grid_nav"
	},
	ModeSelection = {
	...
	MultiplayerMain = {
		...
		menu_open = "uin_menu_selection",
		gain_focus = "cac_grid_nav",
		action = "uin_menu_action",
	...
	CAC = {
		...
		list_up = "uin_cac_wc_browse",
		list_down = "uin_cac_wc_browse",
		list_action = "cac_main_edit_loadout",
		menu_sub = "cac_open_wpn_cust_sub",
		menu_open = "uin_party_ease_slide",
		action = "uin_party_ease_slide",
		list_action = "uin_select",
		gain_focus = "uin_cac_wc_browse",
		list_left = "uin_cac_wc_browse",
		list_right = "uin_cac_wc_browse",
		menu_go_back = "uin_cmn_backout"
	},
	ZCAC = {
		gain_focus = "cac_grid_nav",
		...
		list_action = "uin_select",
		menu_go_back = "uin_cmn_backout",
		menu_open = "uin_zcac_menu_open",
		list_up = "cac_slide_nav_ud",
		list_down = "cac_slide_nav_ud",
		list_left = "cac_slide_nav",
		list_right = "cac_slide_nav"
	},
	Loadout = {
		...
		list_left = "cac_main_nav",
		list_right = "cac_main_nav"
	},
	CAC_EditLoadout = {
...
SoundSet.CAC_PrimaryWeapon.equip_item = "uin_cac_menu_open"
...
SoundSet.CAC_PrimaryWeapon.menu_no_selection = "uin_cmn_backout"
SoundSet.CAC_PrimaryWeapon.menu_open = "uin_cac_menu_open"
...
SoundSet.CAC_Gear = LUI.ShallowCopy( SoundSet.CAC_SubMenu )
SoundSet.CAC_Gear.menu_open = "uin_cac_menu_open_2"
SoundSet.CAC_EquipmentTakeTwo = LUI.ShallowCopy( SoundSet.CAC_SubMenu )
SoundSet.CAC_EquipmentTakeTwo.equip_item = "uin_cac_wpn_base"
SoundSet.CAC_EquipmentTakeTwo.unequip_item = "uin_equipment_remove"
...
SoundSet.CAC_WeaponPersonalization = LUI.ShallowCopy( SoundSet.Loadout )
SoundSet.CAC_WeaponPersonalization.menu_open = "cac_grid_equip_item"
SoundSet.CAC_WeaponPersonalization.equip_item = "cac_equipment_add"
SoundSet.BootMenu = {
	menu_open = "uin_hud_bootup_display"
}
SoundSet.ItemShop = {
	focus_common = "uin_mtx_grid_nav_common",
	focus_rare = "uin_mtx_grid_nav_rare",
	focus_legendary = "uin_mtx_grid_nav_legend",
	focus_epic = "uin_mtx_grid_nav_epic",
	focus_ultra = "uin_mtx_grid_nav_ultra",
	gain_focus = "cac_grid_nav",
	list_up = "cac_grid_nav",
	list_down = "cac_grid_nav",
	list_left = "cac_grid_nav",
