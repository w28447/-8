...
CoD.InspectionGamerCardWidget.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	FELabelSubHeadingE0:setBackingImage( RegisterImage( "uie_t7_menu_frontend_listsubheadpanelfull" ) )
	...
	FELabelSubHeadingE1:setBackingImage( RegisterImage( "uie_t7_menu_frontend_listsubheadpanelfull" ) )
