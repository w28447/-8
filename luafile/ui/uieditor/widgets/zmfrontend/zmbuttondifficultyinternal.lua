...
CoD.ZMButtonDifficultyInternal.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	FocusGlow:setImage( RegisterImage( "uie_ui_menu_common_focus_glow_smaller" ) )
...
CoD.ZMButtonDifficultyInternal.__clipsPerState = {
	...
	Locked = {
		...
		Focus = function ( f28_arg0, f28_arg1 )
			...
			f28_arg0.ImageNotFocus:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_saturation_normal" ) )
		...
		LoseFocus = function ( f33_arg0, f33_arg1 )
			...
			f33_arg0.ImageNotFocus:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_saturation_normal" ) )
