CoD.AARTierRewardItemGlowAnimationRare = InheritFrom( LUI.UIElement )
CoD.AARTierRewardItemGlowAnimationRare.__defaultWidth = 310
CoD.AARTierRewardItemGlowAnimationRare.__defaultHeight = 631
CoD.AARTierRewardItemGlowAnimationRare.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.AARTierRewardItemGlowAnimationRare )
	self.id = "AARTierRewardItemGlowAnimationRare"
	self.soundSet = "none"
	...
	DotPattern:linkToElementModel( self, "rarity", true, function ( model )
		...
		if f6_local0 ~= nil then
			DotPattern:setRGB( CoD.BlackMarketUtility.LootRarityToColorBright( f6_local0 ) )
		end
	end )
	...
	DotPattern2:linkToElementModel( self, "rarity", true, function ( model )
		...
		if f7_local0 ~= nil then
			DotPattern2:setRGB( CoD.BlackMarketUtility.LootRarityToColor( f7_local0 ) )
		end
	end )
	self:addElement( DotPattern2 )
	self.DotPattern2 = DotPattern2
...
CoD.AARTierRewardItemGlowAnimationRare.__resetProperties = function ( f8_arg0 )
	...
	f8_arg0.DotPattern:completeAnimation()
	f8_arg0.DotPattern2:completeAnimation()
	...
	f8_arg0.DotPattern:setAlpha( 0 )
	f8_arg0.DotPattern:setScale( 1, 1 )
	f8_arg0.DotPattern2:setAlpha( 0 )
	f8_arg0.DotPattern2:setScale( 3, 3 )
end
			...
			local f10_local4 = function ( f20_arg0 )
				local f20_local0 = function ( f21_arg0 )
					local f21_local0 = function ( f22_arg0 )
						f22_arg0:beginAnimation( 120, Enum[0xF50FFF429AB1890][0x6F6186B702830BC] )
						f22_arg0:setAlpha( 0 )
						f22_arg0:setScale( 3, 3 )
						f22_arg0:registerEventHandler( "transition_complete_keyframe", f10_arg0.clipFinished )
					end
					
					f21_arg0:beginAnimation( 40, Enum[0xF50FFF429AB1890][0x6F6186B702830BC] )
					f21_arg0:setAlpha( 1 )
					f21_arg0:setScale( 1.5, 1.5 )
					f21_arg0:registerEventHandler( "transition_complete_keyframe", f21_local0 )
				end
				
				f10_arg0.DotPattern:beginAnimation( 40 )
				f10_arg0.DotPattern:registerEventHandler( "interrupted_keyframe", f10_arg0.clipInterrupted )
				f10_arg0.DotPattern:registerEventHandler( "transition_complete_keyframe", f20_local0 )
			end
			
			f10_arg0.DotPattern:completeAnimation()
			f10_arg0.DotPattern:setAlpha( 0 )
			f10_arg0.DotPattern:setScale( 1, 1 )
			f10_local4( f10_arg0.DotPattern )
			local f10_local5 = function ( f23_arg0 )
				local f23_local0 = function ( f24_arg0 )
					f24_arg0:beginAnimation( 400, Enum[0xF50FFF429AB1890][0x6F6186B702830BC] )
					f24_arg0:setAlpha( 0 )
					f24_arg0:setScale( 3, 3 )
					f24_arg0:registerEventHandler( "transition_complete_keyframe", f10_arg0.clipFinished )
				end
				
				f23_arg0:beginAnimation( 280, Enum[0xF50FFF429AB1890][0x6F6186B702830BC] )
				f23_arg0:setAlpha( 1 )
				f23_arg0:setScale( 1.82, 1.82 )
				f23_arg0:registerEventHandler( "transition_complete_keyframe", f23_local0 )
			end
			
			f10_arg0.DotPattern2:beginAnimation( 40 )
			f10_arg0.DotPattern2:setAlpha( 0 )
			f10_arg0.DotPattern2:setScale( 1, 1 )
			f10_arg0.DotPattern2:registerEventHandler( "interrupted_keyframe", f10_arg0.clipInterrupted )
			f10_arg0.DotPattern2:registerEventHandler( "transition_complete_keyframe", f10_local5 )
		end
	}
}
CoD.AARTierRewardItemGlowAnimationRare.__onClose = function ( f25_arg0 )
	...
	f25_arg0.DotPattern:close()
	f25_arg0.DotPattern2:close()
end
