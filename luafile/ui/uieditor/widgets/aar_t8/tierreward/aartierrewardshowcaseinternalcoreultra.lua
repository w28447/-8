require( "ui/uieditor/widgets/aar_t8/tierreward/aartierrewardparticle" )

CoD.AARTierRewardShowcaseInternalCoreUltra = InheritFrom( LUI.UIElement )
CoD.AARTierRewardShowcaseInternalCoreUltra.__defaultWidth = 310
CoD.AARTierRewardShowcaseInternalCoreUltra.__defaultHeight = 632
CoD.AARTierRewardShowcaseInternalCoreUltra.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.AARTierRewardShowcaseInternalCoreUltra )
	self.id = "AARTierRewardShowcaseInternalCoreUltra"
	self.soundSet = "none"
	self.anyChildUsesUpdateState = true
	f1_arg0:addElementToPendingUpdateStateList( self )
	
	local Particle = CoD.AARTierRewardParticle.new( f1_arg0, f1_arg1, 0, 0, -41, 350, 0, 0, -1, 629 )
	Particle:setRGB( ColorSet.BlackMarketUltra.r, ColorSet.BlackMarketUltra.g, ColorSet.BlackMarketUltra.b )
	Particle:setAlpha( 0.73 )
	Particle:setScale( 0.85, 0.85 )
	self:addElement( Particle )
	self.Particle = Particle
	
	local CardUltraMain = LUI.UIImage.new( 0.5, 0.5, -176, 176, 0.5, 0.5, -336, 336 )
	CardUltraMain:setImage( RegisterImage( "uie_ui_menu_mtx_card_ultra_main" ) )
	self:addElement( CardUltraMain )
	self.CardUltraMain = CardUltraMain
	
	local BGPatternThick = LUI.UIImage.new( 0.5, 0.5, -176, 176, 0.5, 0.5, -336, 336 )
	BGPatternThick:setAlpha( 0.62 )
	BGPatternThick:setImage( RegisterImage( "uie_ui_menu_common_mtx_button_bg_ultra_thick" ) )
	...
	GlowRimThinAdd:setImage( RegisterImage( "uie_ui_menu_mtx_button_glow_rim_thin01" ) )
	...
	GlowRimThick:setImage( RegisterImage( "uie_ui_menu_mtx_button_glow_rim_thick01" ) )
	...
	GlowRimThick2:setImage( RegisterImage( "uie_ui_menu_mtx_button_glow_rim_thick01" ) )
	...
	CornerGlowTL:setImage( RegisterImage( "uie_ui_menu_mtx_button_glow_corner" ) )
	...
	CornerGlowTL2:setImage( RegisterImage( "uie_ui_menu_mtx_button_glow_corner" ) )
	...
	CornerGlowBR:setImage( RegisterImage( "uie_ui_menu_mtx_button_glow_corner" ) )
	...
	CornerGlowBR2:setImage( RegisterImage( "uie_ui_menu_mtx_button_glow_corner" ) )
	...
	GlowRimBorder:setAlpha( 0.15 )
	GlowRimBorder:setXRot( 180 )
	GlowRimBorder:setImage( RegisterImage( "uie_ui_menu_mtx_button_glow_rim_thick01" ) )
	...
	GlowRimBorder:linkToElementModel( self, "rarity", true, function ( model )
		...
		if f10_local0 ~= nil then
			GlowRimBorder:setRGB( CoD.BlackMarketUtility.LootRarityToColor( f10_local0 ) )
		end
	end )
...
CoD.AARTierRewardShowcaseInternalCoreUltra.__resetProperties = function ( f11_arg0 )
	...
	f11_arg0.Particle:completeAnimation()
...
CoD.AARTierRewardShowcaseInternalCoreUltra.__clipsPerState = {
	DefaultState = {
		DefaultClip = function ( f12_arg0, f12_arg1 )
			...
			f12_arg0.Particle:completeAnimation()
			f12_arg0.Particle:playClip( "DefaultClip" )
			f12_arg0.clipFinished( f12_arg0.Particle )
			local f12_local0 = function ( f13_arg0 )
				local f13_local0 = function ( f14_arg0 )
					local f14_local0 = function ( f15_arg0 )
						f15_arg0:beginAnimation( 3010, Enum[0xF50FFF429AB1890][0x6F6186B702830BC] )
						f15_arg0:setAlpha( 0 )
						f15_arg0:registerEventHandler( "transition_complete_keyframe", f12_arg0.clipFinished )
					end
					
					f14_arg0:beginAnimation( 500 )
					f14_arg0:setShaderVector( 2, 0, 1, 0, 0 )
					f14_arg0:setShaderVector( 3, 0, 0, 0, 0 )
					f14_arg0:registerEventHandler( "transition_complete_keyframe", f14_local0 )
				end
				
				f12_arg0.BGPatternThick:beginAnimation( 1500 )
				f12_arg0.BGPatternThick:setShaderVector( 2, 0, 0.75, 0, 0 )
				f12_arg0.BGPatternThick:setShaderVector( 3, 0, 0.12, 0, 0 )
				...
				local f16_local0 = function ( f17_arg0 )
					local f17_local0 = function ( f18_arg0 )
						local f18_local0 = function ( f19_arg0 )
							f19_arg0:beginAnimation( 2000, Enum[0xF50FFF429AB1890][0x6F6186B702830BC] )
							f19_arg0:setAlpha( 0 )
				...
				local f20_local0 = function ( f21_arg0 )
					local f21_local0 = function ( f22_arg0 )
						local f22_local0 = function ( f23_arg0 )
							f23_arg0:beginAnimation( 2000, Enum[0xF50FFF429AB1890][0x6F6186B702830BC] )
							f23_arg0:setAlpha( 0 )
				...
				local f24_local0 = function ( f25_arg0 )
					local f25_local0 = function ( f26_arg0 )
						local f26_local0 = function ( f27_arg0 )
							f27_arg0:beginAnimation( 2000, Enum[0xF50FFF429AB1890][0x6F6186B702830BC] )
							f27_arg0:setAlpha( 0 )
