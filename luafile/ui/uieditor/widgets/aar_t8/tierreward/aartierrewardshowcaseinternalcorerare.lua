CoD.AARTierRewardShowcaseInternalCoreRare = InheritFrom( LUI.UIElement )
CoD.AARTierRewardShowcaseInternalCoreRare.__defaultWidth = 310
CoD.AARTierRewardShowcaseInternalCoreRare.__defaultHeight = 632
CoD.AARTierRewardShowcaseInternalCoreRare.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.AARTierRewardShowcaseInternalCoreRare )
	self.id = "AARTierRewardShowcaseInternalCoreRare"
	self.soundSet = "none"
	f1_arg0:addElementToPendingUpdateStateList( self )
	
	local CardRareMain = LUI.UIImage.new( 0.5, 0.5, -176, 176, 0.5, 0.5, -336, 336 )
	CardRareMain:setImage( RegisterImage( "uie_ui_menu_mtx_card_rare_main" ) )
	self:addElement( CardRareMain )
	self.CardRareMain = CardRareMain
	...
	GlowRimThickBorder:setAlpha( 0.08 )
	GlowRimThickBorder:setXRot( 180 )
	GlowRimThickBorder:setImage( RegisterImage( "uie_ui_menu_mtx_button_glow_rim_thick01" ) )
...
CoD.AARTierRewardShowcaseInternalCoreRare.__resetProperties = function ( f11_arg0 )
...
CoD.AARTierRewardShowcaseInternalCoreRare.__clipsPerState = {
	DefaultState = {
			...
			local f12_local0 = function ( f13_arg0 )
				local f13_local0 = function ( f14_arg0 )
					local f14_local0 = function ( f15_arg0 )
						f15_arg0:beginAnimation( 8000 )
						f15_arg0:setAlpha( 0 )
						f15_arg0:setShaderVector( 2, 0, 1, 0, 0 )
						f15_arg0:setShaderVector( 3, 0, 0, 0, 0 )
						f15_arg0:registerEventHandler( "transition_complete_keyframe", f12_arg0.clipFinished )
					end
					
					f14_arg0:beginAnimation( 500 )
					f14_arg0:setAlpha( 0.71 )
					f14_arg0:setShaderVector( 2, 1, 1, 0, 0 )
					f14_arg0:setShaderVector( 3, 0, 0.1, 0, 0 )
...
CoD.AARTierRewardShowcaseInternalCoreRare.__onClose = function ( f40_arg0 )
