CoD.AARTierRewardItemGlowAnimationEpic = InheritFrom( LUI.UIElement )
CoD.AARTierRewardItemGlowAnimationEpic.__defaultWidth = 310
CoD.AARTierRewardItemGlowAnimationEpic.__defaultHeight = 631
CoD.AARTierRewardItemGlowAnimationEpic.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.AARTierRewardItemGlowAnimationEpic )
	self.id = "AARTierRewardItemGlowAnimationEpic"
	self.soundSet = "none"
	...
	fx:linkToElementModel( self, "rarity", true, function ( model )
		...
		if f6_local0 ~= nil then
			fx:setRGB( CoD.BlackMarketUtility.LootRarityToColorBright( f6_local0 ) )
		end
	end )
	self:addElement( fx )
	self.fx = fx
	...
	fx2:linkToElementModel( self, "rarity", true, function ( model )
		...
		if f7_local0 ~= nil then
			fx2:setRGB( CoD.BlackMarketUtility.LootRarityToColor( f7_local0 ) )
		end
	end )
	self:addElement( fx2 )
	self.fx2 = fx2
...
CoD.AARTierRewardItemGlowAnimationEpic.__resetProperties = function ( f8_arg0 )
...
CoD.AARTierRewardItemGlowAnimationEpic.__clipsPerState = {
	DefaultState = {
		...
		Trigger = function ( f10_arg0, f10_arg1 )
			...
			local f10_local4 = function ( f20_arg0 )
				local f20_local0 = function ( f21_arg0 )
					local f21_local0 = function ( f22_arg0 )
						f22_arg0:beginAnimation( 160, Enum[0xF50FFF429AB1890][0x6F6186B702830BC] )
						f22_arg0:setAlpha( 0 )
						f22_arg0:setScale( 2, 2 )
						f22_arg0:registerEventHandler( "transition_complete_keyframe", f10_arg0.clipFinished )
					end
					
					f21_arg0:beginAnimation( 80, Enum[0xF50FFF429AB1890][0x6F6186B702830BC] )
					f21_arg0:setAlpha( 0.5 )
					f21_arg0:setScale( 1.33, 1.33 )
			...
			local f10_local5 = function ( f23_arg0 )
				local f23_local0 = function ( f24_arg0 )
					f24_arg0:beginAnimation( 160, Enum[0xF50FFF429AB1890][0x6F6186B702830BC] )
					f24_arg0:setAlpha( 0 )
					f24_arg0:setScale( 2.5, 2.5 )
					f24_arg0:registerEventHandler( "transition_complete_keyframe", f10_arg0.clipFinished )
				end
				
				f23_arg0:beginAnimation( 80, Enum[0xF50FFF429AB1890][0x6F6186B702830BC] )
				f23_arg0:setAlpha( 0.5 )
				f23_arg0:setScale( 1.5, 1.5 )
				f23_arg0:registerEventHandler( "transition_complete_keyframe", f23_local0 )
			end
			
			f10_arg0.fx2:beginAnimation( 200 )
			...
			f10_arg0.fx2:registerEventHandler( "transition_complete_keyframe", f10_local5 )
		end
	}
}
CoD.AARTierRewardItemGlowAnimationEpic.__onClose = function ( f25_arg0 )
