...
require( "ui/uieditor/widgets/aar_t8/tierreward/aartierrewarditemglowanimationlegendary" )
...
CoD.AARTierRewardShowcaseInternalLegendary = InheritFrom( LUI.UIElement )
CoD.AARTierRewardShowcaseInternalLegendary.__defaultWidth = 310
CoD.AARTierRewardShowcaseInternalLegendary.__defaultHeight = 632
CoD.AARTierRewardShowcaseInternalLegendary.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.AARTierRewardShowcaseInternalLegendary )
	self.id = "AARTierRewardShowcaseInternalLegendary"
	self.soundSet = "none"
	...
	local GlowAnim = CoD.AARTierRewardItemGlowAnimationLegendary.new( f1_arg0, f1_arg1, 0, 1, 0, 0, 0, 1, 0, 0 )
	GlowAnim:setRGB( ColorSet.BlackMarketLegendaryBright.r, ColorSet.BlackMarketLegendaryBright.g, ColorSet.BlackMarketLegendaryBright.b )
	...
	self:mergeStateConditions( {
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if not CoD.ModelUtility.IsSelfModelValueTrue( element, f1_arg1, "unlocked" ) then
					f11_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "rarity", Enum.LootRarityType[0x35E4133DEF6B806] )
				else
					f11_local0 = false
				end
				return f11_local0
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if f12_local0 then
					f12_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "rarity", Enum.LootRarityType[0x35E4133DEF6B806] )
					if f12_local0 then
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if f13_local0 then
					f13_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "rarity", Enum.LootRarityType[0x35E4133DEF6B806] )
					if f13_local0 then
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if f14_local0 then
					f14_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "rarity", Enum.LootRarityType[0x35E4133DEF6B806] )
					if f14_local0 then
...
CoD.AARTierRewardShowcaseInternalLegendary.__resetProperties = function ( f21_arg0 )
	f21_arg0.BGWidgetLegendary:completeAnimation()
	...
	f21_arg0.BGWidgetLegendary:setAlpha( 1 )
	f21_arg0.BGWidgetLegendary:setScale( 1, 1 )
...
CoD.AARTierRewardShowcaseInternalLegendary.__clipsPerState = {
	...
	Empty = {
		DefaultClip = function ( f23_arg0, f23_arg1 )
			...
			f23_arg0.BGWidgetLegendary:completeAnimation()
			f23_arg0.BGWidgetLegendary:setAlpha( 0 )
			f23_arg0.clipFinished( f23_arg0.BGWidgetLegendary )
	...
	Locked = {
		DefaultClip = function ( f24_arg0, f24_arg1 )
			...
			f24_arg0.BGWidgetLegendary:completeAnimation()
			f24_arg0.BGWidgetLegendary:setAlpha( 0 )
			f24_arg0.clipFinished( f24_arg0.BGWidgetLegendary )
		...
		DefaultState = function ( f25_arg0, f25_arg1 )
			...
			local f25_local0 = function ( f26_arg0 )
				...
				f25_arg0.BGWidgetLegendary:playClip( "DefaultClip" )
				f25_arg0.BGWidgetLegendary:beginAnimation( 200 )
				f25_arg0.BGWidgetLegendary:setAlpha( 0.67 )
				f25_arg0.BGWidgetLegendary:setScale( 0.8, 0.8 )
				f25_arg0.BGWidgetLegendary:registerEventHandler( "interrupted_keyframe", f25_arg0.clipInterrupted )
				f25_arg0.BGWidgetLegendary:registerEventHandler( "transition_complete_keyframe", f26_local0 )
			end
			
			f25_arg0.BGWidgetLegendary:completeAnimation()
			f25_arg0.BGWidgetLegendary:setAlpha( 0 )
			f25_arg0.BGWidgetLegendary:setScale( 4, 4 )
			f25_local0( f25_arg0.BGWidgetLegendary )
			...
			f25_arg0.Sound:playSound( "uin_mtx_item_get_legend", f25_arg1 )
			...
			f25_arg0.GlowAnim:beginAnimation( 200 )
		...
		Contraband = function ( f32_arg0, f32_arg1 )
			...
			f32_arg0.ContrabandFull:setAlpha( 1 )
			...
			local f32_local1 = function ( f37_arg0 )
				...
				f32_arg0.BGWidgetLegendary:beginAnimation( 790 )
				f32_arg0.BGWidgetLegendary:registerEventHandler( "interrupted_keyframe", f32_arg0.clipInterrupted )
				f32_arg0.BGWidgetLegendary:registerEventHandler( "transition_complete_keyframe", f37_local0 )
			end
			
			f32_arg0.BGWidgetLegendary:completeAnimation()
			f32_arg0.BGWidgetLegendary:setAlpha( 0 )
			f32_local1( f32_arg0.BGWidgetLegendary )
			...
			f32_arg0.Sound:playSound( "uin_mtx_item_get_legend", f32_arg1 )
		...
		Reroll = function ( f42_arg0, f42_arg1 )
			...
			local f42_local1 = function ( f48_arg0 )
				...
				f42_arg0.BGWidgetLegendary:beginAnimation( 130 )
				f42_arg0.BGWidgetLegendary:registerEventHandler( "interrupted_keyframe", f42_arg0.clipInterrupted )
				f42_arg0.BGWidgetLegendary:registerEventHandler( "transition_complete_keyframe", f48_local0 )
			end
			
			f42_arg0.BGWidgetLegendary:completeAnimation()
			f42_arg0.BGWidgetLegendary:setAlpha( 0 )
			f42_local1( f42_arg0.BGWidgetLegendary )
		...
		Dupe = function ( f58_arg0, f58_arg1 )
			...
			local f58_local0 = function ( f59_arg0 )
				...
				f58_arg0.BGWidgetLegendary:beginAnimation( 130 )
				f58_arg0.BGWidgetLegendary:registerEventHandler( "interrupted_keyframe", f58_arg0.clipInterrupted )
				f58_arg0.BGWidgetLegendary:registerEventHandler( "transition_complete_keyframe", f59_local0 )
			end
			
			f58_arg0.BGWidgetLegendary:completeAnimation()
			f58_arg0.BGWidgetLegendary:setAlpha( 0 )
			f58_local0( f58_arg0.BGWidgetLegendary )
...
CoD.AARTierRewardShowcaseInternalLegendary.__onClose = function ( f69_arg0 )
	...
	f69_arg0.BGWidgetLegendary:close()
