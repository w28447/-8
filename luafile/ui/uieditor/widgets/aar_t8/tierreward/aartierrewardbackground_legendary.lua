CoD.AARTierRewardBackground_Legendary = InheritFrom( LUI.UIElement )
CoD.AARTierRewardBackground_Legendary.__defaultWidth = 600
CoD.AARTierRewardBackground_Legendary.__defaultHeight = 600
CoD.AARTierRewardBackground_Legendary.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.AARTierRewardBackground_Legendary )
	self.id = "AARTierRewardBackground_Legendary"
	self.soundSet = "none"
...
CoD.AARTierRewardBackground_Legendary.__onClose = function ( f7_arg0 )
