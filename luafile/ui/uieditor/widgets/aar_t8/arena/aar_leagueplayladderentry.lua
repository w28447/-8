...
CoD.AAR_LeaguePlayLadderEntry.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	RubiesDotBg:setImage( RegisterImage( 0x4B6FFA90272070E ) )
	...
	PointsDotBg:setImage( RegisterImage( 0x4B6FFA90272070E ) )
	...
	NameDotBg:setImage( RegisterImage( 0x4B6FFA90272070E ) )
	...
	RankMovementDotBg:setImage( RegisterImage( 0x4B6FFA90272070E ) )
	...
	RankDotBg:setImage( RegisterImage( 0x4B6FFA90272070E ) )
	...
	Tied:setAlpha( 0 )
	Tied:setText( LocalizeToUpperString( 0x93E719493E9E18F ) )
