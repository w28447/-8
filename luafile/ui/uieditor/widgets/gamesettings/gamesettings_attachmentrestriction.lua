...
CoD.GameSettings_AttachmentRestriction.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	f1_arg0:AddButtonCallbackFunction( AttachRestrictionCategoriesPC, f1_arg1, Enum.LUIButton[0x755DA1E2E7C263F], "ui_confirm", function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( AttachRestrictionCategoriesPC, f1_arg1, Enum.LUIButton[0x805EFA15E9E7E5A], nil, function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( OptionCategoryGrid, f1_arg1, Enum.LUIButton[0x755DA1E2E7C263F], nil, function ( element, menu, controller, model )
		...
		CoD.OptionsUtility.SetCurrentAttachmentCategoryIndex( element )
		CoD.OptionsUtility.SetFocusToAttachmentOptionsList( self, controller )
		return true
	end, function ( element, menu, controller )
