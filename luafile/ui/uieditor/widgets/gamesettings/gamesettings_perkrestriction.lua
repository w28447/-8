...
CoD.GameSettings_PerkRestriction = InheritFrom( LUI.UIElement )
CoD.GameSettings_PerkRestriction.__defaultWidth = 1920
CoD.GameSettings_PerkRestriction.__defaultHeight = 877
CoD.GameSettings_PerkRestriction.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.GameSettings_PerkRestriction )
	self.id = "GameSettings_PerkRestriction"
	self.soundSet = "none"
	...
	OptionCategoryGrid:setDataSource( "PerkRestrictionOptionCategories" )
...
CoD.GameSettings_PerkRestriction.__onClose = function ( f13_arg0 )
