...
CoD.GameSettings_WildcardRestriction = InheritFrom( LUI.UIElement )
CoD.GameSettings_WildcardRestriction.__defaultWidth = 1920
CoD.GameSettings_WildcardRestriction.__defaultHeight = 877
CoD.GameSettings_WildcardRestriction.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.GameSettings_WildcardRestriction )
	self.id = "GameSettings_WildcardRestriction"
	self.soundSet = "none"
	...
	OptionCategoryGrid:setDataSource( "WildcardRestrictionOptionCategories" )
...
CoD.GameSettings_WildcardRestriction.__onClose = function ( f13_arg0 )
