...
CoD.GameSettings_ZMGeneral = InheritFrom( LUI.UIElement )
CoD.GameSettings_ZMGeneral.__defaultWidth = 1920
CoD.GameSettings_ZMGeneral.__defaultHeight = 877
CoD.GameSettings_ZMGeneral.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.GameSettings_ZMGeneral )
	self.id = "GameSettings_ZMGeneral"
	self.soundSet = "none"
	...
	OptionCategoryGrid:setDataSource( "ZMGeneralOptionCategories" )
...
CoD.GameSettings_ZMGeneral.__resetProperties = function ( f18_arg0 )
...
CoD.GameSettings_ZMGeneral.__clipsPerState = {
	DefaultState = {
...
CoD.GameSettings_ZMGeneral.__onClose = function ( f22_arg0 )
