...
CoD.GameSettings_ZMPlayer = InheritFrom( LUI.UIElement )
CoD.GameSettings_ZMPlayer.__defaultWidth = 1920
CoD.GameSettings_ZMPlayer.__defaultHeight = 877
CoD.GameSettings_ZMPlayer.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.GameSettings_ZMPlayer )
	self.id = "GameSettings_ZMPlayer"
	self.soundSet = "none"
	...
	OptionCategoryGrid:setDataSource( "ZMPlayerOptionCategories" )
...
CoD.GameSettings_ZMPlayer.__resetProperties = function ( f18_arg0 )
...
CoD.GameSettings_ZMPlayer.__clipsPerState = {
	DefaultState = {
...
CoD.GameSettings_ZMPlayer.__onClose = function ( f22_arg0 )
