...
CoD.GameSettings_ZMSystems = InheritFrom( LUI.UIElement )
CoD.GameSettings_ZMSystems.__defaultWidth = 1920
CoD.GameSettings_ZMSystems.__defaultHeight = 877
CoD.GameSettings_ZMSystems.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.GameSettings_ZMSystems )
	self.id = "GameSettings_ZMSystems"
	self.soundSet = "none"
	...
	local OptionCategoryGrid = LUI.GridLayout.new( f1_arg0, f1_arg1, false, 0, 0, 2, 0, nil, nil, false, false, false, true )
	...
	OptionCategoryGrid:setVerticalCounter( CoD.verticalCounter )
	OptionCategoryGrid:setDataSource( "ZMSystemsOptionCategories" )
	...
	CoD.GridAndListUtility.SetGridScrolling( f1_arg0, OptionCategoryGrid, f1_arg1 )
	SetElementCanBeNavigatedTo( f1_local6, false )
	SetElementCanBeNavigatedTo( f1_local7, false )
	return self
end

CoD.GameSettings_ZMSystems.__resetProperties = function ( f18_arg0 )
...
CoD.GameSettings_ZMSystems.__clipsPerState = {
	DefaultState = {
...
CoD.GameSettings_ZMSystems.__onClose = function ( f22_arg0 )
