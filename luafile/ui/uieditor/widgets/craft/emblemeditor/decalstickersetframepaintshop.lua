...
CoD.DecalStickerSetFramePaintshop.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	f1_arg0:AddButtonCallbackFunction( emblemIconList, f1_arg1, Enum.LUIButton[0x755DA1E2E7C263F], nil, function ( f7_arg0, f7_arg1, f7_arg2, f7_arg3 )
		if IsEmblemEditor( f7_arg2 ) and CoD.BaseUtility.DoesElementOrChildHaveFocus( self, "emblemIconList" ) and CoD.ModelUtility.IsSelfModelValueTrue( f7_arg0, f7_arg2, "owned" ) then
			...
			return true
		elseif IsPaintshop( f7_arg2 ) and CoD.BaseUtility.DoesElementOrChildHaveFocus( self, "emblemIconList" ) and CoD.ModelUtility.IsSelfModelValueTrue( f7_arg0, f7_arg2, "owned" ) then
			CoD.CraftUtility.EmblemChooseIcon_SelectionAccepted( self, f7_arg0, f7_arg2 )
			CoD.CraftUtility.EmblemEditor_SetEditMode( f7_arg2 )
