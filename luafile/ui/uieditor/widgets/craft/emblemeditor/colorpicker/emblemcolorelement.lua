...
CoD.EmblemColorElement.__defaultWidth = 68
CoD.EmblemColorElement.__defaultHeight = 22
CoD.EmblemColorElement.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	local colorElement = LUI.UIImage.new( 0.5, 0.5, -31, 31, 0.5, 0.5, -8, 8 )
	...
	local FrontendFrameSelected = LUI.UIImage.new( 0.5, 0.5, -38.5, 38.5, 0.5, 0.5, -15.5, 15.5 )
...
CoD.EmblemColorElement.__resetProperties = function ( f9_arg0 )
	...
	f9_arg0.FrontendFrameSelected:setLeftRight( 0.5, 0.5, -38.5, 38.5 )
	f9_arg0.FrontendFrameSelected:setTopBottom( 0.5, 0.5, -15.5, 15.5 )
	f9_arg0.FrontendFrameSelected:setAlpha( 0 )
	f9_arg0.colorElement:setLeftRight( 0.5, 0.5, -31, 31 )
	f9_arg0.colorElement:setTopBottom( 0.5, 0.5, -8, 8 )
end
...
CoD.EmblemColorElement.__clipsPerState = {
	DefaultState = {
		...
		Focus = function ( f11_arg0, f11_arg1 )
			...
			f11_arg0.colorElement:setLeftRight( 0.5, 0.5, -32.5, 32.5 )
			f11_arg0.colorElement:setTopBottom( 0.5, 0.5, -9.5, 9.5 )
			f11_arg0.clipFinished( f11_arg0.colorElement )
			f11_arg0.FrontendFrameSelected:completeAnimation()
			f11_arg0.FrontendFrameSelected:setLeftRight( 0.5, 0.5, -40, 40 )
			f11_arg0.FrontendFrameSelected:setTopBottom( 0.5, 0.5, -17, 17 )
		...
		GainFocus = function ( f18_arg0, f18_arg1 )
			...
			local f18_local0 = function ( f19_arg0 )
				...
				f18_arg0.colorElement:setLeftRight( 0.5, 0.5, -32.5, 32.5 )
				f18_arg0.colorElement:setTopBottom( 0.5, 0.5, -9.5, 9.5 )
			...
			f18_arg0.colorElement:setLeftRight( 0.5, 0.5, -31, 31 )
			f18_arg0.colorElement:setTopBottom( 0.5, 0.5, -8, 8 )
			f18_local0( f18_arg0.colorElement )
			local f18_local1 = function ( f20_arg0 )
				f18_arg0.FrontendFrameSelected:beginAnimation( 200 )
				f18_arg0.FrontendFrameSelected:setLeftRight( 0.5, 0.5, -40, 40 )
				f18_arg0.FrontendFrameSelected:setTopBottom( 0.5, 0.5, -17, 17 )
			...
			f18_arg0.FrontendFrameSelected:setLeftRight( 0.5, 0.5, -38.5, 38.5 )
			f18_arg0.FrontendFrameSelected:setTopBottom( 0.5, 0.5, -15.5, 15.5 )
		...
		LoseFocus = function ( f21_arg0, f21_arg1 )
			...
			local f21_local0 = function ( f22_arg0 )
				...
				f21_arg0.colorElement:setLeftRight( 0.5, 0.5, -31, 31 )
				f21_arg0.colorElement:setTopBottom( 0.5, 0.5, -8, 8 )
			...
			f21_arg0.colorElement:setLeftRight( 0.5, 0.5, -32.5, 32.5 )
			f21_arg0.colorElement:setTopBottom( 0.5, 0.5, -9.5, 9.5 )
			f21_local0( f21_arg0.colorElement )
			local f21_local1 = function ( f23_arg0 )
				f21_arg0.FrontendFrameSelected:beginAnimation( 100 )
				f21_arg0.FrontendFrameSelected:setLeftRight( 0.5, 0.5, -38.5, 38.5 )
				f21_arg0.FrontendFrameSelected:setTopBottom( 0.5, 0.5, -15.5, 15.5 )
			...
			f21_arg0.FrontendFrameSelected:setLeftRight( 0.5, 0.5, -40, 40 )
			f21_arg0.FrontendFrameSelected:setTopBottom( 0.5, 0.5, -17, 17 )
