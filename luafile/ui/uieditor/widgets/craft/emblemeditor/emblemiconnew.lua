...
CoD.EmblemIconNew.__defaultHeight = 144
CoD.EmblemIconNew.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	local Button = CoD.EmblemIconNew_Internal.new( f1_arg0, f1_arg1, 0.5, 0.5, -72, 72, 0.5, 0.5, -72, 72 )
...
CoD.EmblemIconNew.__resetProperties = function ( f3_arg0 )
	f3_arg0.Button:completeAnimation()
	f3_arg0.Button:setScale( 1, 1 )
end

CoD.EmblemIconNew.__clipsPerState = {
	DefaultState = {
...
CoD.EmblemIconNew.__onClose = function ( f10_arg0 )
