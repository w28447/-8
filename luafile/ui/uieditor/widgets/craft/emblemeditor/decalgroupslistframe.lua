...
CoD.DecalGroupsListFrame = InheritFrom( LUI.UIElement )
CoD.DecalGroupsListFrame.__defaultWidth = 1820
CoD.DecalGroupsListFrame.__defaultHeight = 965
CoD.DecalGroupsListFrame.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.DecalGroupsListFrame )
	self.id = "DecalGroupsListFrame"
	self.soundSet = "none"
	...
	GroupsButtonList:setTopBottom( 0, 0, 88, 880 )
	GroupsButtonList:setWidgetType( CoD.DecalTypeButton )
	GroupsButtonList:setVerticalCount( 10 )
	...
	DecalGroupsAvailable = CoD.DecalGroupsAvailable.new( f1_arg0, f1_arg1, 0, 0, 1203, 1738, 0, 0, 744, 764 )
	...
	CraftLayersAvailable = CoD.CraftLayersAvailable.new( f1_arg0, f1_arg1, 0, 0, 1203, 1738, 0, 0, 718, 738 )
	self:addElement( CraftLayersAvailable )
	self.CraftLayersAvailable = CraftLayersAvailable
	
	DecalPreview = CoD.DecalPreview.new( f1_arg0, f1_arg1, 0, 0, 1202, 1742, 0, 0, 71, 796 )
	...
	SlotsUsedWidget = CoD.SlotsUsedWidget.new( f1_arg0, f1_arg1, 0, 0, 1204.5, 1734.5, 0, 0, 620, 713 )
	...
	SlotsUsedWidget:subscribeToGlobalModel( f1_arg1, "CraftSlots", "totalSlots", function ( model )
		...
		if f21_local0 ~= nil then
			SlotsUsedWidget.Total:setText( f21_local0 )
		end
	end )
	SlotsUsedWidget:subscribeToGlobalModel( f1_arg1, "CraftSlots", "usedSlots", function ( model )
		local f22_local0 = model:get()
		if f22_local0 ~= nil then
			SlotsUsedWidget.Used:setText( f22_local0 )
		end
	end )
	SlotsUsedWidget:subscribeToGlobalModel( f1_arg1, "CraftSlots", "totalSlots", function ( model )
		local f23_local0 = model:get()
		if f23_local0 ~= nil then
			SlotsUsedWidget.totalBar:setShaderVector( 1, SetVectorComponent( 2, 1, CoD.GetVectorComponentFromString( f23_local0, 1 ), CoD.GetVectorComponentFromString( f23_local0, 2 ), CoD.GetVectorComponentFromString( f23_local0, 3 ), CoD.GetVectorComponentFromString( f23_local0, 4 ) ) )
		end
	end )
	SlotsUsedWidget:subscribeToGlobalModel( f1_arg1, "CraftSlots", "totalSlots", function ( model )
		local f24_local0 = model:get()
		if f24_local0 ~= nil then
			SlotsUsedWidget.usedBar:setShaderVector( 1, SetVectorComponent( 2, 1, CoD.GetVectorComponentFromString( f24_local0, 1 ), CoD.GetVectorComponentFromString( f24_local0, 2 ), CoD.GetVectorComponentFromString( f24_local0, 3 ), CoD.GetVectorComponentFromString( f24_local0, 4 ) ) )
		end
	end )
	SlotsUsedWidget:subscribeToGlobalModel( f1_arg1, "CraftSlots", "percent", function ( model )
		local f25_local0 = model:get()
		if f25_local0 ~= nil then
			SlotsUsedWidget.usedBar:setShaderVector( 2, SetVectorComponent( 4, 1, SetVectorComponent( 3, 0, SetVectorComponent( 1, 0, SwapVectorComponents( 1, 2, CoD.GetVectorComponentFromString( f25_local0, 1 ), CoD.GetVectorComponentFromString( f25_local0, 2 ), CoD.GetVectorComponentFromString( f25_local0, 3 ), CoD.GetVectorComponentFromString( f25_local0, 4 ) ) ) ) ) )
		end
	end )
	self:addElement( SlotsUsedWidget )
	self.SlotsUsedWidget = SlotsUsedWidget
	
	local CraftLayerNumber = CoD.CraftLayerNumber.new( f1_arg0, f1_arg1, 0, 0, 1217, 1328, 0, 0, 102, 124 )
	...
	if IsPC() then
		...
		CoD.GridAndListUtility.SetFocusableBackingWidgetOnPC( f1_local9 )
...
CoD.DecalGroupsListFrame.__onClose = function ( f28_arg0 )
	f28_arg0.DecalPreview:close()
	f28_arg0.GroupsButtonList:close()
	f28_arg0.decalGroupList:close()
	f28_arg0.DecalGroupsAvailable:close()
	f28_arg0.CraftLayersAvailable:close()
	f28_arg0.SlotsUsedWidget:close()
	f28_arg0.CraftLayerNumber:close()
end
