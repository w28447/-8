...
CoD.EmblemOptionsButtonSmall = InheritFrom( LUI.UIElement )
CoD.EmblemOptionsButtonSmall.__defaultWidth = 300
CoD.EmblemOptionsButtonSmall.__defaultHeight = 60
CoD.EmblemOptionsButtonSmall.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.EmblemOptionsButtonSmall )
	self.id = "EmblemOptionsButtonSmall"
	self.soundSet = "ChooseDecal"
	self.onlyChildrenFocusable = true
	self.anyChildUsesUpdateState = true
	f1_arg0:addElementToPendingUpdateStateList( self )
	
	local Button = CoD.EmblemOptionsButton_Internal.new( f1_arg0, f1_arg1, 0.5, 0.5, -150, 150, 0.5, 0.5, -30, 30 )
	Button.Blur:setAlpha( 0 )
	Button.Tint:setAlpha( 0.25 )
	Button:linkToElementModel( self, "displayText", true, function ( model )
		local f2_local0 = model:get()
		if f2_local0 ~= nil then
			Button.Title:setText( ConvertToUpperString( CoD.BaseUtility.LocalizeIfXHash( f2_local0 ) ) )
		end
	end )
...
CoD.EmblemOptionsButtonSmall.__resetProperties = function ( f3_arg0 )
	f3_arg0.Button:completeAnimation()
	f3_arg0.Button:setScale( 1, 1 )
end

CoD.EmblemOptionsButtonSmall.__clipsPerState = {
	DefaultState = {
...
CoD.EmblemOptionsButtonSmall.__onClose = function ( f10_arg0 )
