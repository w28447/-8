CoD.AmmoWidgetZM_PowerWeaponDrain = InheritFrom( LUI.UIElement )
CoD.AmmoWidgetZM_PowerWeaponDrain.__defaultWidth = 165
CoD.AmmoWidgetZM_PowerWeaponDrain.__defaultHeight = 61
CoD.AmmoWidgetZM_PowerWeaponDrain.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.AmmoWidgetZM_PowerWeaponDrain )
	self.id = "AmmoWidgetZM_PowerWeaponDrain"
...
CoD.AmmoWidgetZM_PowerWeaponDrain.__resetProperties = function ( f3_arg0 )
...
CoD.AmmoWidgetZM_PowerWeaponDrain.__clipsPerState = {
	DefaultState = {
...
CoD.AmmoWidgetZM_PowerWeaponDrain.__onClose = function ( f16_arg0 )
