CoD.AbilityHoldToActivate = InheritFrom( LUI.UIElement )
CoD.AbilityHoldToActivate.__defaultWidth = 200
CoD.AbilityHoldToActivate.__defaultHeight = 49
CoD.AbilityHoldToActivate.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.AbilityHoldToActivate )
	self.id = "AbilityHoldToActivate"
	...
	HeroAbilityHoldString:setText( LocalizeToUpperString( "mp/hold" ) )
...
CoD.AbilityHoldToActivate.__resetProperties = function ( f11_arg0 )
	...
	f11_arg0.HeroAbilityHoldString:setText( LocalizeToUpperString( "mp/hold" ) )
	f11_arg0.Arrow:setAlpha( 0.94 )
	f11_arg0.empty:setAlpha( 0.2 )
end

CoD.AbilityHoldToActivate.__clipsPerState = {
	DefaultState = {
	...
	VisibleInUse = {
		DefaultClip = function ( f15_arg0, f15_arg1 )
			...
			f15_arg0.HeroAbilityHoldString:setText( LocalizeToUpperString( "DESTROY" ) )
			f15_arg0.clipFinished( f15_arg0.HeroAbilityHoldString )
		end
	}
}
CoD.AbilityHoldToActivate.__onClose = function ( f16_arg0 )
