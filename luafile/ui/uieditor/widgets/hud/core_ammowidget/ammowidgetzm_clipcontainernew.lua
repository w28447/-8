require( "ui/uieditor/widgets/hud/core_ammowidget/ammowidgetzm_clipcontainerpress" )
require( "ui/uieditor/widgets/hud/core_ammowidget/ammowidgetzm_clipcontainervalue" )

CoD.AmmoWidgetZM_ClipContainerNew = InheritFrom( LUI.UIElement )
CoD.AmmoWidgetZM_ClipContainerNew.__defaultWidth = 100
CoD.AmmoWidgetZM_ClipContainerNew.__defaultHeight = 50
CoD.AmmoWidgetZM_ClipContainerNew.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.AmmoWidgetZM_ClipContainerNew )
	self.id = "AmmoWidgetZM_ClipContainerNew"
	...
	Clip.ClipShadow:setText( CoD.BaseUtility.NonStringWorkaround( 33 ) )
	Clip.Clip:setText( CoD.BaseUtility.NonStringWorkaround( 33 ) )
	self:addElement( Clip )
	self.Clip = Clip
	
	local ClipContainerPress = CoD.AmmoWidgetZM_ClipContainerPress.new( f1_arg0, f1_arg1, 0, 1, -52, -52, 0, 1, -8, -8 )
	...
	Bounce = LUI.UIImage.new( 0, 0, -10, 64, 0, 0, -19, 9 )
	Bounce:setAlpha( 0 )
...
CoD.AmmoWidgetZM_ClipContainerNew.__resetProperties = function ( f4_arg0 )
...
CoD.AmmoWidgetZM_ClipContainerNew.__clipsPerState = {
	DefaultState = {
		DefaultClip = function ( f5_arg0, f5_arg1 )
			f5_arg0:__resetProperties()
			f5_arg0:setupElementClipCounter( 2 )
			f5_arg0.Clip:completeAnimation()
			f5_arg0.Clip:setRGB( 1, 1, 1 )
	...
	Hero = {
		DefaultClip = function ( f83_arg0, f83_arg1 )
			...
			f83_arg0.Clip:setRGB( ColorSet.T8__BEIGE__HEADER.r, ColorSet.T8__BEIGE__HEADER.g, ColorSet.T8__BEIGE__HEADER.b )
...
CoD.AmmoWidgetZM_ClipContainerNew.__onClose = function ( f112_arg0 )
