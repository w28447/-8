...
CoD.AmmoWidgetZM_ClipContainerPress = InheritFrom( LUI.UIElement )
CoD.AmmoWidgetZM_ClipContainerPress.__defaultWidth = 162
CoD.AmmoWidgetZM_ClipContainerPress.__defaultHeight = 63
CoD.AmmoWidgetZM_ClipContainerPress.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.AmmoWidgetZM_ClipContainerPress )
	self.id = "AmmoWidgetZM_ClipContainerPress"
	...
	local x = LUI.UIImage.new( 0, 0, 56, 168, 0, 0, -14, 98 )
	x:setRGB( 1, 0, 0 )
	x:setAlpha( 0 )
	x:setImage( RegisterImage( 0x744350D705E85B4 ) )
	self:addElement( x )
	self.x = x
				...
				local f10_local0 = function ( f11_arg0 )
					local f11_local0 = function ( f12_arg0 )
						local f12_local0 = function ( f13_arg0 )
							f13_arg0:beginAnimation( 309 )
							f13_arg0:registerEventHandler( "transition_complete_keyframe", f4_arg0.clipFinished )
						end
						
						f12_arg0:beginAnimation( 350 )
						f12_arg0:setAlpha( 0 )
						f12_arg0:registerEventHandler( "transition_complete_keyframe", f12_local0 )
					end
					
					f11_arg0:beginAnimation( 329 )
					f11_arg0:setAlpha( 1 )
					f11_arg0:registerEventHandler( "transition_complete_keyframe", f11_local0 )
				end
				
				f4_arg0.x:beginAnimation( 310 )
				f4_arg0.x:setAlpha( 0 )
				f4_arg0.x:registerEventHandler( "interrupted_keyframe", f4_arg0.clipInterrupted )
				f4_arg0.x:registerEventHandler( "transition_complete_keyframe", f10_local0 )
			end
			
			f4_arg0.x:completeAnimation()
			f4_arg0.x:setAlpha( 1 )
			f4_local1( f4_arg0.x )
...
CoD.AmmoWidgetZM_ClipContainerPress.__onClose = function ( f14_arg0 )
	f14_arg0.Pixel0:close()
	f14_arg0.Pixel1:close()
end
