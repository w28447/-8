CoD.hud_hacked_streaks_widget = InheritFrom( LUI.UIElement )
CoD.hud_hacked_streaks_widget.__defaultWidth = 68
CoD.hud_hacked_streaks_widget.__defaultHeight = 189
CoD.hud_hacked_streaks_widget.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.hud_hacked_streaks_widget )
	self.id = "hud_hacked_streaks_widget"
	self.soundSet = "default"
	f1_arg0:addElementToPendingUpdateStateList( self )
	
	local Hacked2 = LUI.UIImage.new( 0, 0, 0, 68, 0, 0, 0, 189 )
	Hacked2:setRGB( 0.32, 0.44, 0.52 )
	Hacked2:setAlpha( 0.15 )
	Hacked2:setZRot( 180 )
	Hacked2:setImage( RegisterImage( "uie_ui_hud_core_hacked_streaks_panel" ) )
	Hacked2:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_flipbook_add" ) )
	Hacked2:setShaderVector( 0, 8, 2, 0, 0 )
	Hacked2:setShaderVector( 1, 60, 0, 0, 0 )
	self:addElement( Hacked2 )
	self.Hacked2 = Hacked2
	
	local Hacked = LUI.UIImage.new( 0, 0, 0, 68, 0, 0, 0, 189 )
	Hacked:setRGB( 0.62, 0.76, 0.87 )
	Hacked:setAlpha( 0.25 )
	Hacked:setImage( RegisterImage( "uie_ui_hud_core_hacked_streaks_panel" ) )
	Hacked:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_flipbook_add" ) )
	Hacked:setShaderVector( 0, 8, 2, 0, 0 )
	Hacked:setShaderVector( 1, 60, 0, 0, 0 )
...
CoD.hud_hacked_streaks_widget.__resetProperties = function ( f8_arg0 )
	...
	f8_arg0.Hacked:setAlpha( 0.25 )
	f8_arg0.Hacked2:setAlpha( 0.15 )
end
