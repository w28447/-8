CoD.hud_hacked_score_widget = InheritFrom( LUI.UIElement )
CoD.hud_hacked_score_widget.__defaultWidth = 220
CoD.hud_hacked_score_widget.__defaultHeight = 72
CoD.hud_hacked_score_widget.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.hud_hacked_score_widget )
	self.id = "hud_hacked_score_widget"
	self.soundSet = "default"
	f1_arg0:addElementToPendingUpdateStateList( self )
	
	local Hacked = LUI.UIImage.new( 0.5, 0.5, -110, 110, 0.5, 0.5, -36, 36 )
	Hacked:setRGB( 0.32, 0.44, 0.52 )
	Hacked:setImage( RegisterImage( "uie_ui_hud_core_hacked_objectives_panel" ) )
	Hacked:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_flipbook_add" ) )
	Hacked:setShaderVector( 0, 2, 8, 0, 0 )
	Hacked:setShaderVector( 1, 30, 0, 0, 0 )
	self:addElement( Hacked )
	self.Hacked = Hacked
	
	local Hacked2 = LUI.UIImage.new( 0.5, 0.5, -110, 110, 0.5, 0.5, -36, 36 )
	Hacked2:setRGB( 0.2, 0.3, 0.37 )
	Hacked2:setAlpha( 0.5 )
	Hacked2:setZRot( 180 )
	Hacked2:setImage( RegisterImage( "uie_ui_hud_core_hacked_objectives_panel" ) )
	Hacked2:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_flipbook_add" ) )
	Hacked2:setShaderVector( 0, 2, 8, 0, 0 )
	Hacked2:setShaderVector( 1, 55, 0, 0, 0 )
...
CoD.hud_hacked_score_widget.__clipsPerState = {
	...
	Hacked = {
		DefaultClip = function ( f10_arg0, f10_arg1 )
			...
			f10_arg0.Hacked2:completeAnimation()
			f10_arg0.Hacked2:setAlpha( 0.5 )
			f10_arg0.clipFinished( f10_arg0.Hacked2 )
		end
	}
}
