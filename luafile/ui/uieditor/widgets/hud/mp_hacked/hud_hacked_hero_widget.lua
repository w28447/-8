CoD.hud_hacked_hero_widget = InheritFrom( LUI.UIElement )
CoD.hud_hacked_hero_widget.__defaultWidth = 274
CoD.hud_hacked_hero_widget.__defaultHeight = 138
CoD.hud_hacked_hero_widget.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.hud_hacked_hero_widget )
	self.id = "hud_hacked_hero_widget"
	self.soundSet = "default"
	f1_arg0:addElementToPendingUpdateStateList( self )
	
	local Hacked2 = LUI.UIImage.new( 0, 0, 0, 274, 0, 0, 0, 138 )
