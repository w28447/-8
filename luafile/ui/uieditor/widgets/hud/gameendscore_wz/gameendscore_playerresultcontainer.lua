...
CoD.GameEndScore_PlayerResultContainer.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	blur:setImage( RegisterImage( "uie_ui_hud_wz_endgame_bg" ) )
	...
	ResultBacking:setImage( RegisterImage( "uie_ui_hud_wz_endgame_bg" ) )
	...
	ResultBacking3:setImage( RegisterImage( "uie_ui_hud_wz_endgame_frame_bg02" ) )
	...
	ResultBacking2:setImage( RegisterImage( "uie_ui_hud_wz_endgame_bg" ) )
	...
	ResultBacking4:setImage( RegisterImage( "uie_ui_hud_wz_endgame_frame_bg02" ) )
	...
	Arrow2:setImage( RegisterImage( "uie_ui_hud_wz_endgame_common_triangle" ) )
	...
	FrameInnerRight:setImage( RegisterImage( "uie_ui_hud_wz_endgame_inner_frame_right" ) )
	...
	FrameInnerLeft:setImage( RegisterImage( "uie_ui_hud_wz_endgame_inner_frame_left" ) )
	...
	arrowBot:setImage( RegisterImage( "uie_ui_hud_wz_endgame_arrow02" ) )
	self:addElement( arrowBot )
	self.arrowBot = arrowBot
	
	local arrowTop = LUI.UIImage.new( 0, 0, 637.5, 653.5, 0, 0, 531, 523 )
	arrowTop:setImage( RegisterImage( "uie_ui_hud_wz_endgame_arrow02" ) )
...
CoD.GameEndScore_PlayerResultContainer.__resetProperties = function ( f4_arg0 )
	...
	f4_arg0.blur:setImage( RegisterImage( "uie_ui_hud_wz_endgame_bg" ) )
end
...
CoD.GameEndScore_PlayerResultContainer.__clipsPerState = {
	DefaultState = {
		DefaultClip = function ( f5_arg0, f5_arg1 )
			...
			f5_arg0.blur:setImage( RegisterImage( "uie_ui_hud_wz_endgame_blur_bg" ) )
