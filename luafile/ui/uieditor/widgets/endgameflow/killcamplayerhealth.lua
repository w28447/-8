...
CoD.KillcamPlayerHealth.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	LeftLed02:setImage( RegisterImage( "uie_ui_hud_core_player_widget_led_status" ) )
	LeftLed02:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_wipe_delta_normal" ) )
	...
	LeftLed01:setImage( RegisterImage( "uie_ui_hud_core_player_widget_led_status" ) )
	LeftLed01:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_wipe_delta_normal" ) )
