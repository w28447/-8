...
CoD.Dropdown_LeftAlign = InheritFrom( LUI.UIElement )
CoD.Dropdown_LeftAlign.__defaultWidth = 336
CoD.Dropdown_LeftAlign.__defaultHeight = 65
CoD.Dropdown_LeftAlign.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.Dropdown_LeftAlign )
	self.id = "Dropdown_LeftAlign"
