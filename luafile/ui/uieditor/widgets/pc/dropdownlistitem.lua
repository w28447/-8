...
CoD.DropdownListItem = InheritFrom( LUI.UIElement )
CoD.DropdownListItem.__defaultWidth = 336
CoD.DropdownListItem.__defaultHeight = 60
CoD.DropdownListItem.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.DropdownListItem )
	self.id = "DropdownListItem"
	self.soundSet = "none"
	...
	local TextBox = LUI.UIText.new( 0, 1, 42, -42, 0.5, 0.5, -9.5, 9.5 )
...
CoD.DropdownListItem.__resetProperties = function ( f4_arg0 )
...
CoD.DropdownListItem.__clipsPerState = {
	DefaultState = {
...
CoD.DropdownListItem.__onClose = function ( f34_arg0 )
