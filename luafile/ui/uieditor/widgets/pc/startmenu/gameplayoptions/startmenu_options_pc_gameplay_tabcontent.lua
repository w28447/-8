...
require( "ui/uieditor/widgets/pc/startmenu/gameplayoptions/startmenu_options_pc_gameplayoptions_suboptionsnavigation" )

CoD.StartMenu_Options_PC_Gameplay_TabContent = InheritFrom( LUI.UIElement )
CoD.StartMenu_Options_PC_Gameplay_TabContent.__defaultWidth = 1885
CoD.StartMenu_Options_PC_Gameplay_TabContent.__defaultHeight = 812
CoD.StartMenu_Options_PC_Gameplay_TabContent.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.StartMenu_Options_PC_Gameplay_TabContent )
	self.id = "StartMenu_Options_PC_Gameplay_TabContent"
	self.soundSet = "default"
	self.onlyChildrenFocusable = true
	self.anyChildUsesUpdateState = true
	f1_arg0:addElementToPendingUpdateStateList( self )
	
	local SubOptionsNavigation1 = CoD.StartMenu_Options_PC_GameplayOptions_SubOptionsNavigation.new( f1_arg0, f1_arg1, 0, 0, 422, 1885, 0, 0, 0, 716 )
...
CoD.StartMenu_Options_PC_Gameplay_TabContent.__resetProperties = function ( f10_arg0 )
...
CoD.StartMenu_Options_PC_Gameplay_TabContent.__clipsPerState = {
	DefaultState = {
...
CoD.StartMenu_Options_PC_Gameplay_TabContent.__onClose = function ( f21_arg0 )
