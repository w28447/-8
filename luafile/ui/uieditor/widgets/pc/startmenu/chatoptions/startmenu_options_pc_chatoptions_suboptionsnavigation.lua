...
CoD.StartMenu_Options_PC_ChatOptions_SubOptionsNavigation = InheritFrom( LUI.UIElement )
CoD.StartMenu_Options_PC_ChatOptions_SubOptionsNavigation.__defaultWidth = 1465
CoD.StartMenu_Options_PC_ChatOptions_SubOptionsNavigation.__defaultHeight = 716
CoD.StartMenu_Options_PC_ChatOptions_SubOptionsNavigation.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.StartMenu_Options_PC_ChatOptions_SubOptionsNavigation )
	self.id = "StartMenu_Options_PC_ChatOptions_SubOptionsNavigation"
	...
	PCStartMenuOptionsList.ScrollList.ScrollView.View:setDataSource( "OptionChat" )
...
CoD.StartMenu_Options_PC_ChatOptions_SubOptionsNavigation.__resetProperties = function ( f8_arg0 )
...
CoD.StartMenu_Options_PC_ChatOptions_SubOptionsNavigation.__clipsPerState = {
	DefaultState = {
...
CoD.StartMenu_Options_PC_ChatOptions_SubOptionsNavigation.__onClose = function ( f18_arg0 )
