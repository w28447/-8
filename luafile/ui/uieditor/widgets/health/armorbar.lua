...
CoD.ArmorBar.__defaultWidth = 150
CoD.ArmorBar.__defaultHeight = 4
CoD.ArmorBar.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	ArmorBarBackground:setImage( RegisterImage( "uie_ui_hud_core_armor_bar_empty" ) )
	...
	ArmorBarImage:setImage( RegisterImage( "uie_ui_hud_core_armor_bar_fill" ) )
	...
	ArmorBarImage:setShaderVector( 3, 0.4, 0.4, 0, 0 )
...
CoD.ArmorBar.__resetProperties = function ( f6_arg0 )
...
CoD.ArmorBar.__onClose = function ( f9_arg0 )
