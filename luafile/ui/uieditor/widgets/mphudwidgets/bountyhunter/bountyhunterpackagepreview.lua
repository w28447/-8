...
CoD.BountyHunterPackagePreview.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	VerticalAccentBL:setImage( RegisterImage( "uie_ui_hud_common_line_accent01" ) )
	VerticalAccentBL:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_nineslice_normal" ) )
	...
	VerticalAccentBR:setImage( RegisterImage( "uie_ui_hud_common_line_accent01" ) )
	VerticalAccentBR:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_nineslice_normal" ) )
	...
	VerticalAccentBL2:setImage( RegisterImage( "uie_ui_hud_common_line_accent01" ) )
	VerticalAccentBL2:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_nineslice_normal" ) )
	...
	VerticalAccentBR2:setImage( RegisterImage( "uie_ui_hud_common_line_accent01" ) )
	VerticalAccentBR2:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_nineslice_normal" ) )
