...
CoD.Waypoint_TextBGTraining.__defaultHeight = 31
CoD.Waypoint_TextBGTraining.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.Waypoint_TextBGTraining )
	self.id = "Waypoint_TextBGTraining"
	...
	local WaypointTextWithBG = CoD.Waypoint_TextWithBGTraining.new( f1_arg0, f1_arg1, 0.5, 0.5, -192, 192, 1, 1, -30, 8 )
	self:addElement( WaypointTextWithBG )
	self.WaypointTextWithBG = WaypointTextWithBG
	
	local DistanceTextWithBG = CoD.Waypoint_TextWithBGTraining.new( f1_arg0, f1_arg1, 0.5, 0.5, -192, 192, 1, 1, -30, 8 )
	...
	ContestedText:setTTF( "ttmussels_regular" )
...
CoD.Waypoint_TextBGTraining.__resetProperties = function ( f10_arg0 )
	...
	f10_arg0.ContestedText:setText( Engine[0xF9F1239CFD921FE]( "menu/waypoint_contested" ) )
	f10_arg0.ContestedText:setShaderVector( 0, 0.8, 0, 0, 0 )
	f10_arg0.ContestedText:setShaderVector( 1, 0, 0, 0, 0 )
	f10_arg0.ContestedText:setShaderVector( 2, 1, 0, 0, 0.4 )
...
CoD.Waypoint_TextBGTraining.__clipsPerState = {
	...
	Contested = {
		DefaultClip = function ( f12_arg0, f12_arg1 )
			...
			f12_arg0.ContestedText:setText( Engine[0xF9F1239CFD921FE]( "menu/waypoint_contested" ) )
			f12_arg0.ContestedText:setShaderVector( 0, 0.8, 0, 0, 0 )
			f12_arg0.ContestedText:setShaderVector( 1, 0, 0, 0, 0 )
			f12_arg0.ContestedText:setShaderVector( 2, 1, 0, 0, 0 )
	...
	Protect = {
		DefaultClip = function ( f17_arg0, f17_arg1 )
			...
			f17_arg0.ContestedText:setText( Engine[0xF9F1239CFD921FE]( "menu/waypoint_protect" ) )
			f17_arg0.ContestedText:setShaderVector( 0, 0.8, 0, 0, 0 )
			f17_arg0.ContestedText:setShaderVector( 1, 0, 0, 0, 0 )
			f17_arg0.ContestedText:setShaderVector( 2, 1, 0, 0, 0 )
	...
	ShowDistance = {
		DefaultClip = function ( f20_arg0, f20_arg1 )
			...
			f20_arg0.ContestedText:setShaderVector( 0, 0.8, 0, 0, 0 )
			f20_arg0.ContestedText:setShaderVector( 1, 0, 0, 0, 0 )
			f20_arg0.ContestedText:setShaderVector( 2, 1, 0, 0, 0 )
	...
	Show = {
		DefaultClip = function ( f21_arg0, f21_arg1 )
			...
			f21_arg0.ContestedText:setShaderVector( 0, 0.8, 0, 0, 0 )
			f21_arg0.ContestedText:setShaderVector( 1, 0, 0, 0, 0 )
			f21_arg0.ContestedText:setShaderVector( 2, 1, 0, 0, 0 )
