CoD.GenericSimpleButton_Container = InheritFrom( LUI.UIElement )
CoD.GenericSimpleButton_Container.__defaultWidth = 194
CoD.GenericSimpleButton_Container.__defaultHeight = 103
CoD.GenericSimpleButton_Container.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.GenericSimpleButton_Container )
	self.id = "GenericSimpleButton_Container"
	...
	local Title = LUI.UIText.new( 0, 1, 14, -14, 0.5, 0.5, -8, 16 )
...
CoD.GenericSimpleButton_Container.__resetProperties = function ( f2_arg0 )
...
CoD.GenericSimpleButton_Container.__clipsPerState = {
	DefaultState = {
		...
		Focus = function ( f4_arg0, f4_arg1 )
			...
			f4_arg0.Background:setAlpha( 0.99 )
		...
		LoseFocus = function ( f5_arg0, f5_arg1 )
			...
			f5_arg0.Background:setAlpha( 0.99 )
