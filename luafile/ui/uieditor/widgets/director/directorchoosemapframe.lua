...
CoD.DirectorChooseMapFrame.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	f1_arg0:AddButtonCallbackFunction( MapCategoryGridPC, f1_arg1, Enum.LUIButton[0x755DA1E2E7C263F], nil, function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( MapListPC, f1_arg1, Enum.LUIButton[0x755DA1E2E7C263F], nil, function ( element, menu, controller, model )
		if IsElementPropertyValue( element, "purchasable", true ) then
			OpenOverlay( self, "Store", controller )
			return true
		else
			CoD.MapUtility.SelectElementMap( element, controller )
			PlaySoundAlias( "cac_open_wpn_cust" )
			return true
		end
	end, function ( element, menu, controller )
	...
	f1_arg0:AddButtonCallbackFunction( MapListPC, f1_arg1, Enum.LUIButton[0x805EFA15E9E7E5A], nil, function ( element, menu, controller, model )
