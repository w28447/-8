...
CoD.DirectorPlaylistOptionInternal.__resetProperties = function ( f16_arg0 )
	...
	f16_arg0.ImageNotFocus:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_saturation_normal" ) )
...
CoD.DirectorPlaylistOptionInternal.__clipsPerState = {
	...
	Locked = {
		...
		ChildFocus = function ( f30_arg0, f30_arg1 )
			...
			f30_arg0.ImageNotFocus:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_saturation_normal" ) )
		...
		GainChildFocus = function ( f31_arg0, f31_arg1 )
			...
			f31_arg0.ImageNotFocus:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_saturation_normal" ) )
		...
		LoseChildFocus = function ( f34_arg0, f34_arg1 )
			...
			f34_arg0.ImageNotFocus:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_saturation_normal" ) )
	...
	Upsell = {
		DefaultClip = function ( f38_arg0, f38_arg1 )
			...
			f38_arg0.ImageNotFocus:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_saturation_normal" ) )
		...
		ChildFocus = function ( f39_arg0, f39_arg1 )
			...
			f39_arg0.ImageNotFocus:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_saturation_normal" ) )
		...
		GainChildFocus = function ( f40_arg0, f40_arg1 )
			...
			f40_arg0.ImageNotFocus:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_saturation_normal" ) )
		...
		LoseChildFocus = function ( f42_arg0, f42_arg1 )
			...
			f42_arg0.ImageNotFocus:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_saturation_normal" ) )
	...
	Download = {
		DefaultClip = function ( f44_arg0, f44_arg1 )
			...
			f44_arg0.ImageNotFocus:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_saturation_normal" ) )
		...
		ChildFocus = function ( f45_arg0, f45_arg1 )
			...
			f45_arg0.ImageNotFocus:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_saturation_normal" ) )
		...
		GainChildFocus = function ( f46_arg0, f46_arg1 )
			...
			f46_arg0.ImageNotFocus:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_saturation_normal" ) )
		...
		LoseChildFocus = function ( f48_arg0, f48_arg1 )
			...
			f48_arg0.ImageNotFocus:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_saturation_normal" ) )
