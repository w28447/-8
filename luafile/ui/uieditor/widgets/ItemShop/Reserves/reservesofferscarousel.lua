...
CoD.ReservesOffersCarousel.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	f1_arg0:AddButtonCallbackFunction( OffersCarousel, f1_arg1, Enum.LUIButton[0x755DA1E2E7C263F], nil, function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( OffersCarousel, f1_arg1, Enum.LUIButton[0x820DDD869ABBFAA], "MWHEELDOWN", function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( OffersCarousel, f1_arg1, Enum.LUIButton[0xD2F467A6C6DA1AC], "MWHEELUP", function ( element, menu, controller, model )
		if not IsRepeatButtonPress( model ) then
