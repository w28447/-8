CoD.ItemShopRarityBackgroundStream_Common = InheritFrom( LUI.UIElement )
CoD.ItemShopRarityBackgroundStream_Common.__defaultWidth = 600
CoD.ItemShopRarityBackgroundStream_Common.__defaultHeight = 600
CoD.ItemShopRarityBackgroundStream_Common.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.ItemShopRarityBackgroundStream_Common )
	self.id = "ItemShopRarityBackgroundStream_Common"
	self.soundSet = "none"
...
CoD.ItemShopRarityBackgroundStream_Common.__onClose = function ( f7_arg0 )
