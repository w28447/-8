...
CoD.ContractSeasonalOverlay_SupplyChain = InheritFrom( LUI.UIElement )
CoD.ContractSeasonalOverlay_SupplyChain.__defaultWidth = 349
CoD.ContractSeasonalOverlay_SupplyChain.__defaultHeight = 158
CoD.ContractSeasonalOverlay_SupplyChain.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.ContractSeasonalOverlay_SupplyChain )
	self.id = "ContractSeasonalOverlay_SupplyChain"
	...
	local ContractRarityHeaderBackground2 = LUI.UIImage.new( 0, 0, 1, 348, 0, 0, 6.5, 27.5 )
	...
	local PixelGridTiledBacking2 = LUI.UIImage.new( 0, 0, 1, 347, 0, 0, 8.5, 25.5 )
	...
	local Seasonal = LUI.UIText.new( 0, 0, 14.5, 348.5, 0, 0, 8.5, 25.5 )
...
CoD.ContractSeasonalOverlay_SupplyChain.__resetProperties = function ( f2_arg0 )
...
CoD.ContractSeasonalOverlay_SupplyChain.__clipsPerState = {
	DefaultState = {
