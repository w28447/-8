...
CoD.ContractSeasonalOverlay_InfoPanel = InheritFrom( LUI.UIElement )
CoD.ContractSeasonalOverlay_InfoPanel.__defaultWidth = 759
CoD.ContractSeasonalOverlay_InfoPanel.__defaultHeight = 25
CoD.ContractSeasonalOverlay_InfoPanel.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.ContractSeasonalOverlay_InfoPanel )
	self.id = "ContractSeasonalOverlay_InfoPanel"
	self.soundSet = "default"
	f1_arg0:addElementToPendingUpdateStateList( self )
	
	local ContractRarityHeaderBackground2 = LUI.UIImage.new( 0, 0, 0, 759, 0, 0, 0, 25 )
...
CoD.ContractSeasonalOverlay_InfoPanel.__resetProperties = function ( f2_arg0 )
...
CoD.ContractSeasonalOverlay_InfoPanel.__clipsPerState = {
	DefaultState = {
