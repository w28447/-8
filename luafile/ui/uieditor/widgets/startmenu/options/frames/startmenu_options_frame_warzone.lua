...
CoD.StartMenu_Options_Frame_Warzone.__defaultHeight = 890
CoD.StartMenu_Options_Frame_Warzone.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.StartMenu_Options_Frame_Warzone )
	self.id = "StartMenu_Options_Frame_Warzone"
	self.soundSet = "none"
	...
	OptionGroups:setTopBottom( 0, 0, 0, 830 )
	OptionGroups:setWidgetType( CoD.StartMenu_Options_SettingSlider_Wrapper )
	OptionGroups:setVerticalCount( 15 )
	OptionGroups:setSpacing( 10 )
	OptionGroups:setAlignment( Enum.LUIAlignment[0x58C8A85F2048829] )
	OptionGroups:setVerticalCounter( CoD.verticalCounter )
	OptionGroups:setDataSource( "PlayerSettingsWarzoneList" )
...
CoD.StartMenu_Options_Frame_Warzone.__onClose = function ( f7_arg0 )
	f7_arg0.OptionInfo:close()
	f7_arg0.OptionGroups:close()
end
