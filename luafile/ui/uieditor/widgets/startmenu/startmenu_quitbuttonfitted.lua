...
CoD.StartMenu_QuitButtonFitted.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.StartMenu_QuitButtonFitted )
	self.id = "StartMenu_QuitButtonFitted"
	self.soundSet = "default"
	self.onlyChildrenFocusable = true
	self.anyChildUsesUpdateState = true
	f1_arg0:addElementToPendingUpdateStateList( self )
	
	local DirectorGenericButton = CoD.DirectorGenericButton.new( f1_arg0, f1_arg1, 0, 1, 0, 0, 0, 1, 0, 0 )
	...
	local HoldButtonFill = CoD.StartMenu_QuitButtonFill.new( f1_arg0, f1_arg1, 0, 1, 2, -2, 0, 1, 11, -11 )
	...
	local TextBox = LUI.UIText.new( 0.5, 0.5, -125, 125, 0.5, 0.5, -12, 12 )
