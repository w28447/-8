...
CoD.JumpkitSelected.__defaultHeight = 152
CoD.JumpkitSelected.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.JumpkitSelected )
	self.id = "JumpkitSelected"
	self.soundSet = "default"
	self.anyChildUsesUpdateState = true
	f1_arg0:addElementToPendingUpdateStateList( self )
	
	local JumpkitButtonInternal = CoD.JumpkitSelected_Internal.new( f1_arg0, f1_arg1, 0, 0, 0, 152, 0, 0, 0, 152 )
