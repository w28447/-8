...
CoD.RankUpNotification.__defaultWidth = 612
CoD.RankUpNotification.__defaultHeight = 330
CoD.RankUpNotification.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	local TitleText = LUI.UIText.new( 0, 0, 108, 505, 0, 0, 207, 243 )
	...
	local SubtitleText = LUI.UIText.new( 0, 0, 0, 612, 0, 0, 247, 272 )
	...
	self.TitleText:linkToElementModel( self, "subtitle", true, function ( model )
	...
	self.SubtitleText:linkToElementModel( self, "title", true, function ( model )
...
CoD.RankUpNotification.__resetProperties = function ( f9_arg0 )
...
CoD.RankUpNotification.__clipsPerState = {
	DefaultState = {
		...
		TimeUp = function ( f34_arg0, f34_arg1 )
			...
			f34_arg0.SubtitleText:beginAnimation( 150 )
			f34_arg0.SubtitleText:setAlpha( 1 )
			f34_arg0.SubtitleText:registerEventHandler( "interrupted_keyframe", f34_arg0.clipInterrupted )
			f34_arg0.SubtitleText:registerEventHandler( "transition_complete_keyframe", f34_local2 )
...
CoD.RankUpNotification.__onClose = function ( f45_arg0 )
	f45_arg0.TitleText:close()
	f45_arg0.SubtitleText:close()
