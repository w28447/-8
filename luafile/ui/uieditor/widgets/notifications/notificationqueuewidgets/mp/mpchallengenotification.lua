...
CoD.MPChallengeNotification.__defaultWidth = 612
CoD.MPChallengeNotification.__defaultHeight = 330
CoD.MPChallengeNotification.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	local SubtitleText = LUI.UIText.new( 0, 0, -73, 685, 0, 0, 247, 272 )
...
CoD.MPChallengeNotification.__resetProperties = function ( f9_arg0 )
...
CoD.MPChallengeNotification.__clipsPerState = {
	DefaultState = {
		DefaultClip = function ( f10_arg0, f10_arg1 )
			...
			f10_arg0.Rank:setRGB( 1, 1, 1 )
			f10_arg0.Rank:setAlpha( 0 )
			f10_arg0.Rank:setScale( 5, 5 )
			f10_local7( f10_arg0.Rank )
			local f10_local8 = function ( f33_arg0 )
				local f33_local0 = function ( f34_arg0 )
					f34_arg0:beginAnimation( 90 )
					f34_arg0:setAlpha( 0 )
					f34_arg0:setScale( 5, 5 )
					f34_arg0:registerEventHandler( "transition_complete_keyframe", f10_arg0.clipFinished )
				end
				
				f33_arg0:beginAnimation( 130, Enum[0xF50FFF429AB1890][0x6F6186B702830BC] )
				f33_arg0:setAlpha( 0.25 )
				f33_arg0:setScale( 2.95, 2.95 )
		...
		TimeUp = function ( f35_arg0, f35_arg1 )
			...
			local f35_local7 = function ( f43_arg0 )
				...
				f35_arg0.Rank:beginAnimation( 50, Enum[0xF50FFF429AB1890][0x5D2D9CF90AB1735] | Enum[0xF50FFF429AB1890][0x6F6186B702830BC] )
				f35_arg0.Rank:setAlpha( 0 )
				f35_arg0.Rank:registerEventHandler( "interrupted_keyframe", f35_arg0.clipInterrupted )
				f35_arg0.Rank:registerEventHandler( "transition_complete_keyframe", f43_local0 )
			end
			
			f35_arg0.Rank:completeAnimation()
			f35_arg0.Rank:setAlpha( 1 )
			f35_arg0.Rank:setScale( 1.2, 1.2 )
			f35_local7( f35_arg0.Rank )
		end
	}
}
CoD.MPChallengeNotification.__onClose = function ( f46_arg0 )
