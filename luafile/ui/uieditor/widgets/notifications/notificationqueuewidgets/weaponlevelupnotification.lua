...
CoD.WeaponLevelUpNotification.__defaultHeight = 330
CoD.WeaponLevelUpNotification.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	local SubtitleText = LUI.UIText.new( 0, 0, 206, 406, 0, 0, 247, 272 )
	...
	self.WeaponImage:linkToElementModel( self, "icon", true, function ( model )
		...
		if f7_local0 ~= nil then
			WeaponImage:setImage( CoD.BaseUtility.AlreadyRegistered( f7_local0 ) )
		end
	end )
...
CoD.WeaponLevelUpNotification.__resetProperties = function ( f10_arg0 )
...
CoD.WeaponLevelUpNotification.__clipsPerState = {
	DefaultState = {
...
CoD.WeaponLevelUpNotification.__onClose = function ( f70_arg0 )
