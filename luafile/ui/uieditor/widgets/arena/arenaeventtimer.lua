CoD.ArenaEventTimer = InheritFrom( LUI.UIElement )
CoD.ArenaEventTimer.__defaultWidth = 260
CoD.ArenaEventTimer.__defaultHeight = 14
CoD.ArenaEventTimer.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.ArenaEventTimer )
	self.id = "ArenaEventTimer"
	self.soundSet = "none"
	f1_arg0:addElementToPendingUpdateStateList( self )
	
	local EventEndsIn = LUI.UIText.new( 0, 0, 0, 260, 0, 0, 0, 14 )
	...
	EventEndsIn:setAlignment( Enum.LUIAlignment[0xF41D595A2B0EDF3] )
	EventEndsIn:setBackingType( 2 )
	EventEndsIn:setBackingColor( 0, 0, 0 )
	EventEndsIn:setBackingAlpha( 0.9 )
	EventEndsIn:setBackingXPadding( 4 )
	EventEndsIn:setBackingYPadding( 2 )
	self:addElement( EventEndsIn )
	self.EventEndsIn = EventEndsIn
	
	local EventStartsIn = LUI.UIText.new( 0, 0, 0, 260, 0, 0, 0, 14 )
	...
	EventStartsIn:setAlignment( Enum.LUIAlignment[0xF41D595A2B0EDF3] )
	EventStartsIn:setBackingType( 2 )
	EventStartsIn:setBackingColor( 0, 0, 0 )
	EventStartsIn:setBackingAlpha( 0.9 )
	EventStartsIn:setBackingXPadding( 4 )
	EventStartsIn:setBackingYPadding( 2 )
