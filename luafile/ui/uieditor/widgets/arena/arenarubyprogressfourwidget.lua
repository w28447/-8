...
CoD.ArenaRubyProgressFourWidget = InheritFrom( LUI.UIElement )
CoD.ArenaRubyProgressFourWidget.__defaultWidth = 926
CoD.ArenaRubyProgressFourWidget.__defaultHeight = 40
CoD.ArenaRubyProgressFourWidget.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.ArenaRubyProgressFourWidget )
	self.id = "ArenaRubyProgressFourWidget"
	self.soundSet = "none"
	self.anyChildUsesUpdateState = true
	f1_arg0:addElementToPendingUpdateStateList( self )
	
	local RedBar01 = CoD.ArenaRubyProgressRedBar.new( f1_arg0, f1_arg1, 0, 0, -90, 309, 0, 0, -7, 43 )
	self:addElement( RedBar01 )
	self.RedBar01 = RedBar01
	
	local RedBar02 = CoD.ArenaRubyProgressRedBar.new( f1_arg0, f1_arg1, 0, 0, 145.5, 544.5, 0, 0, -7, 43 )
	self:addElement( RedBar02 )
	self.RedBar02 = RedBar02
	
	local RedBar03 = CoD.ArenaRubyProgressRedBar.new( f1_arg0, f1_arg1, 0, 0, 382, 780, 0, 0, -7, 43 )
	self:addElement( RedBar03 )
	self.RedBar03 = RedBar03
	
	local RedBar04 = CoD.ArenaRubyProgressRedBar.new( f1_arg0, f1_arg1, 0, 0, 616.5, 1015.5, 0, 0, -7, 43 )
	self:addElement( RedBar04 )
	self.RedBar04 = RedBar04
	
	local frame1 = LUI.UIImage.new( 0, 0, 90, 130, 0, 0, 0, 40 )
	frame1:setImage( RegisterImage( 0x81EAB9F8F5950E7 ) )
	self:addElement( frame1 )
	self.frame1 = frame1
	
	local gem1 = LUI.UIImage.new( 0, 0, 90, 130, 0, 0, 0, 40 )
	gem1:setAlpha( 0 )
	gem1:setImage( RegisterImage( 0x17ED8E3A9A3FC36 ) )
	self:addElement( gem1 )
	self.gem1 = gem1
	
	local frame2 = LUI.UIImage.new( 0, 0, 325, 365, 0, 0, 0, 40 )
	frame2:setImage( RegisterImage( 0x81EAB9F8F5950E7 ) )
	self:addElement( frame2 )
	self.frame2 = frame2
	
	local gem2 = LUI.UIImage.new( 0, 0, 325, 365, 0, 0, 0, 40 )
	gem2:setAlpha( 0 )
	gem2:setImage( RegisterImage( 0x17ED8E3A9A3FC36 ) )
	self:addElement( gem2 )
	self.gem2 = gem2
	
	local frame3 = LUI.UIImage.new( 0, 0, 561, 601, 0, 0, 0, 40 )
	frame3:setImage( RegisterImage( 0x81EAB9F8F5950E7 ) )
	self:addElement( frame3 )
	self.frame3 = frame3
	
	local gem3 = LUI.UIImage.new( 0, 0, 561, 601, 0, 0, 0, 40 )
	gem3:setAlpha( 0 )
	gem3:setImage( RegisterImage( 0x17ED8E3A9A3FC36 ) )
	self:addElement( gem3 )
	self.gem3 = gem3
	
	local frame4 = LUI.UIImage.new( 0, 0, 796, 836, 0, 0, 0, 40 )
	frame4:setImage( RegisterImage( 0x81EAB9F8F5950E7 ) )
	self:addElement( frame4 )
	self.frame4 = frame4
	
	local gem4 = LUI.UIImage.new( 0, 0, 796, 836, 0, 0, 0, 40 )
	gem4:setAlpha( 0 )
...
CoD.ArenaRubyProgressFourWidget.__resetProperties = function ( f2_arg0 )
...
CoD.ArenaRubyProgressFourWidget.__clipsPerState = {
	DefaultState = {
	...
	OneRuby = {
		DefaultClip = function ( f4_arg0, f4_arg1 )
			...
			local f4_local0 = function ( f5_arg0 )
				f4_arg0.RedBar01:beginAnimation( 300, Enum[0xF50FFF429AB1890][0x6F6186B702830BC] )
				f4_arg0.RedBar01.RedBar01:beginAnimation( 300, Enum[0xF50FFF429AB1890][0x6F6186B702830BC] )
				f4_arg0.RedBar01.FocusGlow01:beginAnimation( 300, Enum[0xF50FFF429AB1890][0x6F6186B702830BC] )
				f4_arg0.RedBar01.Dot01:beginAnimation( 300, Enum[0xF50FFF429AB1890][0x6F6186B702830BC] )
...
CoD.ArenaRubyProgressFourWidget.__onClose = function ( f16_arg0 )
	f16_arg0.RedBar01:close()
	f16_arg0.RedBar02:close()
	f16_arg0.RedBar03:close()
	f16_arg0.RedBar04:close()
end
