CoD.CallingCards_Asset_birds_white = InheritFrom( LUI.UIElement )
CoD.CallingCards_Asset_birds_white.__defaultWidth = 184
CoD.CallingCards_Asset_birds_white.__defaultHeight = 360
CoD.CallingCards_Asset_birds_white.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.CallingCards_Asset_birds_white )
	self.id = "CallingCards_Asset_birds_white"
	...
	birds:setImage( RegisterImage( "uie_birdflap_white" ) )
	...
	birds2:setImage( RegisterImage( "uie_birdflap_white" ) )
	...
	birds3:setImage( RegisterImage( "uie_birdflap_white" ) )
	...
	birds4:setImage( RegisterImage( "uie_birdflap_white" ) )
	...
	birds5:setImage( RegisterImage( "uie_birdflap_white" ) )
	...
	birds6:setImage( RegisterImage( "uie_birdflap_white" ) )
