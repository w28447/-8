...
CoD.callingcards_code_cc = InheritFrom( LUI.UIElement )
CoD.callingcards_code_cc.__defaultWidth = 960
CoD.callingcards_code_cc.__defaultHeight = 240
CoD.callingcards_code_cc.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.callingcards_code_cc )
...
CoD.callingcards_code_cc.__resetProperties = function ( f2_arg0 )
	f2_arg0.truck:completeAnimation()
end

CoD.callingcards_code_cc.__clipsPerState = {
	DefaultState = {
...
CoD.callingcards_code_cc.__onClose = function ( f4_arg0 )
	f4_arg0.truck:close()
end
