require( "ui/uieditor/widgets/callingcards/callingcards_cardwidgetinternal" )

CoD.CallingCards_CardWidget = InheritFrom( LUI.UIElement )
CoD.CallingCards_CardWidget.__defaultWidth = 360
CoD.CallingCards_CardWidget.__defaultHeight = 90
CoD.CallingCards_CardWidget.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	local CallingCards = CoD.CallingCards_CardWidgetInternal.new( f1_arg0, f1_arg1, 0.5, 0.5, -180, 180, 0.5, 0.5, -45, 45 )
...
CoD.CallingCards_CardWidget.__resetProperties = function ( f3_arg0 )
	f3_arg0.CallingCards:completeAnimation()
	f3_arg0.CallingCards:setScale( 1, 1 )
end

CoD.CallingCards_CardWidget.__clipsPerState = {
	DefaultState = {
...
CoD.CallingCards_CardWidget.__onClose = function ( f10_arg0 )
