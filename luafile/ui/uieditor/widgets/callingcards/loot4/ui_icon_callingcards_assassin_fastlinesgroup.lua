...
CoD.ui_icon_callingcards_assassin_fastlinesgroup.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	fastlines2:setImage( RegisterImage( "uie_ui_icon_callingcards_assassin_fastlines" ) )
	...
	Image:setAlpha( 0.3 )
	Image:setYRot( 180 )
	Image:setImage( RegisterImage( "uie_ui_icon_callingcards_assassin_fastlines" ) )
	...
	fastlines:setImage( RegisterImage( "uie_ui_icon_callingcards_assassin_fastlines" ) )
	...
	Image2:setAlpha( 0.3 )
	Image2:setYRot( 180 )
	Image2:setImage( RegisterImage( "uie_ui_icon_callingcards_assassin_fastlines" ) )
