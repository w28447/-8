	...
	DefaultState = {
		DefaultClip = function ( f3_arg0, f3_arg1 )
			...
			local f3_local1 = function ( f8_arg0 )
				...
				f3_arg0.laserlight:registerEventHandler( "transition_complete_keyframe", f8_local0 )
			end
			...
			local f3_local3 = function ( f14_arg0 )
				local f14_local0 = function ( f15_arg0 )
					local f15_local0 = function ( f16_arg0 )
						local f16_local0 = function ( f17_arg0 )
							local f17_local0 = function ( f18_arg0 )
											...
											local f21_local0 = function ( f22_arg0 )
												local f22_local0 = function ( f23_arg0 )
													local f23_local0 = function ( f24_arg0 )
																...
																local f26_local0 = function ( f27_arg0 )
																	local f27_local0 = function ( f28_arg0 )
																		local f28_local0 = function ( f29_arg0 )
																			f29_arg0:beginAnimation( 230 )
																			f29_arg0:setTopBottom( 0, 0, 139, 243 )
																			f29_arg0:registerEventHandler( "transition_complete_keyframe", f3_arg0.clipFinished )
																		end
																		
																		f28_arg0:beginAnimation( 269 )
																		f28_arg0:setTopBottom( 0, 0, 145, 249 )
																		f28_arg0:registerEventHandler( "transition_complete_keyframe", f28_local0 )
																	end
																	
																	f27_arg0:beginAnimation( 230 )
																	f27_arg0:setTopBottom( 0, 0, 139, 243 )
																	f27_arg0:registerEventHandler( "transition_complete_keyframe", f27_local0 )
																end
																
																f26_arg0:beginAnimation( 260 )
																f26_arg0:setTopBottom( 0, 0, 145, 249 )
														...
														f24_arg0:beginAnimation( 230 )
														f24_arg0:setTopBottom( 0, 0, 139, 243 )
														f24_arg0:registerEventHandler( "transition_complete_keyframe", f24_local0 )
													end
													
													f23_arg0:beginAnimation( 260 )
													f23_arg0:setTopBottom( 0, 0, 145, 249 )
													f23_arg0:registerEventHandler( "transition_complete_keyframe", f23_local0 )
												end
												
												f22_arg0:beginAnimation( 269 )
												f22_arg0:registerEventHandler( "transition_complete_keyframe", f22_local0 )
											end
											
											f21_arg0:beginAnimation( 230 )
											f21_arg0:setTopBottom( 0, 0, 139, 243 )
											f21_arg0:registerEventHandler( "transition_complete_keyframe", f21_local0 )
										end
										
										f20_arg0:beginAnimation( 260 )
										f20_arg0:setTopBottom( 0, 0, 145, 249 )
								...
								f18_arg0:beginAnimation( 230 )
								f18_arg0:setTopBottom( 0, 0, 139, 243 )
								f18_arg0:registerEventHandler( "transition_complete_keyframe", f18_local0 )
							end
							
							f17_arg0:beginAnimation( 260 )
							f17_arg0:setTopBottom( 0, 0, 145, 249 )
					...
					f15_arg0:beginAnimation( 230 )
					f15_arg0:setTopBottom( 0, 0, 139, 243 )
				...
				f3_arg0.racoonTail:registerEventHandler( "transition_complete_keyframe", f14_local0 )
			end
			...
			local f3_local4 = function ( f30_arg0 )
				...
				f3_arg0.firePlate:registerEventHandler( "transition_complete_keyframe", f30_local0 )
			end
			...
			local f3_local5 = function ( f34_arg0 )
				local f34_local0 = function ( f35_arg0 )
					local f35_local0 = function ( f36_arg0 )
						local f36_local0 = function ( f37_arg0 )
							f37_arg0:beginAnimation( 210 )
							f37_arg0:setZRot( -20 )
							f37_arg0:registerEventHandler( "transition_complete_keyframe", f3_arg0.clipFinished )
						end
						
						f36_arg0:beginAnimation( 1500 )
						f36_arg0:registerEventHandler( "transition_complete_keyframe", f36_local0 )
					end
					
					f35_arg0:beginAnimation( 260 )
					f35_arg0:setZRot( 17 )
				...
				f3_arg0.Larm:registerEventHandler( "transition_complete_keyframe", f34_local0 )
			end
			
			f3_arg0.Larm:completeAnimation()
			f3_arg0.Larm:setZRot( -20 )
			f3_local5( f3_arg0.Larm )
			local f3_local6 = function ( f38_arg0 )
				local f38_local0 = function ( f39_arg0 )
					local f39_local0 = function ( f40_arg0 )
						...
						f40_arg0:beginAnimation( 1500 )
						f40_arg0:registerEventHandler( "transition_complete_keyframe", f40_local0 )
					end
					
					f39_arg0:beginAnimation( 260 )
					f39_arg0:setZRot( -18 )
				...
				f3_arg0.Rarm:registerEventHandler( "transition_complete_keyframe", f38_local0 )
			end
			...
			local f3_local7 = function ( f42_arg0 )
					...
					local f43_local0 = function ( f44_arg0 )
						local f44_local0 = function ( f45_arg0 )
							local f45_local0 = function ( f46_arg0 )
								local f46_local0 = function ( f47_arg0 )
									local f47_local0 = function ( f48_arg0 )
										local f48_local0 = function ( f49_arg0 )
											local f49_local0 = function ( f50_arg0 )
												local f50_local0 = function ( f51_arg0 )
													local f51_local0 = function ( f52_arg0 )
														...
														f52_arg0:beginAnimation( 210 )
														f52_arg0:setTopBottom( 0, 0, -3, 165 )
														f52_arg0:setScale( 1, 1 )
														f52_arg0:registerEventHandler( "transition_complete_keyframe", f52_local0 )
													end
													
													f51_arg0:beginAnimation( 240 )
													f51_arg0:setTopBottom( 0, 0, 5, 173 )
													f51_arg0:setScale( 1.02, 0.98 )
											...
											f49_arg0:setTopBottom( 0, 0, -3, 165 )
											f49_arg0:setScale( 1, 1 )
											f49_arg0:registerEventHandler( "transition_complete_keyframe", f49_local0 )
										end
										
										f48_arg0:beginAnimation( 240 )
										f48_arg0:setTopBottom( 0, 0, 5, 173 )
										f48_arg0:setScale( 1.02, 0.98 )
								...
								f46_arg0:setTopBottom( 0, 0, -3, 165 )
								f46_arg0:setScale( 1, 1 )
								f46_arg0:registerEventHandler( "transition_complete_keyframe", f46_local0 )
							end
							
							f45_arg0:beginAnimation( 240 )
							f45_arg0:setTopBottom( 0, 0, 5, 173 )
							f45_arg0:setScale( 1.02, 0.98 )
							f45_arg0:registerEventHandler( "transition_complete_keyframe", f45_local0 )
						end
						
						f44_arg0:beginAnimation( 260 )
						f44_arg0:registerEventHandler( "transition_complete_keyframe", f44_local0 )
					end
					
					f43_arg0:beginAnimation( 240 )
					f43_arg0:setTopBottom( 0, 0, -3, 165 )
				...
				f3_arg0.racoonHead:registerEventHandler( "transition_complete_keyframe", f42_local0 )
			end
