...
CoD.TabletIcePickGadget_Internal.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	f1_arg0:AddButtonCallbackFunction( Players, f1_arg1, Enum.LUIButton[0x755DA1E2E7C263F], nil, function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( Players, f1_arg1, Enum.LUIButton[0x571F08AD84807E0], "ui_navright", function ( element, menu, controller, model )
		BlockGameFromKeyEvent( controller )
	...
	f1_arg0:AddButtonCallbackFunction( Vehicles, f1_arg1, Enum.LUIButton[0x755DA1E2E7C263F], nil, function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( Vehicles, f1_arg1, Enum.LUIButton[0x57783F8DA4AAEF], "ui_navleft", function ( element, menu, controller, model )
		BlockGameFromKeyEvent( controller )
		SetFocusToElement( self, "Equipment", controller )
	...
	f1_arg0:AddButtonCallbackFunction( Equipment, f1_arg1, Enum.LUIButton[0x571F08AD84807E0], "ui_navright", function ( element, menu, controller, model )
		BlockGameFromKeyEvent( controller )
	...
	f1_arg0:AddButtonCallbackFunction( Equipment, f1_arg1, Enum.LUIButton[0x57783F8DA4AAEF], "ui_navleft", function ( element, menu, controller, model )
		BlockGameFromKeyEvent( controller )
