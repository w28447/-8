...
CoD.TabletTak5_PlayerInfo.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	InfoStripe:setMaterial( LUI.UIImage.GetCachedMaterial( 0x2EEB1ECF1F211F5 ) )
	...
	InfoStripeAdd:setMaterial( LUI.UIImage.GetCachedMaterial( 0x2EEB1ECF1F211F5 ) )
	...
	InfoStripeAdd2:setMaterial( LUI.UIImage.GetCachedMaterial( 0x2EEB1ECF1F211F5 ) )
	...
	NoTargetText:setText( LocalizeToUpperString( 0x41C813D62359384 ) )
	...
	MaxedOutString:setText( LocalizeToUpperString( 0xDF37DF17685ED6D ) )
...
CoD.TabletTak5_PlayerInfo.__resetProperties = function ( f10_arg0 )
	...
	f10_arg0.MaxedOutString:setRFTMaterial( LUI.UIImage.GetCachedMaterial( 0x6B34AA3F39208EF ) )
	f10_arg0.MaxedOutString:setBackingMaterial( LUI.UIImage.GetCachedMaterial( 0x6B34AA3F39208EF ) )
	f10_arg0.MaxedOutString:setBackingMaterial( LUI.UIImage.GetCachedMaterial( 0x44484DDFAF5C093 ) )
	f10_arg0.InfoStripe:setRGB( 1, 1, 1 )
	f10_arg0.InfoStripe:setAlpha( 0 )
	f10_arg0.InfoStripe:setMaterial( LUI.UIImage.GetCachedMaterial( 0x2EEB1ECF1F211F5 ) )
	...
	f10_arg0.InfoStripeAdd:setMaterial( LUI.UIImage.GetCachedMaterial( 0x2EEB1ECF1F211F5 ) )
	...
	f10_arg0.InfoStripeAdd2:setMaterial( LUI.UIImage.GetCachedMaterial( 0x2EEB1ECF1F211F5 ) )
...
CoD.TabletTak5_PlayerInfo.__clipsPerState = {
	...
	MaxedOut = {
		DefaultClip = function ( f21_arg0, f21_arg1 )
			...
			f21_arg0.InfoStripe:setMaterial( LUI.UIImage.GetCachedMaterial( 0x2EEB1ECF1F211F5 ) )
			...
			f21_arg0.MaxedOutString:setRFTMaterial( LUI.UIImage.GetCachedMaterial( 0x6B34AA3F39208EF ) )
			f21_arg0.MaxedOutString:setBackingMaterial( LUI.UIImage.GetCachedMaterial( 0x6B34AA3F39208EF ) )
			f21_arg0.MaxedOutString:setBackingMaterial( LUI.UIImage.GetCachedMaterial( 0x44484DDFAF5C093 ) )
	...
	NoTarget = {
		DefaultClip = function ( f32_arg0, f32_arg1 )
			...
			f32_arg0.InfoStripe:setMaterial( LUI.UIImage.GetCachedMaterial( 0xE992BD5A540E2D ) )
			...
			f32_arg0.InfoStripeAdd:setMaterial( LUI.UIImage.GetCachedMaterial( 0x2EEB1ECF1F211F5 ) )
			...
			f32_arg0.InfoStripeAdd2:setMaterial( LUI.UIImage.GetCachedMaterial( 0x2EEB1ECF1F211F5 ) )
