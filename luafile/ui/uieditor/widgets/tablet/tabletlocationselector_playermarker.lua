CoD.TabletLocationSelector_PlayerMarker = InheritFrom( LUI.UIElement )
CoD.TabletLocationSelector_PlayerMarker.__defaultWidth = 50
CoD.TabletLocationSelector_PlayerMarker.__defaultHeight = 50
CoD.TabletLocationSelector_PlayerMarker.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.TabletLocationSelector_PlayerMarker )
	self.id = "TabletLocationSelector_PlayerMarker"
	self.soundSet = "none"
	f1_arg0:addElementToPendingUpdateStateList( self )
	
	local IconFrame = LUI.UIImage.new( 0.74, 0.74, -44, 20, 0.76, 0.76, -44, 20 )
	IconFrame:setAlpha( 0 )
	IconFrame:setScale( 1.74, 1.74 )
...
CoD.TabletLocationSelector_PlayerMarker.__resetProperties = function ( f2_arg0 )
	...
	f2_arg0.IconFrame:setScale( 1.74, 1.74 )
	f2_arg0.Icon:setRGB( 1, 1, 1 )
end

CoD.TabletLocationSelector_PlayerMarker.__clipsPerState = {
	DefaultState = {
