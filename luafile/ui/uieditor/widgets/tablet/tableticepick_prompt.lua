...
CoD.TabletIcePick_Prompt.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	Glow:setAlpha( 0 )
	Glow:setImage( RegisterImage( "blue_square_glow" ) )
	...
	FillFrameAdd:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_nineslice_add" ) )
	...
	LayoutLabelL:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_wipe_delta_normal" ) )
	...
	LayoutLabelR:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_wipe_delta_normal" ) )
