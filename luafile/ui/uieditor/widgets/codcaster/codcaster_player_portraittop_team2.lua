...
CoD.codcaster_player_portraittop_team2 = InheritFrom( LUI.UIElement )
CoD.codcaster_player_portraittop_team2.__defaultWidth = 132
CoD.codcaster_player_portraittop_team2.__defaultHeight = 156
CoD.codcaster_player_portraittop_team2.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.codcaster_player_portraittop_team2 )
	self.id = "codcaster_player_portraittop_team2"
	self.soundSet = "none"
	...
	local PlayerPortraitHoverBottom = CoD.PlayerPortraitHoverBottom.new( f1_arg0, f1_arg1, 0.5, 0.5, -66, 66, 0, 0, 90, 106 )
	...
	local CodCasterPortraitPlayerListEntrySpecialistHead = CoD.CodCasterPortraitPlayerListEntrySpecialistHead.new( f1_arg0, f1_arg1, 0.33, 0.83, 18.5, 18.5, -0.05, -0.05, 6, 79 )
	CodCasterPortraitPlayerListEntrySpecialistHead:setYRot( 180 )
	...
	local UltimateBackgroundPlayerPortrait = LUI.UIImage.new( 0, 0, -9, 101, 0, 0, -29, 81 )
	...
	local UltimateProgressFillPlayerPortrait = CoD.AmmoWidgetMP_Ultimate_Progress_Fill_Player_Portrait.new( f1_arg0, f1_arg1, 0, 0, -8, 102, 0, 0, -28, 82 )
	...
	local PlayerListEntryId = CoD.CodCasterPortraitPlayerListNumber.new( f1_arg0, f1_arg1, 0, 0, 8, 26, 0, 0, 4, 29 )
	...
	local PlayerListEntryPlayerName = CoD.codcaster_playerPortraitName.new( f1_arg0, f1_arg1, 0, 0, 6, 126, 0, 0, 57, 74 )
	PlayerListEntryPlayerName:linkToElementModel( self, nil, false, function ( model )
		PlayerListEntryPlayerName:setModel( model, f1_arg1 )
	end )
	...
	local PlayerDeadOverlay = LUI.UIImage.new( 0.5, 0.5, -61, 61, 0, 0, 3, 44 )
	...
	local CodCasterPortraitPlayerListEntryDeathMarker = CoD.CodCasterPortraitPlayerListEntryDeathMarker.new( f1_arg0, f1_arg1, 0, 0, 73.5, 116.5, 0, 0, 8.5, 51.5 )
	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				local f25_local0 = IsCodCasterProfileValueEqualTo( f1_arg1, "shoutcaster_ds_portrait_scorestreaks", 1 )
				if f25_local0 then
					f25_local0 = IsCodCasterProfileValueEqualTo( f1_arg1, "shoutcaster_ds_portrait_stats", 1 )
					if f25_local0 then
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f26_local0 = IsCodCasterProfileValueEqualTo( f1_arg1, "shoutcaster_ds_portrait_stats", 1 )
				if f26_local0 then
					f26_local0 = IsCodCasterProfileValueEqualTo( f1_arg1, "shoutcaster_ds_portrait_scorestreaks", 1 )
					if f26_local0 then
						f26_local0 = CoD.HUDUtility.IsGameTypeEqualToString( "bounty" )
						if f26_local0 then
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f27_local0 = IsCodCasterProfileValueEqualTo( f1_arg1, "shoutcaster_ds_portrait_scorestreaks", 1 )
				if f27_local0 then
					f27_local0 = IsCodCasterProfileValueEqualTo( f1_arg1, "shoutcaster_ds_portrait_stats", 0 )
					if f27_local0 then
						if not CoD.HUDUtility.IsGameTypeEqualToString( "bounty" ) then
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f28_local0 = IsCodCasterProfileValueEqualTo( f1_arg1, "shoutcaster_ds_portrait_stats", 1 )
				if f28_local0 then
					f28_local0 = IsCodCasterProfileValueEqualTo( f1_arg1, "shoutcaster_ds_portrait_scorestreaks", 0 )
					if f28_local0 then
...
CoD.codcaster_player_portraittop_team2.__resetProperties = function ( f38_arg0 )
	...
	f38_arg0.PlayerPortraitHoverBottom:setTopBottom( 0, 0, 90, 106 )
	f38_arg0.PlayerDeadOverlay:setTopBottom( 0, 0, 3, 44 )
	f38_arg0.PlayerDeadOverlay:setAlpha( 0 )
	f38_arg0.PlayerPortraitFocusTop:setTopBottom( 0, 0, -11, 5 )
end

CoD.codcaster_player_portraittop_team2.__clipsPerState = {
	DefaultState = {
	...
	fullDead = {
		DefaultClip = function ( f40_arg0, f40_arg1 )
			...
			f40_arg0.mediumBG:completeAnimation()
			f40_arg0.mediumBG:setAlpha( 1 )
			f40_arg0.clipFinished( f40_arg0.mediumBG )
			f40_arg0.PlayerPortraitFocusBottom:completeAnimation()
			f40_arg0.PlayerPortraitFocusBottom:setTopBottom( 0, 0, 147, 163 )
			f40_arg0.clipFinished( f40_arg0.PlayerPortraitFocusBottom )
			f40_arg0.PlayerPortraitHoverBottom:completeAnimation()
			f40_arg0.PlayerPortraitHoverBottom:setTopBottom( 0, 0, 147, 163 )
			f40_arg0.clipFinished( f40_arg0.PlayerPortraitHoverBottom )
			f40_arg0.ObjectiveStatus:completeAnimation()
			f40_arg0.ObjectiveStatus:setTopBottom( 1.05, 1.05, -8, 56 )
			...
			f40_arg0.ScrStkButtons:completeAnimation()
			f40_arg0.ScrStkButtons:setAlpha( 1 )
			f40_arg0.clipFinished( f40_arg0.ScrStkButtons )
			f40_arg0.PlayerDeadOverlay:completeAnimation()
			f40_arg0.PlayerDeadOverlay:setTopBottom( 0, 0, 3, 117 )
	...
	fullheistDead = {
		DefaultClip = function ( f41_arg0, f41_arg1 )
			...
			f41_arg0.PlayerPortraitFocusTop:completeAnimation()
			f41_arg0.PlayerPortraitFocusTop:setTopBottom( 0, 0, -11, 5 )
			f41_arg0.clipFinished( f41_arg0.PlayerPortraitFocusTop )
			...
			f41_arg0.mediumBG2:completeAnimation()
			f41_arg0.mediumBG2:setTopBottom( 0.5, 0.5, 8.5, 41.5 )
			f41_arg0.mediumBG2:setAlpha( 1 )
			f41_arg0.clipFinished( f41_arg0.mediumBG2 )
			f41_arg0.CodCasterPortraitPlayerListEntryExtra:completeAnimation()
			f41_arg0.CodCasterPortraitPlayerListEntryExtra:setTopBottom( 0.5, 0.5, 8.5, 41.5 )
			f41_arg0.CodCasterPortraitPlayerListEntryExtra:setAlpha( 1 )
			f41_arg0.clipFinished( f41_arg0.CodCasterPortraitPlayerListEntryExtra )
	...
	mediumstreakDead = {
		DefaultClip = function ( f42_arg0, f42_arg1 )
			...
			f42_arg0.mediumBG:completeAnimation()
			f42_arg0.mediumBG:setAlpha( 1 )
			f42_arg0.clipFinished( f42_arg0.mediumBG )
			...
			f42_arg0.ScrStkButtons:completeAnimation()
			f42_arg0.ScrStkButtons:setAlpha( 1 )
			f42_arg0.clipFinished( f42_arg0.ScrStkButtons )
			f42_arg0.PlayerDeadOverlay:completeAnimation()
			f42_arg0.PlayerDeadOverlay:setTopBottom( 0, 0, 3, 119 )
	...
	mediuminfoDead = {
		DefaultClip = function ( f43_arg0, f43_arg1 )
			...
			f43_arg0.CodCasterPortraitPlayerListEntryExtra:setTopBottom( 0.5, 0.5, 8.5, 41.5 )
			...
			f43_arg0.PlayerDeadOverlay:setTopBottom( 0, 0, 3, 85 )
	...
	fullheist = {
		DefaultClip = function ( f45_arg0, f45_arg1 )
			...
			f45_arg0.PlayerPortraitFocusTop:completeAnimation()
			f45_arg0.PlayerPortraitFocusTop:setTopBottom( 0, 0, -11, 5 )
			f45_arg0.clipFinished( f45_arg0.PlayerPortraitFocusTop )
			...
			f45_arg0.CodCasterPortraitPlayerListEntryExtra:setTopBottom( 0.5, 0.5, 8.5, 41.5 )
	...
	mediuminfo = {
		DefaultClip = function ( f47_arg0, f47_arg1 )
			...
			f47_arg0.CodCasterPortraitPlayerListEntryExtra:setTopBottom( 0.5, 0.5, 8.5, 41.5 )
...
CoD.codcaster_player_portraittop_team2.__onClose = function ( f48_arg0 )
	...
	f48_arg0.PlayerListEntryPlayerName:close()
