...
CoD.CodCasterLoadoutPrimaryWeapon = InheritFrom( LUI.UIElement )
CoD.CodCasterLoadoutPrimaryWeapon.__defaultWidth = 112
CoD.CodCasterLoadoutPrimaryWeapon.__defaultHeight = 76
CoD.CodCasterLoadoutPrimaryWeapon.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setUseCylinderMapping( true )
	self:setClass( CoD.CodCasterLoadoutPrimaryWeapon )
	self.id = "CodCasterLoadoutPrimaryWeapon"
	self.soundSet = "none"
	...
	local FixedAspectRatioImage = LUI.UIFixedAspectRatioImage.new( 0, 0, 10, 103, 0, 0, 9, 66 )
	FixedAspectRatioImage:setScale( 0.6, 0.6 )
	FixedAspectRatioImage:subscribeToGlobalModel( f1_arg1, "PerController", "primaryWeapon.item", function ( model )
		local f2_local0 = model:get()
		if f2_local0 ~= nil then
			FixedAspectRatioImage:setImage( RegisterImage( CoD.CodCasterUtility.GetPrimaryWeaponImage( f1_arg1, f2_local0 ) ) )
		end
	end )
...
CoD.CodCasterLoadoutPrimaryWeapon.__onClose = function ( f6_arg0 )
