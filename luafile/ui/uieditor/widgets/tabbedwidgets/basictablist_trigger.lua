...
CoD.basicTabList_Trigger = InheritFrom( LUI.UIElement )
CoD.basicTabList_Trigger.__defaultWidth = 1635
CoD.basicTabList_Trigger.__defaultHeight = 60
CoD.basicTabList_Trigger.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.basicTabList_Trigger )
	self.id = "basicTabList_Trigger"
	self.soundSet = "none"
	...
	CoD.GridAndListUtility.AddTriggerNavigation( f1_arg0, grid, f1_arg1 )
	return self
end
