...
CoD.VehicleGround_ModT2.__defaultWidth = 72
CoD.VehicleGround_ModT2.__defaultHeight = 54
CoD.VehicleGround_ModT2.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	local Image1 = LUI.UIImage.new( 0, 0, 0, 72, 0, 0, 0, 54 )
	Image1:setImage( RegisterImage( 0xE96BC34BB099609 ) )
	Image1:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_add" ) )
	self:addElement( Image1 )
	self.Image1 = Image1
	
	local Image0 = LUI.UIImage.new( 0, 0, 38, 50, 0, 0, 20, 32 )
	...
	DefaultState = {
		DefaultClip = function ( f5_arg0, f5_arg1 )
			...
			local f5_local0 = function ( f6_arg0 )
				...
				f5_arg0.Image0:beginAnimation( 200 )
