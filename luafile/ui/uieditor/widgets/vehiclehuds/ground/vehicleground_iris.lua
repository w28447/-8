...
CoD.VehicleGround_Iris.__defaultWidth = 1920
CoD.VehicleGround_Iris.__defaultHeight = 1080
CoD.VehicleGround_Iris.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	local OutterThinInternal0 = CoD.VehicleGround_IrisOutterThinInternal.new( f1_arg0, f1_arg1, 0, 0, -105, 2027, 0, 0, -202, 1212 )
	...
	local InnerContainer0 = CoD.VehicleGround_IrisInnerContainer.new( f1_arg0, f1_arg1, 0.5, 0.5, -960, 960, 0.5, 0.5, -586, 494 )
...
CoD.VehicleGround_Iris.__resetProperties = function ( f2_arg0 )
	...
	f2_arg0.InnerContainer0:setLeftRight( 0.5, 0.5, -960, 960 )
	f2_arg0.InnerContainer0:setTopBottom( 0.5, 0.5, -586, 494 )
	f2_arg0.InnerContainer0:setRGB( 1, 1, 1 )
...
CoD.VehicleGround_Iris.__clipsPerState = {
	DefaultState = {
		...
		StartUp = function ( f4_arg0, f4_arg1 )
			...
			f4_arg0.InnerContainer0:setLeftRight( 0.5, 0.5, -960, 960 )
			f4_arg0.InnerContainer0:setTopBottom( 0.5, 0.5, -586, 494 )
	...
	Zoom = {
		DefaultClip = function ( f27_arg0, f27_arg1 )
			...
			f27_arg0.IrisOutterEdge:completeAnimation()
			f27_arg0.IrisOutterEdge:setAlpha( 0.5 )
			f27_arg0.clipFinished( f27_arg0.IrisOutterEdge )
			f27_arg0.IrisOutterEdgeR:completeAnimation()
			f27_arg0.IrisOutterEdgeR:setAlpha( 0.5 )
			f27_arg0.clipFinished( f27_arg0.IrisOutterEdgeR )
			f27_arg0.OutterThinInternal0:completeAnimation()
			f27_arg0.OutterThinInternal0:setRGB( 0.23, 0.35, 0.75 )
			f27_arg0.OutterThinInternal0:setAlpha( 0.1 )
			f27_arg0.OutterThinInternal0:setZoom( 100 )
			f27_arg0.clipFinished( f27_arg0.OutterThinInternal0 )
			f27_arg0.InnerContainer0:completeAnimation()
			f27_arg0.InnerContainer0:setAlpha( 0.6 )
			f27_arg0.InnerContainer0:setZRot( -17 )
			f27_arg0.InnerContainer0:setZoom( 273 )
			f27_arg0.clipFinished( f27_arg0.InnerContainer0 )
		end,
		DefaultState = function ( f28_arg0, f28_arg1 )
			f28_arg0:__resetProperties()
			f28_arg0:setupElementClipCounter( 6 )
			local f28_local0 = function ( f29_arg0 )
				f28_arg0.OutterDigi0:beginAnimation( 590, Enum[0xF50FFF429AB1890][0x5193EA7825DC097] )
				f28_arg0.OutterDigi0:setAlpha( 0.5 )
				f28_arg0.OutterDigi0:registerEventHandler( "interrupted_keyframe", f28_arg0.clipInterrupted )
				f28_arg0.OutterDigi0:registerEventHandler( "transition_complete_keyframe", f28_arg0.clipFinished )
			end
			
			f28_arg0.OutterDigi0:completeAnimation()
			f28_arg0.OutterDigi0:setRGB( 1, 1, 1 )
			f28_arg0.OutterDigi0:setAlpha( 0 )
			f28_arg0.OutterDigi0:setZoom( 0 )
			f28_local0( f28_arg0.OutterDigi0 )
			local f28_local1 = function ( f30_arg0 )
				f28_arg0.IrisOutterEdge:beginAnimation( 890 )
				f28_arg0.IrisOutterEdge:setAlpha( 0 )
				f28_arg0.IrisOutterEdge:registerEventHandler( "interrupted_keyframe", f28_arg0.clipInterrupted )
				f28_arg0.IrisOutterEdge:registerEventHandler( "transition_complete_keyframe", f28_arg0.clipFinished )
			end
			
			f28_arg0.IrisOutterEdge:completeAnimation()
			f28_arg0.IrisOutterEdge:setRGB( 1, 1, 1 )
			f28_arg0.IrisOutterEdge:setAlpha( 0.5 )
			f28_local1( f28_arg0.IrisOutterEdge )
			local f28_local2 = function ( f31_arg0 )
				f28_arg0.IrisOutterEdgeR:beginAnimation( 890 )
				f28_arg0.IrisOutterEdgeR:setAlpha( 0 )
				f28_arg0.IrisOutterEdgeR:registerEventHandler( "interrupted_keyframe", f28_arg0.clipInterrupted )
				f28_arg0.IrisOutterEdgeR:registerEventHandler( "transition_complete_keyframe", f28_arg0.clipFinished )
			end
			
			f28_arg0.IrisOutterEdgeR:completeAnimation()
			f28_arg0.IrisOutterEdgeR:setRGB( 1, 1, 1 )
			f28_arg0.IrisOutterEdgeR:setAlpha( 0.5 )
			f28_local2( f28_arg0.IrisOutterEdgeR )
			local f28_local3 = function ( f32_arg0 )
				f28_arg0.OutterThinInternal0:beginAnimation( 600, Enum[0xF50FFF429AB1890][0x5193EA7825DC097] )
				f28_arg0.OutterThinInternal0:setRGB( 1, 1, 1 )
				f28_arg0.OutterThinInternal0:setAlpha( 0.9 )
				f28_arg0.OutterThinInternal0:setZoom( 0 )
				f28_arg0.OutterThinInternal0:registerEventHandler( "interrupted_keyframe", f28_arg0.clipInterrupted )
				f28_arg0.OutterThinInternal0:registerEventHandler( "transition_complete_keyframe", f28_arg0.clipFinished )
			end
			
			f28_arg0.OutterThinInternal0:completeAnimation()
			f28_arg0.OutterThinInternal0:setRGB( 0.23, 0.35, 0.75 )
			f28_arg0.OutterThinInternal0:setAlpha( 0.1 )
			f28_arg0.OutterThinInternal0:setZRot( 0 )
			f28_arg0.OutterThinInternal0:setZoom( 100 )
			f28_local3( f28_arg0.OutterThinInternal0 )
			local f28_local4 = function ( f33_arg0 )
				f28_arg0.InnerContainer0:beginAnimation( 710, Enum[0xF50FFF429AB1890][0x5193EA7825DC097] )
				f28_arg0.InnerContainer0:setAlpha( 0.9 )
				f28_arg0.InnerContainer0:setZRot( 0 )
				f28_arg0.InnerContainer0:setZoom( 0 )
				f28_arg0.InnerContainer0:registerEventHandler( "interrupted_keyframe", f28_arg0.clipInterrupted )
				f28_arg0.InnerContainer0:registerEventHandler( "transition_complete_keyframe", f28_arg0.clipFinished )
			end
			
			f28_arg0.InnerContainer0:completeAnimation()
			f28_arg0.InnerContainer0:setLeftRight( 0.5, 0.5, -960, 960 )
			f28_arg0.InnerContainer0:setTopBottom( 0.5, 0.5, -586, 494 )
			f28_arg0.InnerContainer0:setRGB( 1, 1, 1 )
			f28_arg0.InnerContainer0:setAlpha( 0.6 )
			f28_arg0.InnerContainer0:setZRot( -17 )
			f28_arg0.InnerContainer0:setZoom( 273 )
			f28_local4( f28_arg0.InnerContainer0 )
			local f28_local5 = function ( f34_arg0 )
				f28_arg0.OutterDigiAnimateIn:beginAnimation( 1340, Enum[0xF50FFF429AB1890][0x5193EA7825DC097] )
				f28_arg0.OutterDigiAnimateIn:setLeftRight( 0, 1, 0, 0 )
				f28_arg0.OutterDigiAnimateIn:registerEventHandler( "interrupted_keyframe", f28_arg0.clipInterrupted )
				f28_arg0.OutterDigiAnimateIn:registerEventHandler( "transition_complete_keyframe", f28_arg0.clipFinished )
			end
			
			f28_arg0.OutterDigiAnimateIn:completeAnimation()
			f28_arg0.OutterDigiAnimateIn:setLeftRight( 0, 1, -52, 52 )
			f28_arg0.OutterDigiAnimateIn:setTopBottom( 0, 1, 0, 0 )
			f28_arg0.OutterDigiAnimateIn:setRGB( 1, 1, 1 )
			f28_arg0.OutterDigiAnimateIn:setAlpha( 0 )
			f28_arg0.OutterDigiAnimateIn:setZoom( 0 )
			f28_local5( f28_arg0.OutterDigiAnimateIn )
		end
	}
}
CoD.VehicleGround_Iris.__onClose = function ( f35_arg0 )
	f35_arg0.OutterDigi0:close()
	f35_arg0.OutterThinInternal0:close()
	f35_arg0.InnerContainer0:close()
	f35_arg0.OutterDigiAnimateIn:close()
end
