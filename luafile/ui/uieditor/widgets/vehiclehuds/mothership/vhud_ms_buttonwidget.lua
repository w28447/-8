...
CoD.vhud_ms_ButtonWidget.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	prompt:setRFTMaterial( LUI.UIImage.GetCachedMaterial( 0x4E6CE42E0799F57 ) )
	...
	button:setZoom( 15 )
	button:setMaterial( LUI.UIImage.GetCachedMaterial( 0x4E6CE42E0799F57 ) )
	self:addElement( button )
	self.button = button
	
	local bind = LUI.UIText.new( 0.5, 0.5, -20, 20, 0.5, 0.5, -20, 20 )
	bind:setTTF( "default" )
	bind:setRFTMaterial( LUI.UIImage.GetCachedMaterial( 0x4E6CE42E0799F57 ) )
