...
CoD.vhud_agr_internal.__defaultWidth = 1920
CoD.vhud_agr_internal.__defaultHeight = 1080
CoD.vhud_agr_internal.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
...
CoD.vhud_agr_internal.__onClose = function ( f8_arg0 )
	f8_arg0.vhudagrreticle:close()
	f8_arg0.vhudagrButtonContainer:close()
end
