CoD.GenericIconButton_Container = InheritFrom( LUI.UIElement )
CoD.GenericIconButton_Container.__defaultWidth = 194
CoD.GenericIconButton_Container.__defaultHeight = 103
CoD.GenericIconButton_Container.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.GenericIconButton_Container )
	self.id = "GenericIconButton_Container"
...
CoD.GenericIconButton_Container.__resetProperties = function ( f2_arg0 )
...
CoD.GenericIconButton_Container.__clipsPerState = {
	DefaultState = {
