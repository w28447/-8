CoD.Warzone_EMP_Status = InheritFrom( LUI.UIElement )
CoD.Warzone_EMP_Status.__defaultWidth = 316
CoD.Warzone_EMP_Status.__defaultHeight = 88
CoD.Warzone_EMP_Status.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.Warzone_EMP_Status )
	self.id = "Warzone_EMP_Status"
	self.soundSet = "default"
	f1_arg0:addElementToPendingUpdateStateList( self )
	
	local Backer = LUI.UIImage.new( 0, 1, 0, 0, 0, 0, 0, 88 )
	Backer:setImage( RegisterImage( 0xA676AF219DA9603 ) )
...
CoD.Warzone_EMP_Status.__resetProperties = function ( f15_arg0 )
...
CoD.Warzone_EMP_Status.__clipsPerState = {
	DefaultState = {
