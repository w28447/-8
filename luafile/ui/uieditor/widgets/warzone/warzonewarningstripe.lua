CoD.WarzoneWarningStripe = InheritFrom( LUI.UIElement )
CoD.WarzoneWarningStripe.__defaultWidth = 392
CoD.WarzoneWarningStripe.__defaultHeight = 112
CoD.WarzoneWarningStripe.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.WarzoneWarningStripe )
	self.id = "WarzoneWarningStripe"
...
CoD.WarzoneWarningStripe.__resetProperties = function ( f2_arg0 )
...
CoD.WarzoneWarningStripe.__clipsPerState = {
	DefaultState = {
		DefaultClip = function ( f3_arg0, f3_arg1 )
			f3_arg0:__resetProperties()
			f3_arg0:setupElementClipCounter( 1 )
			local f3_local0 = function ( f4_arg0 )
				f3_arg0.LargeStripe:beginAnimation( 30000 )
