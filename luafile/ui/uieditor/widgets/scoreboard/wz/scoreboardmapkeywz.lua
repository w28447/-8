...
CoD.ScoreboardMapKeyWZ.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	MoveMarker.Action:setText( Engine[0xF9F1239CFD921FE]( "warzone/move_marker" ) )
	...
	BringCursor.ControllerDependentTextBox.KBMText:setText( Engine[0xF9F1239CFD921FE]( "key/mouse2" ) )
	BringCursor.Action:setText( Engine[0xF9F1239CFD921FE]( "warzone/bringcursor" ) )
	...
	Drag:setAlpha( 0 )
	Drag.ControllerDependentTextBox.KBMText:setText( Engine[0xF9F1239CFD921FE]( "key/mouse2" ) )
	Drag.Action:setText( Engine[0xF9F1239CFD921FE]( "warzone/drag" ) )
	...
	ZoomOut.ControllerDependentTextBox.KBMText:setText( Engine[0xF9F1239CFD921FE]( "key/mwheeldown" ) )
	ZoomOut.Action:setText( Engine[0xF9F1239CFD921FE]( "warzone/zoom_out" ) )
	...
	ZoomIn.ControllerDependentTextBox.KBMText:setText( Engine[0xF9F1239CFD921FE]( "key/mwheelup" ) )
	ZoomIn.Action:setText( Engine[0xF9F1239CFD921FE]( "warzone/zoom_in" ) )
	...
	PlaceWaypoint.ControllerDependentTextBox.KBMText:setText( Engine[0xF9F1239CFD921FE]( "key/mouse1" ) )
	PlaceWaypoint.Action:setText( Engine[0xF9F1239CFD921FE]( "warzone/place_waypoint" ) )
	...
	DeleteWaypoint.ControllerDependentTextBox.KBMText:setText( Engine[0xF9F1239CFD921FE]( "key/mouse3" ) )
	DeleteWaypoint.Action:setText( Engine[0xF9F1239CFD921FE]( "warzone/delete_waypoint" ) )
	...
	CloseMap.Action:setText( Engine[0xF9F1239CFD921FE]( "warzone/close_map" ) )
	...
	CenterCursor.Action:setText( Engine[0xF9F1239CFD921FE]( "warzone/marker_to" ) )
	...
	RepeatDotline01:setImage( RegisterImage( "uie_ui_menu_specialist_hub_repeat_dotline" ) )
	...
	RepeatDotline02:setImage( RegisterImage( "uie_ui_menu_specialist_hub_repeat_dotline" ) )
	...
	RepeatDotline03:setImage( RegisterImage( "uie_ui_menu_specialist_hub_repeat_dotline" ) )
	...
	RepeatDotline04:setImage( RegisterImage( "uie_ui_menu_specialist_hub_repeat_dotline" ) )
	...
	RepeatDotline05:setImage( RegisterImage( "uie_ui_menu_specialist_hub_repeat_dotline" ) )
	...
	RepeatDotline06:setImage( RegisterImage( "uie_ui_menu_specialist_hub_repeat_dotline" ) )
...
CoD.ScoreboardMapKeyWZ.__resetProperties = function ( f56_arg0 )
	...
	f56_arg0.DeleteWaypoint.ControllerDependentTextBox.KBMText:setText( Engine[0xF9F1239CFD921FE]( "key/mouse3" ) )
	f56_arg0.PlaceWaypoint:setLeftRight( 1, 1, -298, -42 )
	f56_arg0.PlaceWaypoint:setTopBottom( 1, 1, -221.5, -181.5 )
	f56_arg0.PlaceWaypoint.ControllerDependentTextBox.KBMText:setText( Engine[0xF9F1239CFD921FE]( "key/mouse1" ) )
	...
	f56_arg0.BringCursor.ControllerDependentTextBox.KBMText:setText( Engine[0xF9F1239CFD921FE]( "key/mouse2" ) )
	f56_arg0.BringCursor.Action:setText( Engine[0xF9F1239CFD921FE]( "warzone/bringcursor" ) )
...
CoD.ScoreboardMapKeyWZ.__clipsPerState = {
	...
	PC = {
		DefaultClip = function ( f58_arg0, f58_arg1 )
			...
			f58_arg0.BringCursor.ControllerDependentTextBox.KBMText:setText( Engine[0xF9F1239CFD921FE]( "key/mouse2" ) )
			f58_arg0.BringCursor.Action:setText( Engine[0xF9F1239CFD921FE]( "warzone/bringcursor" ) )
			...
			f58_arg0.PlaceWaypoint.ControllerDependentTextBox.KBMText:setText( Engine[0xF9F1239CFD921FE]( "key/mouse1" ) )
			...
			f58_arg0.DeleteWaypoint.ControllerDependentTextBox.KBMText:setText( Engine[0xF9F1239CFD921FE]( "key/mouse3" ) )
			...
			f58_arg0.CloseMap.ControllerDependentTextBox.KBMText:setText( Engine[0xF9F1239CFD921FE]( "menu/map" ) )
