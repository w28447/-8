CoD.StoreCommonTextBacking = InheritFrom( LUI.UIElement )
CoD.StoreCommonTextBacking.__defaultWidth = 324
CoD.StoreCommonTextBacking.__defaultHeight = 53
CoD.StoreCommonTextBacking.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.StoreCommonTextBacking )
	self.id = "StoreCommonTextBacking"
