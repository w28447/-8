...
CoD.BonuscardUtility.GetBonucardUnlockHint = function ( f22_arg0, f22_arg1 )
	...
	return Engine.Localize( "mpui/item_unlocks_at_lvl", Engine.GetItemName( f22_local0, Enum[0x6EB546760F890D2][0x1A949B83CC070B0], f22_arg1 ), Engine.GetItemUnlockLevel( f22_local0, Enum[0x6EB546760F890D2][0x1A949B83CC070B0], f22_arg1 ) + 1 )
end
