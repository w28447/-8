...
LUI.createMenu.PositionDraft_Teams = function ( f1_arg0, f1_arg1 )
	...
	Ring:setAlpha( 0.5 )
	Ring:setImage( RegisterImage( "uie_ui_hud_common_draft_timer_fui" ) )
	...
	VS2:setText( Engine[0xF9F1239CFD921FE]( "mp/versus" ) )
	...
	TeamStripBase:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_tile_scroll_normal" ) )
	...
	EnemyStripBase:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_tile_scroll_normal" ) )
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum.LUIButton[0x805EFA15E9E7E5A], nil, function ( element, menu, controller, model )
		...
		CoD.Menu.SetButtonLabel( menu, Enum.LUIButton[0x805EFA15E9E7E5A], "challenge/backdraft", nil, nil )
		return true
	end, false )
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum.LUIButton[0x93AB4C84F113EE1], "TAB", function ( element, menu, controller, model )
		GoBack( self, controller )
		return true
	end, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum.LUIButton[0x93AB4C84F113EE1], "", nil, "TAB" )
		return false
	end, false )
