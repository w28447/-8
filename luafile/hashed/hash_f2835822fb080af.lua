...
CoD.textSize = {}
if Enum[0xAA0EE37DF15F5A8].language_russian == Dvar[0xA97AE527D90FB24]:get() then
	CoD.textSize.ExtraSmall = 20
	CoD.textSize.Default = 21
	CoD.textSize.Condensed = 24
	CoD.textSize.Big = 36
elseif Enum[0xAA0EE37DF15F5A8].language_polish == Dvar[0xA97AE527D90FB24]:get() then
	CoD.textSize.ExtraSmall = 16
	CoD.textSize.Default = 19
	CoD.textSize.Condensed = 21
	CoD.textSize.Big = 32
elseif Enum[0xAA0EE37DF15F5A8].language_japanese == Dvar[0xA97AE527D90FB24]:get() or Enum[0xAA0EE37DF15F5A8][0x9A4194D08679C69] == Dvar[0xA97AE527D90FB24]:get() then
...
CoD.GetRankName = function ( f19_arg0, f19_arg1, f19_arg2 )
	...
	elseif f19_arg1 == 0 then
		return Engine[0xF9F1239CFD921FE]( CoD.RankUtility.GetRankInfoField( f19_arg2, f19_arg0, 0x3E538ACFBFDD718, "" ) )
	elseif f19_arg1 == CoD.PrestigeUtility.GetPrestigeCap( f19_arg2 ) then
		return Engine[0xF9F1239CFD921FE]( "menu/prestige_master" )
	else
		return Engine[0xF9F1239CFD921FE]( "mpui/prestige_n", f19_arg1 )
	end
end
