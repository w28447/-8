...
CoD.EquippedBGBContainer.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	f1_arg0:AddButtonCallbackFunction( UpBGB, f1_arg1, Enum.LUIButton[0x755DA1E2E7C263F], nil, function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( RightBGB, f1_arg1, Enum.LUIButton[0x755DA1E2E7C263F], nil, function ( element, menu, controller, model )
		if not IsCurrentMenu( menu, "BubblegumBuffSelect" ) then
			CoD.BaseUtility.SetControllerModelToSelfModelValue( controller, element, "BGBLoadout.selectedIndex", "slotIndex" )
			CoD.ZMLoadoutUtility.OpenBGBSelectionMenu( self, menu, controller, self )
			return true
	...
	f1_arg0:AddButtonCallbackFunction( DownBGB, f1_arg1, Enum.LUIButton[0x755DA1E2E7C263F], nil, function ( element, menu, controller, model )
		if not IsCurrentMenu( menu, "BubblegumBuffSelect" ) then
			CoD.BaseUtility.SetControllerModelToSelfModelValue( controller, element, "BGBLoadout.selectedIndex", "slotIndex" )
			CoD.ZMLoadoutUtility.OpenBGBSelectionMenu( self, menu, controller, self )
			return true
	...
	f1_arg0:AddButtonCallbackFunction( LeftBGB, f1_arg1, Enum.LUIButton[0x755DA1E2E7C263F], nil, function ( element, menu, controller, model )
		if not IsCurrentMenu( menu, "BubblegumBuffSelect" ) then
			CoD.BaseUtility.SetControllerModelToSelfModelValue( controller, element, "BGBLoadout.selectedIndex", "slotIndex" )
			CoD.ZMLoadoutUtility.OpenBGBSelectionMenu( self, menu, controller, self )
			return true
