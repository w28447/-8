...
LUI.createMenu.FTUEInfoScreen = function ( f1_arg0, f1_arg1 )
	...
	f1_local1:AddButtonCallbackFunction( PCButton2, f1_arg0, Enum.LUIButton[0x755DA1E2E7C263F], "ui_confirm", function ( element, menu, controller, model )
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum.LUIButton[0x755DA1E2E7C263F], "MOUSE1", function ( element, menu, controller, model )
		...
		if not IsPC() and not IsRepeatButtonPress( f24_local0 ) and CoD.ModelUtility.IsModelValueEqualToEnum( controller, "FTUEInfo.layout", CoD.FTUEUtility.FTUELayouts.StoreUpsell ) then
			CoD.Menu.SetButtonLabel( menu, Enum.LUIButton[0x755DA1E2E7C263F], "menu/purchase", Enum[0xBEBDBAEEB3ECCCA][0x71B04FAC5BE0E35] | 750 << Enum[0xBEBDBAEEB3ECCCA][0x76ADD225D738C93], "MOUSE1" )
			return true
		elseif not IsPC() and not IsRepeatButtonPress( f24_local0 ) and CoD.ModelUtility.IsModelValueEqualToEnum( controller, "FTUEInfo.layout", CoD.FTUEUtility.FTUELayouts.PromoEvent ) then
			CoD.Menu.SetButtonLabel( menu, Enum.LUIButton[0x755DA1E2E7C263F], "menu/black_market", Enum[0xBEBDBAEEB3ECCCA][0x71B04FAC5BE0E35] | 750 << Enum[0xBEBDBAEEB3ECCCA][0x76ADD225D738C93], "MOUSE1" )
			return true
		elseif not IsPC() and not IsRepeatButtonPress( f24_local0 ) and CoD.ModelUtility.IsModelValueEqualToEnum( controller, "FTUEInfo.layout", CoD.FTUEUtility.FTUELayouts.HoldButtonEntries1 ) then
			CoD.Menu.SetButtonLabel( menu, Enum.LUIButton[0x755DA1E2E7C263F], "menu/continue", Enum[0xBEBDBAEEB3ECCCA][0x71B04FAC5BE0E35] | 750 << Enum[0xBEBDBAEEB3ECCCA][0x76ADD225D738C93], "MOUSE1" )
			return true
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum.LUIButton[0x805EFA15E9E7E5A], nil, function ( element, menu, controller, model )
		...
		elseif CoD.ModelUtility.IsModelValueEqualToEnum( controller, "FTUEInfo.layout", CoD.FTUEUtility.FTUELayouts.StoreUpsell ) then
			CoD.FTUEUtility.DismissCurrentSequence( self, controller )
			return true
