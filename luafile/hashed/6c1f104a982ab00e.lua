...
CoD.SpecialDealConfirmation = InheritFrom( CoD.Menu )
LUI.createMenu.SpecialDealConfirmation = function ( f1_arg0, f1_arg1 )
	local self = CoD.Menu.NewForUIEditor( "SpecialDealConfirmation", f1_arg0 )
	...
	self:setClass( CoD.SpecialDealConfirmation )
	...
	FullscreenPopupTemplate.ButtonList:setDataSource( "SpecialDealPurchaseList" )
	FullscreenPopupTemplate.Subtitle:setText( Engine[0xF9F1239CFD921FE]( 0x73FB71DD306C936 ) )
	FullscreenPopupTemplate.ErrorSubtitle:setText( LocalizeToUpperString( 0xA3298EE0A8F4603 ) )
	...
	FullscreenPopupTemplate:linkToElementModel( self, "percentOff", true, function ( model )
		...
		if f2_local0 ~= nil then
			FullscreenPopupTemplate.Title:setText( LocalizeToUpperString( CoD.BlackMarketUtility.GetSpecialDealConfirmationTitle( f2_local0 ) ) )
		end
	end )
	...
	local TextBox = LUI.UIText.new( 0.5, 0.5, -269, 211, 0.5, 0.5, -132, -110 )
	...
	local ImagePrompt = CoD.ImagePrompt.new( f1_local1, f1_arg0, 0.5, 0.5, -285, 195, 0.5, 0.5, -90, -30 )
	...
	local CratePurchaseTip = ImagePrompt
	local Price = ImagePrompt.subscribeToModel
	local f1_local22 = Engine.GetModelForController( f1_arg0 )
	...
	Price = LUI.UIText.new( 0.5, 0.5, -957, -327, 0.5, 0.5, 196, 222 )
	...
	CratePurchaseTip:subscribeToGlobalModel( f1_arg0, "TierPurchase", "CrateCost", function ( model )
		...
		if f10_local0 ~= nil then
			CratePurchaseTip.ImagePromptInternal.warningTextPrompt:setText( LocalizeIntoString( 0x856283FBFAE4074, f10_local0 ) )
		end
	end )
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum.LUIButton[0x805EFA15E9E7E5A], nil, function ( f14_arg0, f14_arg1, f14_arg2, f14_arg3 )
		if IsMenuInState( f14_arg1, "UnlockingTiers" ) then
			GoBackMultiple( f14_arg1, f14_arg2, 2 )
			return true
		elseif not IsElementInState( self.FullscreenPopupTemplate, "WorkingState" ) and not IsMenuInState( f14_arg1, "UnlockingTiers" ) then
			CoD.BlackMarketUtility.SendPurchaseTiersEvent( f14_arg2, f14_arg1 )
		...
		if IsMenuInState( f15_arg1, "UnlockingTiers" ) then
			CoD.Menu.SetButtonLabel( f15_arg1, Enum.LUIButton[0x805EFA15E9E7E5A], 0x70A9FDC87CD3D48, nil, nil )
			return true
		elseif not IsElementInState( self.FullscreenPopupTemplate, "WorkingState" ) and not IsMenuInState( f15_arg1, "UnlockingTiers" ) then
			CoD.Menu.SetButtonLabel( f15_arg1, Enum.LUIButton[0x805EFA15E9E7E5A], 0x70A9FDC87CD3D48, nil, nil )
			return true
		else
			return false
	...
	self.__on_menuOpened_self = function ( f16_arg0, f16_arg1, f16_arg2, f16_arg3 )
		...
		MenuHidesFreeCursor( f16_arg2, f16_arg1 )
	end
	...
	f1_local22 = FullscreenPopupTemplate
	if IsPC() then
		CoD.PCUtility.LinkPCSmallCloseButtonToInput( f1_local1, f1_arg0, f1_local22, Enum.LUIButton[0x805EFA15E9E7E5A] )
	end
	return self
end
...
CoD.SpecialDealConfirmation.__resetProperties = function ( f19_arg0 )
	...
	f19_arg0.TextBox:setLeftRight( 0.5, 0.5, -269, 211 )
...
CoD.SpecialDealConfirmation.__clipsPerState = {
	DefaultState = {
		DefaultClip = function ( f20_arg0, f20_arg1 )
			...
			f20_arg0.TextBox:setLeftRight( 0.5, 0.5, -269, 431 )
	...
	UnlockingTiers = {
		DefaultClip = function ( f21_arg0, f21_arg1 )
			...
			f21_arg0.SpinnerLoadingAnimation:setAlpha( 1 )
