...
CoD.PC_Korea_Event_TierProgress.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	CornerPips:setImage( RegisterImage( "uie_ui_hud_notifications_cornerpip" ) )
	...
	CornerPips2:setImage( RegisterImage( "uie_ui_hud_notifications_cornerpip" ) )
	...
	CornerPips3:setImage( RegisterImage( "uie_ui_hud_notifications_cornerpip" ) )
	...
	CornerPips4:setImage( RegisterImage( "uie_ui_hud_notifications_cornerpip" ) )
