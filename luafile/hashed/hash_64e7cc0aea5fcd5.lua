...
CoD.CharacterSelection_CustomCharacterFrameWidget.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	f1_arg0:AddButtonCallbackFunction( CustomCharacter, f1_arg1, Enum.LUIButton[0xE6DB407A2AF8B09], "ui_contextual_2", function ( element, menu, controller, model )
		...
		if IsGamepad( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum.LUIButton[0xE6DB407A2AF8B09], "menu/personalize_character", nil, "ui_contextual_2" )
			return true
		elseif not IsGamepad( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum.LUIButton[0xE6DB407A2AF8B09], "menu/personalize_character", Enum[0xBEBDBAEEB3ECCCA][0xB6372335C630AD3], "ui_contextual_2" )
			return true
		else
			return false
		end
	...
	CustomCharacter:AddContextualMenuAction( f1_arg0, f1_arg1, "menu/personalize_character", function ( f13_arg0, f13_arg1, f13_arg2, f13_arg3 )
	...
	f1_arg0:AddButtonCallbackFunction( Characters, f1_arg1, Enum.LUIButton[0xE6DB407A2AF8B09], "ui_contextual_2", function ( element, menu, controller, model )
	...
	Characters:AddContextualMenuAction( f1_arg0, f1_arg1, "menu/personalize_character", function ( f28_arg0, f28_arg1, f28_arg2, f28_arg3 )
	...
	DotPipR01:setImage( RegisterImage( "uie_ui_menu_specialist_hub_bot_frame_dot" ) )
	...
	DotPipR02:setImage( RegisterImage( "uie_ui_menu_specialist_hub_bot_frame_dot" ) )
	...
	DotPipL02:setImage( RegisterImage( "uie_ui_menu_specialist_hub_bot_frame_dot" ) )
	...
	DotPipL01:setImage( RegisterImage( "uie_ui_menu_specialist_hub_bot_frame_dot" ) )
