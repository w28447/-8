...
CoD.PlayerWidgetWZArmor.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	DestroyedLightArmorIcon:setImage( RegisterImage( "uie_ui_icon_armordamagestate_wz_light" ) )
	DestroyedLightArmorIcon:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_flipbook_animated" ) )
	...
	DestroyedMediumArmorIcon:setImage( RegisterImage( "uie_ui_icon_armordamagestate_wz_medium" ) )
	DestroyedMediumArmorIcon:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_flipbook_animated" ) )
	...
	DestroyedHeavyArmorIcon:setImage( RegisterImage( "uie_ui_icon_armordamagestate_wz_heavy" ) )
	DestroyedHeavyArmorIcon:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_flipbook_animated" ) )
