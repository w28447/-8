...
CoD.HVOCardInternal.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	BackerGold:setImage( RegisterImage( "uie_ui_hud_hvo_backer_gray" ) )
	self:addElement( BackerGold )
	self.BackerGold = BackerGold
	
	local BackerGray = LUI.UIImage.new( 0, 0, -0.5, 631.5, 0, 0, 0, 964 )
	BackerGray:setImage( RegisterImage( "uie_ui_hud_hvo_backer_gray" ) )
	...
	TeamBarAnim:setImage( RegisterImage( "uie_ui_hud_hvo_bar_animation" ) )
	...
	TeamBarBase:setImage( RegisterImage( "uie_ui_hud_hvo_bar" ) )
	...
	TeamBarMuted:setImage( RegisterImage( "uie_ui_hud_hvo_bar" ) )
	...
	TeamBarBright:setImage( RegisterImage( "uie_ui_hud_hvo_bar" ) )
	...
	TeamBarAnim2:setImage( RegisterImage( "uie_ui_hud_hvo_bar_animation" ) )
	...
	GlowBase:setAlpha( 0 )
	GlowBase:setImage( RegisterImage( "uie_ui_hud_hvo_glow" ) )
	...
	GlowMuted:setImage( RegisterImage( "uie_ui_hud_hvo_glow" ) )
	...
	GlowBright:setImage( RegisterImage( "uie_ui_hud_hvo_glow" ) )
