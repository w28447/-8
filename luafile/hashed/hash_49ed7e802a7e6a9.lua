...
CoD.PC_Korea_Event_Month_Reward.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	MonthRewardBG:setImage( RegisterImage( "uie_pc_igrevent_weekprogression_week_bg" ) )
	...
	YellowOverlay:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_glint_reveal" ) )
...
CoD.PC_Korea_Event_Month_Reward.__resetProperties = function ( f2_arg0 )
	...
	f2_arg0.YellowOverlay:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_glint_reveal" ) )
