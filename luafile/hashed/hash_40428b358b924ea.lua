...
CoD.Barracks_StatsOverview_WZ.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	TimePlayedText.__String_Reference = function ()
		TimePlayedText:setText( SecondsAsTimePlayedString( CoD.PlayerStatsUtility.GetWZGameModePlayerStorageStat( f1_arg1, f1_arg0, "time_played_total", "" ) ) )
	end
	...
	KillDeathRatio.StatHeaderText:setText( Engine[0xF9F1239CFD921FE]( "menu/kd_short" ) )
	...
	LongestDistanceKill.StatHeaderText:setText( LocalizeToUpperString( "menu/longest_distance_kill" ) )
