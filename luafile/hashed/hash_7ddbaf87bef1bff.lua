...
CoD.Archives_Videos = InheritFrom( LUI.UIElement )
CoD.Archives_Videos.__defaultWidth = 1920
CoD.Archives_Videos.__defaultHeight = 780
CoD.Archives_Videos.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.Archives_Videos )
	self.id = "Archives_Videos"
	self.soundSet = "none"
	...
	f1_arg0:AddButtonCallbackFunction( VideoList, f1_arg1, Enum.LUIButton[0x865DD2DB1EFE9F8], "MOUSE1", function ( element, menu, controller, model )
		...
		if CoD.ModelUtility.IsSelfModelValueNonEmptyString( element, controller, "video.hiResVideo.movieName" ) and not IsElementInState( element, "MatureContentFiltered" ) then
			CoD.Menu.SetButtonLabel( menu, Enum.LUIButton[0x865DD2DB1EFE9F8], 0xD31D493AE40DA0F, nil, "MOUSE1" )
			return true
		else
			return false
		end
...
CoD.Archives_Videos.__onClose = function ( f9_arg0 )
	f9_arg0.ArchivesVoDPreview:close()
	f9_arg0.VideoList:close()
end
