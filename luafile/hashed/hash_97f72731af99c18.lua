...
Lobby.JSON.CreateStartSearchParamDoc = function ( f29_arg0 )
	...
	if f29_local19.use_skill and not f29_local10 then
		f29_local18 = true
	end
	...
	Lobby.MatchmakingAsync.MatchmakingSearchSummaryLog.utc_timestamp_created = f29_local21
	Lobby.MatchmakingAsync.PartyToMatchSummary.utc_timestamp_created = f29_local21
