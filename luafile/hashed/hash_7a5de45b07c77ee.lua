...
LUI.createMenu.OpenBribeConfirmation = function ( f1_arg0, f1_arg1 )
	...
	ItemName:setText( LocalizeToUpperString( CoD.BlackMarketUtility.GetBribeNameFromMenuProperty( f1_arg0, f1_local1, "" ) ) )
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum.LUIButton[0x755DA1E2E7C263F], nil, function ( element, menu, controller, model )
		...
		CoD.BlackMarketUtility.OpenNonCPBribe( controller, menu )
		return true
	end, function ( element, menu, controller )
