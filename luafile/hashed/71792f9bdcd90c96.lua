...
CoD.TabbedMultiItemPickupItem.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	sizeElement:setMaterial( LUI.UIImage.GetCachedMaterial( 0xE125638BF94665F ) )
	...
	Brackets:setMaterial( LUI.UIImage.GetCachedMaterial( 0xFD777557404A7B3 ) )
	...
	Brackets2:setMaterial( LUI.UIImage.GetCachedMaterial( 0xFD777557404A7B3 ) )
	...
	Brackets3:setMaterial( LUI.UIImage.GetCachedMaterial( 0xFD777557404A7B3 ) )
	...
	pip1.image:setMaterial( LUI.UIImage.GetCachedMaterial( 0x6B34AA3F39208EF ) )
	...
	pip2.image:setMaterial( LUI.UIImage.GetCachedMaterial( 0x6B34AA3F39208EF ) )
	...
	pip3.image:setMaterial( LUI.UIImage.GetCachedMaterial( 0x6B34AA3F39208EF ) )
	...
	plusPip.image:setMaterial( LUI.UIImage.GetCachedMaterial( 0x6B34AA3F39208EF ) )
	...
	PickupHintImage:setMaterial( LUI.UIImage.GetCachedMaterial( 0x67D1E3A3D2D1BF ) )
...
CoD.TabbedMultiItemPickupItem.__clipsPerState = {
	...
	SpecialItem = {
		...
		Focus = function ( f72_arg0, f72_arg1 )
			...
			f72_arg0.BlackjackGlow:setMaterial( LUI.UIImage.GetCachedMaterial( 0x4E6CE42E0799F57 ) )
