...
LUI.createMenu.SpecialDealConfirmation = function ( f1_arg0, f1_arg1 )
	...
	ImagePrompt.ImagePromptInternal.warningIcon:setImage( RegisterImage( "uie_t7_icon_pregame_warning" ) )
	...
	CratePurchaseTip.ImagePromptInternal.warningIcon:setImage( RegisterImage( "uie_t7_icon_pregame_warning" ) )
	...
	CratePurchaseTip:subscribeToGlobalModel( f1_arg0, "TierPurchase", "CrateCost", function ( model )
		...
		if f10_local0 ~= nil then
			CratePurchaseTip.ImagePromptInternal.warningTextPrompt:setText( LocalizeIntoString( "menu/crate_tip", f10_local0 ) )
		end
	end )
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum.LUIButton[0x805EFA15E9E7E5A], nil, function ( element, menu, controller, model )
		...
		elseif not IsElementInState( self.FullscreenPopupTemplate, "WorkingState" ) and not IsMenuInState( menu, "UnlockingTiers" ) then
			CoD.BlackMarketUtility.SendPurchaseTiersEvent( controller, menu )
