...
CoD.WZTeamScoreboard.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	f1_arg0:AddButtonCallbackFunction( WZTeamScoreboard, f1_arg1, Enum.LUIButton[0x755DA1E2E7C263F], nil, function ( element, menu, controller, model )
		if not IsScoreboardPlayerSelf( element, controller ) and IsScoreboardPlayerMuted( controller, element ) then
			...
			UpdateButtonPromptState( menu, element, controller, Enum.LUIButton[0x755DA1E2E7C263F] )
			return true
		...
		if not IsScoreboardPlayerSelf( element, controller ) and IsScoreboardPlayerMuted( controller, element ) then
			CoD.Menu.SetButtonLabel( menu, Enum.LUIButton[0x755DA1E2E7C263F], "menu/unmute_player", nil, nil )
			return true
		elseif not IsScoreboardPlayerSelf( element, controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum.LUIButton[0x755DA1E2E7C263F], "menu/mute_player", nil, nil )
			return true
		else
			return false
		end
	...
	PlayerColumnHeader:setText( Engine[0xF9F1239CFD921FE]( "menu/player" ) )
	...
	Column1Header:setText( GetScoreboardColumnHeader( f1_arg1, 0, "" ) )
	...
	Column2Header:setText( GetScoreboardColumnHeader( f1_arg1, 1, "" ) )
	...
	Column3Header:setText( GetScoreboardColumnHeader( f1_arg1, 2, "" ) )
	...
	ColumnExtraHeader:setText( GetScoreboardColumnHeader( f1_arg1, 9, "" ) )
