...
CoD.RadiationBlastMeter.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	MeterRed:setAlpha( 0 )
	MeterRed:setImage( RegisterImage( "uie_ui_hud_radiation_meter_red" ) )
	...
	Radiation:setImage( RegisterImage( "uie_ui_hud_radiation_icon" ) )
	...
	CriticalGlow:setImage( RegisterImage( "uie_hud_radiationmeter_glow1" ) )
	...
	CriticalGlow2:setImage( RegisterImage( "uie_hud_radiationmeter_glow2" ) )
	...
	CriticalGlow3:setImage( RegisterImage( "uie_hud_radiationmeter_glow3" ) )
	...
	CriticalGlow4:setImage( RegisterImage( "uie_hud_radiationmeter_glow4" ) )
	...
	fui:setAlpha( 0.75 )
	fui:setImage( RegisterImage( "uie_ui_hud_radiation_fui" ) )
