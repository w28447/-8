...
LUI.createMenu.BountyHunterBuy = function ( f1_arg0, f1_arg1 )
	...
	f1_local1:AddButtonCallbackFunction( PCBackButton, f1_arg0, Enum.LUIButton[0x755DA1E2E7C263F], "ui_confirm", function ( element, menu, controller, model )
		if not IsVisibilityBitSet( controller, Enum.UIVisibilityBit[0xA69E34E231CE8B6] ) and not IsDemoPlaying() then
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum.LUIButton[0x805EFA15E9E7E5A], nil, function ( element, menu, controller, model )
		if not IsVisibilityBitSet( controller, Enum.UIVisibilityBit[0xA69E34E231CE8B6] ) and not IsMouseOrKeyboard( controller ) and not IsDemoPlaying() then
			CoD.BountyHunterUtility.ToggleBuyMenuVisible( self, controller, self.BountyHunterBuyInternal, self.BountyHunterOpenPrompt, self.PCBackButton )
			return true
		else
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum.LUIButton[0xC083113BC81F23F], nil, function ( element, menu, controller, model )
		...
		if IsBooleanDvarSet( "ui_bounty_undo_enabled" ) and CoD.ModelUtility.IsModelValueTrue( controller, "hudItems.bountyUndoValid" ) then
			CoD.Menu.SetButtonLabel( menu, Enum.LUIButton[0xC083113BC81F23F], "bounty_hunter/undo_last_purchase", Enum[0xBEBDBAEEB3ECCCA][0x2919C98A7A845F0] | 750 << Enum[0xBEBDBAEEB3ECCCA][0x76ADD225D738C93], nil )
			return true
		else
			return false
		end
