...
CoD.DeathCamPlayerKilledBy.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:mergeStateConditions( {
		...
		},
		{
			...
			condition = function ( menu, element, event )
				return CoD.SpawnSelectionUtility.IsSpawnSelectActive( f1_arg1 ) and CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg1, "hudItems.killedByMOD", Enum[0x52177B239BFECC1].mod_meta )
			end
		},
		{
