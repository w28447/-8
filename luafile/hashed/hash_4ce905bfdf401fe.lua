...
LUI.createMenu.FTUEZMInventoryMenu = function ( f1_arg0, f1_arg1 )
	...
	Title:setText( LocalizeToUpperString( "menu/loadouts_caps" ) )
	...
	InventoryImage:setImage( RegisterImage( "uie_ui_menu_ftue_zm_loadouts_perks" ) )
	...
	InventoryImage2:setImage( RegisterImage( "uie_ui_menu_ftue_zm_loadouts_elixirs_talismans" ) )
	...
	InventoryImage2PC:setImage( RegisterImage( "uie_ui_menu_ftue_zm_loadouts_elixirs_talismans_pc" ) )
	...
	InventoryImage3:setImage( RegisterImage( "uie_ui_menu_ftue_zm_loadouts_wpn_eq" ) )
	...
	ElixirInfo.InventoryTitleLabel:setText( LocalizeToUpperString( "menu/elixirs" ) )
	...
	TalismanInfo.InventoryTitleLabel:setText( LocalizeToUpperString( "menu/talismans_caps" ) )
	...
	PerksInfo.InventoryTitleLabel:setText( LocalizeToUpperString( "menu/perks" ) )
	...
	SpecialWeaponInfo.InventoryTitleLabel:setText( LocalizeToUpperString( "menu/special_weapons_caps" ) )
	...
	EquipmentInfo.InventoryTitleLabel:setText( LocalizeToUpperString( "menu/equipment" ) )
	...
	StartingWeaponInfo.InventoryTitleLabel:setText( LocalizeToUpperString( "menu/starting_weapon" ) )
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum.LUIButton[0x755DA1E2E7C263F], "MOUSE1", function ( element, menu, controller, model )
		CoD.FTUEUtility.AdvanceCurrentSequence( self, controller )
		GoBack( self, controller )
		PlaySoundAlias( "uin_toggle_generic" )
		return true
	end, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum.LUIButton[0x755DA1E2E7C263F], "menu/continue", nil, "MOUSE1" )
		return true
	end, false )
