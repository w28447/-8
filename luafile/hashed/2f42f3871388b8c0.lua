...
LUI.createMenu.BountyHunterPackageSelect = function ( f1_arg0, f1_arg1 )
	...
	HorizAccentTop2:setImage( RegisterImage( 0xFE30A9AF719A400 ) )
	HorizAccentTop2:setMaterial( LUI.UIImage.GetCachedMaterial( 0x44484DDFAF5C093 ) )
	...
	PCBackButton.Button.ButtonContainer.Title:setText( LocalizeToUpperString( 0x70A9FDC87CD3D48 ) )
	PCBackButton.GamepadTitle:setText( Engine[0xF9F1239CFD921FE]( 0x70A9FDC87CD3D48 ) )
