...
CoD.CharacterSelection_FeaturedGamesList.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	BO1.GameIcon:setImage( RegisterImage( "uie_ui_icon_wz_frontend_gameicon_bo1" ) )
	...
	BO2.GameIcon:setImage( RegisterImage( "uie_ui_icon_wz_frontend_gameicon_bo2" ) )
	...
	BO3.GameIcon:setImage( RegisterImage( "uie_ui_icon_wz_frontend_gameicon_bo3" ) )
	...
	BO4.GameIcon:setImage( RegisterImage( "uie_ui_icon_wz_frontend_gameicon_bo4" ) )
