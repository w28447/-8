...
CoD.remoteMissileTargetLockonInternal.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	BaseLine:setAlpha( 0 )
	BaseLine:setImage( RegisterImage( "uie_ui_hud_vehicle_hellstorm_enemyindicatorbaseline" ) )
	...
	Base:setAlpha( 0 )
	Base:setImage( RegisterImage( "uie_ui_hud_vehicle_hellstorm_enemyindicatorbase" ) )
	...
	BaseAdd:setAlpha( 0 )
	BaseAdd:setImage( RegisterImage( "uie_ui_hud_vehicle_hellstorm_enemyindicatorbaseline" ) )
	...
	ReticleAdd:setImage( RegisterImage( "uie_ui_hud_vehicle_hellstorm_enemyindicator" ) )
	...
	HawkLockOnTertiary:setImage( RegisterImage( "uie_ui_hud_reticles_hawk_lock_tertiary" ) )
	...
	HawkEKIA:setAlpha( 0 )
	HawkEKIA:setImage( RegisterImage( "uie_ui_hud_reticles_hawk_lock_ekia" ) )
	...
	HawkEKIAAdd:setImage( RegisterImage( "uie_ui_hud_reticles_hawk_lock_ekia_add" ) )
