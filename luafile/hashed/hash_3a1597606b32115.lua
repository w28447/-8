...
LUI.createMenu.PositionDraft = function ( f2_arg0, f2_arg1 )
	...
	f2_local1:AddButtonCallbackFunction( ChangeClassButton, f2_arg0, Enum.LUIButton[0x755DA1E2E7C263F], "ui_confirm", function ( element, menu, controller, model )
	...
	self:registerEventHandler( "menu_loaded", function ( self, event )
		...
		if self.menuLoaded then
			f47_local0 = self:menuLoaded( event )
		elseif self.super.menuLoaded then
			f47_local0 = self.super:menuLoaded( event )
		end
		if not IsPC() then
			SizeToSafeArea( self, f2_arg0 )
		end
	...
	f2_local1:AddButtonCallbackFunction( self, f2_arg0, Enum.LUIButton[0x805EFA15E9E7E5A], "ESCAPE", function ( element, menu, controller, model )
		...
		elseif IsMenuInState( menu, "EditLoadout" ) then
			SetLoseFocusToElement( self, "StartMenuEditLoadout", controller )
			SetState( self, "CharacterSelected", controller )
			SaveLoadout( self, controller )
			SendClientScriptNotify( controller, "PositionDraft_Loadout", "0" )
		...
		if not PlayerReadiedUp( controller ) and IsElementInAnyState( menu, "CharacterSelectedPC", "CharacterSelected" ) then
			...
			return true
		elseif IsMenuInState( menu, "EditLoadout" ) then
			CoD.Menu.SetButtonLabel( menu, Enum.LUIButton[0x805EFA15E9E7E5A], "mpui/done", nil, "ESCAPE" )
			return true
		else
			return false
		end
	end, false )
	f2_local1:AddButtonCallbackFunction( self, f2_arg0, Enum.LUIButton[0x755DA1E2E7C263F], "MOUSE1", function ( element, menu, controller, model )
		...
		if CoD.BaseUtility.DoesElementOrChildHaveFocus( self, "PositionDraftReadyButton" ) and CoD.BaseUtility.IsWidgetVisible( self.PositionDraftReadyButton ) and CoD.ModelUtility.IsControllerModelValueTrue( controller, "PositionDraft.characterSelected" ) then
			CoD.Menu.SetButtonLabel( menu, Enum.LUIButton[0x755DA1E2E7C263F], "", Enum[0xBEBDBAEEB3ECCCA][0x2919C98A7A845F0] | 750 << Enum[0xBEBDBAEEB3ECCCA][0x76ADD225D738C93], "MOUSE1" )
			return false
		else
			return false
		end
	end, false )
	f2_local1:AddButtonCallbackFunction( self, f2_arg0, Enum.LUIButton[0x22361E23588705A], nil, function ( element, menu, controller, model )
		...
		if not CoD.ModelUtility.IsModelValueEqualTo( controller, "PositionDraft.stage", 6 ) and not IsPC() then
			...
			return false
		elseif not CoD.ModelUtility.IsModelValueEqualTo( controller, "PositionDraft.stage", 6 ) and IsCustomLobby() and IsGamepad( controller ) and IsPC() then
			CoD.Menu.SetButtonLabel( menu, Enum.LUIButton[0x22361E23588705A], "mpui/change_team", nil, nil )
			return true
		else
			return false
		end
	end, false )
	f2_local1:AddButtonCallbackFunction( self, f2_arg0, Enum.LUIButton[0x820DDD869ABBFAA], "ui_contextual_2", function ( element, menu, controller, model )
		...
		if not CoD.ModelUtility.IsModelValueEqualTo( controller, "PositionDraft.stage", 6 ) and IsCustomLobby() and IsMouseOrKeyboard( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum.LUIButton[0x820DDD869ABBFAA], "mpui/change_team", nil, "ui_contextual_2" )
			return true
		else
			return false
		end
	end, false )
	f2_local1:AddButtonCallbackFunction( self, f2_arg0, Enum.LUIButton[0x49A252B20B48936], "MOUSE2", function ( element, menu, controller, model )
		...
		if IsCodCaster( controller ) and not IsRepeatButtonPress( nil ) then
			CoD.Menu.SetButtonLabel( menu, Enum.LUIButton[0x49A252B20B48936], "menu/next", nil, "MOUSE2" )
			return true
		else
			return false
		end
	end, false )
	f2_local1:AddButtonCallbackFunction( self, f2_arg0, Enum.LUIButton[0x493152B20AE4F58], "MOUSE1", function ( element, menu, controller, model )
		if IsCodCaster( controller ) and not IsRepeatButtonPress( model ) then
			AdjustShoutcasterTeam( self, element, controller, -1 )
			return true
		else
		...
		if IsCodCaster( controller ) and not IsRepeatButtonPress( nil ) then
			CoD.Menu.SetButtonLabel( menu, Enum.LUIButton[0x493152B20AE4F58], "mpui/prev_caps", nil, "MOUSE1" )
			return true
		else
			return false
		end
	end, false )
	f2_local1:AddButtonCallbackFunction( self, f2_arg0, Enum.LUIButton[0xD2F467A6C6DA1AC], "F1", function ( element, menu, controller, model )
	...
	f2_local1:AddButtonCallbackFunction( self, f2_arg0, Enum.LUIButton[0x93AB4C84F113EE1], "TAB", function ( element, menu, controller, model )
		...
		if CoD.ModelUtility.IsModelValueEqualTo( controller, "isInPrematchPeriod", 1 ) and CoD.ModelUtility.IsModelValueLessThanOrEqualTo( controller, "PositionDraft.stage", 3 ) and IsGametypeTeambased() then
			CoD.Menu.SetButtonLabel( menu, Enum.LUIButton[0x93AB4C84F113EE1], "menu/view_teams", nil, "TAB" )
			return true
		else
			return false
		end
...
CoD.PositionDraft.__clipsPerState = {
	...
	MatchStartingCodCaster = {
		DefaultClip = function ( f72_arg0, f72_arg1 )
			...
			f72_arg0.StatusText:setText( LocalizeToUpperString( "mp/match_starting_in" ) )
		...
		OneSecondRemaining = function ( f84_arg0, f84_arg1 )
			...
			f84_arg0.StatusText:setText( LocalizeToUpperString( "mp/match_starting_in" ) )
	...
	MatchStartingPC = {
		DefaultClip = function ( f100_arg0, f100_arg1 )
			...
			f100_arg0.StatusText:setText( LocalizeToUpperString( "mp/match_starting_in" ) )
		...
		OneSecondRemaining = function ( f111_arg0, f111_arg1 )
			...
			f111_arg0.StatusText:setText( LocalizeToUpperString( "mp/match_starting_in" ) )
	...
	WaitingForPlayers = {
		DefaultClip = function ( f114_arg0, f114_arg1 )
			...
			f114_arg0.StatusText:setText( LocalizeToUpperString( "menu/waiting_for_players_caps" ) )
	...
	MatchStarting = {
		DefaultClip = function ( f142_arg0, f142_arg1 )
			...
			f142_arg0.StatusText:setText( LocalizeToUpperString( "mp/match_starting_in" ) )
		...
		OneSecondRemaining = function ( f153_arg0, f153_arg1 )
			...
			f153_arg0.StatusText:setText( LocalizeToUpperString( "mp/match_starting_in" ) )
