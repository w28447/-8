...
CoD.TabbedMultiItemPickupItem.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	Glow:setImage( RegisterImage( "uie_hud_core_loadout_abilityreadyglow" ) )
	...
	Brackets2:setImage( RegisterImage( "uie_ui_hud_wz_hud_core_brackets" ) )
	...
	Brackets3:setImage( RegisterImage( "uie_ui_hud_wz_hud_core_brackets" ) )
	...
	pip1.image:setImage( RegisterImage( "uie_hud_common_core_score_control_diamond" ) )
	...
	pip2.image:setImage( RegisterImage( "uie_hud_common_core_score_control_diamond" ) )
	...
	pip3.image:setImage( RegisterImage( "uie_hud_common_core_score_control_diamond" ) )
	...
	pip4.image:setImage( RegisterImage( "uie_hud_common_core_score_control_diamond" ) )
	...
	plusPip.image:setImage( RegisterImage( "uie_ui_hud_wz_hud_core_thin_plus" ) )
	...
	BlackjackLogo:setImage( RegisterImage( "uie_ui_hud_wz_hud_core_blackjack_cache_logo" ) )
	...
	BlackjackFrameCorner:setImage( RegisterImage( "uie_ui_hud_wz_hud_core_blackjack_cache_frame_corner" ) )
	...
	BlackjackFrame:setImage( RegisterImage( "uie_ui_hud_wz_hud_core_blackjack_cache_frame" ) )
	...
	BlackjackGlow:setImage( RegisterImage( "uie_ui_hud_wz_hud_core_blackjack_cache_glow" ) )
