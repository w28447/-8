...
CoD.Barracks_StatsOverview.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	Wins.StatHeaderText:setText( Engine[0xF9F1239CFD921FE]( "menu/wins_caps" ) )
	...
	DirectActionKills.StatHeaderText:setText( LocalizeToUpperString( "menu/direct_action_kills" ) )
	...
	HighestKillStreak.StatHeaderText:setText( LocalizeToUpperString( "menu/highest_kill_streak" ) )
	...
	ScorePerMinute.StatHeaderText:setText( LocalizeToUpperString( "menu/score_per_minute" ) )
	...
	DamagePerGame.StatHeaderText:setText( LocalizeToUpperString( "menu/damage_per_game" ) )
