...
CoD.PositionDraft_StatusBannerFrame.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	TextBackingLeftBlur:setImage( RegisterImage( "uie_ui_menu_draft_frame_backing" ) )
	...
	TextBackingRightBlur:setImage( RegisterImage( "uie_ui_menu_draft_frame_backing" ) )
	...
	FrameOuterBR:setImage( RegisterImage( "uie_ui_menu_draft_frame_outer_bot" ) )
	...
	FrameOuterTR:setImage( RegisterImage( "uie_ui_menu_draft_frame_outer_top" ) )
