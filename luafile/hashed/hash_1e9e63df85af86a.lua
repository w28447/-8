...
CoD.CustomGames_LobbySettings = InheritFrom( CoD.Menu )
LUI.createMenu.CustomGames_LobbySettings = function ( f1_arg0, f1_arg1 )
	local self = CoD.Menu.NewForUIEditor( "CustomGames_LobbySettings", f1_arg0 )
	local f1_local1 = self
	self:setClass( CoD.CustomGames_LobbySettings )
	...
	CommomCenteredPopup.TitleText:setText( LocalizeToUpperString( "director/lobby_settings" ) )
	...
	local LobbySettingsList = LUI.UIList.new( f1_local1, f1_arg0, 8, 0, nil, false, false, false, false )
	LobbySettingsList:setLeftRight( 0.5, 0.5, -250, 250 )
	LobbySettingsList:setTopBottom( 0.5, 0.5, -380, 224 )
	LobbySettingsList:setAutoScaleContent( true )
	...
	LobbySettingsList:setAlignment( Enum.LUIAlignment[0x58C8A85F2048829] )
	...
	self.LobbySettingsList = LobbySettingsList
	...
	PCSmallCloseButton = CoD.PC_SmallCloseButton.new( f1_local1, f1_arg0, 0.5, 0.5, 308, 342, 0.5, 0.5, -439.5, -405.5 )
	...
	LobbySettingsList.id = "LobbySettingsList"
	if CoD.isPC then
	...
	self.__defaultFocus = LobbySettingsList
...
CoD.CustomGames_LobbySettings.__resetProperties = function ( f13_arg0 )
	f13_arg0.LobbySettingsList:completeAnimation()
	f13_arg0.SettingDescription:completeAnimation()
	f13_arg0.LobbySettingsList:setLeftRight( 0.5, 0.5, -250, 250 )
...
CoD.CustomGames_LobbySettings.__clipsPerState = {
	...
	KBM = {
		DefaultClip = function ( f15_arg0, f15_arg1 )
			...
			f15_arg0.LobbySettingsList:completeAnimation()
			f15_arg0.LobbySettingsList:setLeftRight( 0.5, 0.5, -290, 290 )
			f15_arg0.clipFinished( f15_arg0.LobbySettingsList )
...
CoD.CustomGames_LobbySettings.__onClose = function ( f16_arg0 )
	...
	f16_arg0.LobbySettingsList:close()
