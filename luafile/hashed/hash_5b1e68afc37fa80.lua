...
CoD.MultiItemPickupWaypoint.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	ItemPickupGrid:subscribeToGlobalModel( f1_arg1, "PerController", "scriptNotify", function ( model )
		...
		if CoD.ModelUtility.IsParamModelEqualToHashString( model, "multi_item_select" ) and IsGamepad( f1_arg1 ) and not IsIntDvarNonZero( "tabbedMultiItemPickup" ) then
	...
	OpenPromptText:setText( Engine[0xF9F1239CFD921FE]( "wz/open_stash" ) )
...
CoD.MultiItemPickupWaypoint.__resetProperties = function ( f50_arg0 )
	...
	f50_arg0.OpenPromptText:setText( Engine[0xF9F1239CFD921FE]( "wz/open_stash" ) )
...
CoD.MultiItemPickupWaypoint.__clipsPerState = {
	...
	LockedPromptSnap = {
		DefaultClip = function ( f55_arg0, f55_arg1 )
			...
			f55_arg0.OpenPromptText:setText( Engine[0xF9F1239CFD921FE]( "wz/locked_stash" ) )
	...
	LockedPrompt = {
		DefaultClip = function ( f56_arg0, f56_arg1 )
			...
			f56_arg0.OpenPromptText:setText( Engine[0xF9F1239CFD921FE]( "wz/locked_stash" ) )
	...
	UnlockPromptSnap = {
		DefaultClip = function ( f59_arg0, f59_arg1 )
			...
			f59_arg0.OpenPromptText:setText( Engine[0xF9F1239CFD921FE]( "wz/unlock_stash" ) )
	...
	UnlockPrompt = {
		DefaultClip = function ( f60_arg0, f60_arg1 )
			...
			f60_arg0.OpenPromptText:setText( Engine[0xF9F1239CFD921FE]( "wz/unlock_stash" ) )
