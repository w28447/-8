...
f0_local0.GetCurrentLobbySizes = function ( f10_arg0 )
	...
	if f10_arg0 == true then
		Engine.PrintInfo( Enum[0x7A63DCD561B0FA8][0xC1DE3DC19B3B20D], "Current Lobby Sizes (" .. f10_local1.name .. ", ID " .. tostring( f10_local0 ) .. "):" .. " maxClients(" .. tostring( f10_local1.maxclients ) .. "), maxLaunchClients(" .. tostring( f10_local1.maxlaunchclients ) .. "), maxCoDcasterClients(" .. tostring( f10_local1.maxcodcasterclients ) .. "), maxLocalClients(" .. tostring( f10_local1[0x6D8502BDC7A4868] ) .. "), maxLocalClientsNetwork(" .. tostring( f10_local1.maxlocalclientsnetwork ) .. "), maxClientsSession(" .. tostring( f10_local2 ) .. ").\n" )
	end
	return {
		maxClients = f10_local1.maxclients,
		maxLaunchClients = f10_local1.maxlaunchclients,
		maxCoDcasterClients = f10_local1.maxcodcasterclients,
