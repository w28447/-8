...
Lobby.ProcessPlatform.PS4AcceptInvite = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5 )
	...
	local f1_local48 = Lobby.Actions.ErrorPopupMsg( "menu/update_needed" )
	...
	local f1_local71 = Lobby.Actions.LobbyJoinXUIDExt( f1_arg0, Enum.jointype.join_type_party, f1_local64, Enum.LobbyType[0xA1647599284110] )
	local f1_local72 = Lobby.Actions.ErrorPopup( f1_local71 )
	local f1_local73 = Lobby.Actions.LobbyJoinXUIDExt( f1_arg0, Enum.jointype.join_type_party, f1_local64, Enum.LobbyType[0xA1647599284110] )
...
Lobby.ProcessPlatform.XboxJoin = function ( f10_arg0, f10_arg1, f10_arg2, f10_arg3 )
	...
	local f10_local13 = Lobby.Process.ReloadPrivateLobby( f10_arg0, f10_local11.networkmode, f10_local11 )
	...
	local f10_local54 = Lobby.Actions.LobbyJoinXUIDExt( f10_arg0, Enum.jointype.join_type_party, f10_local49, Enum.LobbyType[0xA1647599284110] )
