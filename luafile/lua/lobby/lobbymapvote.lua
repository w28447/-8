...
Lobby.MapVote.Clear = function ()
	...
	f18_local0.mapVoteMapNext:set( "" )
	f18_local0.mapVoteMapPrevious:set( "" )
	f18_local0.mapVoteGameModeNext:set( "" )
	f18_local0.mapVoteGameModePrevious:set( "" )
	...
	f18_local0.mapVoteMapPreviousGametype:set( "" )
	f18_local0.mapVoteCustomGameName:set( "" )
