...
Lobby.Join.OnJoinableCheck = function ( f6_arg0 )
	...
	if f6_local1.response == Enum.JoinResult[0x26E669B1C0B3657] then
		...
		if f6_arg0.joinRequest.joinType ~= Enum.jointype.join_type_party and f6_local3 == false and Engine[0xA63E42B2FB6EC02]() == Enum.LobbyNetworkMode[0xE99F41098B71960] and (f6_local2.LobbyType == Enum.LobbyType[0x92676CF5B6FCD43] or Engine[0xE39F1F30B306065]() == true) and Lobby.MatchmakingAsync.UpdateReservation( f6_local0.members ) == false then
...
Lobby.Join.JoinResultToString = function ( f8_arg0, f8_arg1 )
	...
	elseif f8_arg0 == Enum.JoinResult[0x9E083F2EA9B6844] then
		...
		f8_local0.errorMsg = "menu/join_result_not_joinable_already_in_progress"
	...
	elseif f8_arg0 == Enum.JoinResult[0x11A1F5E2557ADEE] then
		...
		f8_local0.errorMsg = "menu/join_result_mismatch_playlistid"
	...
	elseif f8_arg0 == Enum.JoinResult[0xD587302520D8B45] then
		...
		f8_local0.errorMsg = "menu/join_result_not_joinable_paused"
	...
	elseif Engine[0x9E5BE3B4BBA4E0E]( "probation_public_enabled" ) and f8_arg0 == Enum.JoinResult[0xFB9C91F64F55BFE] then
		...
		f8_local0.errorMsg = "menu/join_denied_public_probation"
	...
	elseif f8_arg0 == Enum.JoinResult[0xB1C0D3E06FFEFB4] then
		...
		f8_local0.errorMsg = "exe/hostunreach_too_many_joins"
