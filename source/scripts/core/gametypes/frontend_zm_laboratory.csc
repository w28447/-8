...
// Size: 0xa8
function function_f47528e7( localclientnum, bottlesmodel, index )
{
...
// Size: 0x24c
function lab_set_rewards( localclientnum )
{
    if ( !isdefined( level.var_49f26c00.controller_model ) )
    {
        return;
...
// Size: 0x6f4
function skip_to_reveal( localclientnum )
{
    level endon( #"laboratory_closed" );
    s_cam = struct::get( #"tag_align_zm_lab" );
...
function setup_bottles( localclientnum, e_bottle_1, e_bottle_2, e_bottle_3 )
{
    ...
    e_bottle_1.mdl_lid = util::spawn_model( localclientnum, #"p8_zm_elixir_lid_ui_lab", e_bottle_1 gettagorigin( "bottlecap_01_link_jnt" ), e_bottle_1 gettagangles( "bottlecap_01_link_jnt" ) );
    ...
    e_bottle_2.mdl_lid = util::spawn_model( localclientnum, #"p8_zm_elixir_lid_ui_lab", e_bottle_2 gettagorigin( "bottlecap_02_link_jnt" ), e_bottle_2 gettagangles( "bottlecap_02_link_jnt" ) );
    ...
    e_bottle_3.mdl_lid = util::spawn_model( localclientnum, #"p8_zm_elixir_lid_ui_lab", e_bottle_3 gettagorigin( "bottlecap_03_link_jnt" ), e_bottle_3 gettagangles( "bottlecap_03_link_jnt" ) );
...
// Size: 0x1cc
function function_9b8f7969( var_803342ff, str_rob = #"hash_39fc63d10a03dd55" )
{
    if ( !isdefined( self ) )
    {
        return;
...
// Size: 0x398
function function_7492cbc7( var_a82b834c = 0.5, str_rob = #"hash_6f36cd3b18334e2e", var_d2e7cd73 = 0 )
{
    self notify( #"hash_333aed9939c9fe17" );
