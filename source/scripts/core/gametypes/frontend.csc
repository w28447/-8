...
/#
    ...
    function function_23bc6f08( localclientnum, var_d0b01271, itemtype, item_data, mode, character_index, var_b34f01f0 )
    {
        ...
        [[ var_d0b01271 ]]->update( { #var_c76f3e47:1, #var_5bd51249:8, #var_13fb1841:4, #scene:scene_name, #scene_shot:shot_name } );
    ...
    // Size: 0x664, Type: dev
    function t10_lasers_mixlaser2_sn_droger( localclientnum, menu_name, state )
    {
...
// Size: 0x544
function function_f00765ad( localclientnum, xuid, ccobject, index, var_3f0e790b )
{
    ...
    if ( !isdefined( var_23904c1d ) && current_index != var_4865db3b )
    {
        ...
        {
            var_cb498604 = { #scene:var_7f40501d, #scene_target:self, #var_a34c858c:1, #var_c76f3e47:1, #var_401d9a1:1 };
        }
        else
        {
            var_cb498604 = { #anim_name:[[ ccobject ]]->function_8144231c() };
        }
...
function lobby_main( localclientnum, menu_name, state )
{
    ...
    if ( isdefined( level.lastlobbystate ) && state !== level.lastlobbystate )
    {
        ...
        {
            level notify( "menu_change" + localclientnum, { #menu:"directorTraining", #status:"closed", #state:undefined, #mode:1 } );
        }
...
// Size: 0x534
function function_a71254a9( localclientnum, play, player_data, var_1c5551d6 = 0, scene_shot = undefined, var_ddc01a5 = 0, override_scene = undefined )
{
...
function function_d8402f0c( localclientnum, menu_name, state )
{
    ...
    {
        [[ var_d0b01271 ]]->set_character_index( state );
        level notify( "updateSpecialistCustomization" + localclientnum, { #event_name:"changeHero", #character_index:state, #mode:0 } );
    }
