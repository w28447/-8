...
function on_player_killed( params )
{
    ...
    if ( isdefined( victim.usingvehicle ) && victim.usingvehicle )
    {
        ...
        if ( isdefined( vehicle ) && isdefined( vehicle.session ) )
        {
            vehicle.session.passenger_deaths++;
        }
    }
...
// Size: 0x56
function disable_trophy_system()
{
