...
function function_78083139()
{
    ...
    foreach ( var_38280f2f, var_5ceb23d0 in player.pers[ #"contracts" ] )
    {
        ...
        /#
            ...
            {
                completed_text = var_9224acc ? "<dev string:x262>" : "<dev string:x1d2>";
                iprintln( "<dev string:x272>" + hashtostring( var_38280f2f ) + "<dev string:x280>" + delta + "<dev string:x28e>" + var_4b67585c + "<dev string:x2ae>" + var_2de8a050 + completed_text );
            }
        #/
