...
class czm_towers_challenges_hud : cluielem
{
    ...
    // Size: 0xdc
    function setup_clientfields( uid, progresscallback, challenge_textcallback, required_goalcallback )
    {
        ...
        cluielem::add_clientfield( "required_goal", 1, 7, "int", required_goalcallback );
    }
...
// Size: 0x64
function register( uid, progresscallback, challenge_textcallback, required_goalcallback )
{
    elem = new czm_towers_challenges_hud();
    [[ elem ]]->setup_clientfields( uid, progresscallback, challenge_textcallback, required_goalcallback );
    return elem;
}
