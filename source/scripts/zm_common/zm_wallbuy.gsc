...
// Params 0, eflags: 0x2
// Checksum 0xd6629811, Offset: 0x348
// Size: 0x94
...
// Namespace zm_wallbuy/zm_wallbuy
// Params 2
// Checksum 0x8986e69f, Offset: 0x1548
// Size: 0x24c
...
// Namespace zm_wallbuy/zm_wallbuy
// Params 3
// Checksum 0x5d064c69, Offset: 0x1820
// Size: 0x694
...
// Namespace zm_wallbuy/zm_wallbuy
// Params 0
// Checksum 0xd75f18dd, Offset: 0x2970
// Size: 0x390
    ...
    for ( ;; )
    {
        ...
        if ( !player_has_weapon )
        {
            if ( zm_utility::function_e05ac4ad( player, cost ) )
            {
                ...
                player zm_stats::increment_challenge_stat( #"zm_daily_purchase_wall_buy", undefined, 1 );
