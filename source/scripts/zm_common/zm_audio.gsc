...
function function_198818fe()
{
    ...
    if ( does_category_exist( self.subarchetype ) )
    {
        function_ef9ba49c( self.subarchetype, n_delay );
    }
    
    if ( does_category_exist( self.archetype ) )
    {
...
{
    str_subcat = death + "_" + self zm_vo::function_82f9bc9f();
    
    if ( !does_category_exist( #"kill", str_subcat ) )
    {
        return;
    }
    ...
    {
        e_speaker create_and_play_dialog( #"kill", str_subcat, undefined, 1 );
    }
}
...
{
    if ( isdefined( ai.subarchetype ) && does_category_exist( "kill", ai.subarchetype ) )
    {
        return ai.subarchetype;
    }
    
    if ( isdefined( ai.archetype ) && does_category_exist( "kill", ai.archetype ) )
    {
        return ai.archetype;
    }
}
...
function timer_actual( kills, time )
{
    ...
    while ( gettime() < timer )
    {
        ...
        {
            if ( math::cointoss() && level.players.size > 1 && isdefined( self.streakvox ) )
            {
                players = getplayers();
                ...
                foreach ( e_player in players )
                {
                    ...
                    if ( self != e_player && sighttracepassed( self.origin + ( 0, 0, 30 ), e_player.origin + ( 0, 0, 30 ), 0, undefined ) )
                    {
                        e_player create_and_play_dialog( #"kill", self.streakvox );
                    }
                }
            }
            else
...
function create_and_play_dialog( category, subcategory, force_variant, b_wait_if_busy = 0, var_d0acc84f )
{
    ...
    {
        if ( s_overrides.str_category == "" && s_overrides.str_subcategory == "" )
        {
            return false;
        }
        
        if ( !does_category_exist( s_overrides.str_category, s_overrides.str_subcategory ) )
        {
            /#
        ...
        else if ( s_overrides.chance == 0 || s_overrides.chance > randomint( 100 ) )
        {
            ...
            subcategory = s_overrides.str_subcategory;
        }
    }
    ...
    if ( !does_category_exist( category, subcategory ) )
    {
        /#
            if ( getdvarint( #"debug_audio", 0 ) )
            {
...
function function_43f17c2( category, subcategory )
{
    ...
    if ( does_category_exist( category, subcategory ) && level.sndplayervox[ category ][ subcategory ].var_7aadcbd7 )
    {
...
function function_9c83876e( category, subcategory )
{
    ...
    if ( level.var_79bbe09a[ category ][ subcategory ] == 1 )
    {
        ...
        if ( does_category_exist( category, var_9c4a66e5 ) )
        {
...
function function_6191af93( str_category, str_subcategory, str_override_category, str_override_subcategory, var_2bff7297 = 0 )
{
    ...
    s_override = { #str_category:str_override_category, #str_subcategory:str_override_subcategory, #chance:var_2bff7297 };
    self.var_c13233ee[ str_category ][ str_subcategory ] = s_override;
}
...
// Size: 0x9a
function function_e1666976( str_category, str_subcategory )
{
    if ( isdefined( self.var_c13233ee ) )
    {
        if ( isdefined( self.var_c13233ee[ str_category ] ) )
        {
            if ( isdefined( self.var_c13233ee[ str_category ][ str_subcategory ] ) )
            {
                self.var_c13233ee[ str_category ][ str_subcategory ] = undefined;
...
// Size: 0xbe
function private function_a3932430( str_category, str_subcategory )
{
    if ( isdefined( self.var_c13233ee ) )
    {
        if ( isdefined( self.var_c13233ee[ str_category ] ) )
        {
            if ( isdefined( self.var_c13233ee[ str_category ][ str_subcategory ] ) )
            {
                return self.var_c13233ee[ str_category ][ str_subcategory ];
            }
        }
    }
    else if ( isdefined( level.var_c13233ee ) )
    {
        ...
        {
            if ( isdefined( level.var_c13233ee[ str_category ][ str_subcategory ] ) )
            {
                return level.var_c13233ee[ str_category ][ str_subcategory ];
            }
        }
    }
...
// Size: 0x5e
function function_631a26f0( str_category, str_subcategory )
{
    if ( function_31230d39( str_category, str_subcategory ) )
    {
        self.var_5b6ebfd0 = 0;
        return [[ self.var_631a26f0[ str_category ][ str_subcategory ] ]]( str_category, str_subcategory );
    }
...
// Size: 0x80, Type: bool
function function_31230d39( str_category, str_subcategory )
{
    if ( !isdefined( str_category ) || !isdefined( str_subcategory ) )
    {
        return false;
    }
    
    if ( isdefined( self.var_631a26f0 ) && isdefined( self.var_631a26f0[ str_category ] ) && isfunctionptr( self.var_631a26f0[ str_category ][ str_subcategory ] ) )
    {
        return true;
    }
...
// Size: 0x4c
function function_87714659( func, str_category, str_subcategory )
{
    ...
    self.var_631a26f0[ str_category ][ str_subcategory ] = func;
}
...
// Size: 0x76, Type: bool
function does_category_exist( category, subcategory )
{
    if ( isdefined( level.sndplayervox ) )
    {
...
function function_e2bd90b5( category, subcategory, variant )
{
    ...
    else if ( does_category_exist( category, subcategory ) )
    {
        vox = level.sndplayervox[ category ][ subcategory ];
...
function sndannouncer_init()
{
    ...
    {
        sndannouncervoxadd( #"game_start", #"vox_rush_game_start" );
        ...
        sndannouncervoxadd( #"perk_generic", #"vox_rush_perk_generic" );
        sndannouncervoxadd( #"hero_weapon_ready", #"hash_279b4769ea79b472" );
        sndannouncervoxadd( #"extra_life", #"vox_rush_extra_life" );
        sndannouncervoxadd( #"incoming_blight_father", #"vox_rush_incoming_blight" );
        sndannouncervoxadd( #"incoming_stoker", #"vox_rush_incoming_stoker" );
        sndannouncervoxadd( #"incoming_boss", #"vox_rush_incoming_boss" );
        sndannouncervoxadd( #"incoming_mini_boss", #"vox_rush_incoming_mini_boss" );
        sndannouncervoxadd( #"incoming_heavy", #"vox_rush_incoming_heavy" );
        sndannouncervoxadd( #"power_activated", #"vox_rush_power_activated" );
        sndannouncervoxadd( #"rush_zone_nag", #"vox_rush_zone_nag" );
        sndannouncervoxadd( #"defend_start", #"vox_rush_defend_start" );
        sndannouncervoxadd( #"defend_complete", #"vox_rush_defend_complete" );
        sndannouncervoxadd( #"player_out", #"vox_rush_player_out" );
        sndannouncervoxadd( #"player_last_man_standing", #"hash_445a8d6ac36b6ce4" );
        sndannouncervoxadd( #"player_respawn", #"vox_rush_player_respawn" );
        sndannouncervoxadd( #"timer_10", #"vox_rush_timer_10" );
        sndannouncervoxadd( #"timer_9", #"vox_rush_timer_9" );
        sndannouncervoxadd( #"timer_8", #"vox_rush_timer_8" );
        sndannouncervoxadd( #"timer_7", #"vox_rush_timer_7" );
        sndannouncervoxadd( #"timer_6", #"vox_rush_timer_6" );
        sndannouncervoxadd( #"timer_5", #"vox_rush_timer_5" );
        sndannouncervoxadd( #"timer_4", #"vox_rush_timer_4" );
        sndannouncervoxadd( #"timer_3", #"vox_rush_timer_3" );
        sndannouncervoxadd( #"timer_2", #"vox_rush_timer_2" );
        sndannouncervoxadd( #"timer_1", #"vox_rush_timer_1" );
        sndannouncervoxadd( #"lead_gained", #"vox_rush_lead_gained" );
        sndannouncervoxadd( #"lead_lost", #"vox_rush_lead_lost" );
        ...
        sndannouncervoxadd( #"player_down", #"vox_rush_player_down" );
        sndannouncervoxadd( #"pap_avail", #"vox_rush_pap_avail" );
        sndannouncervoxadd( #"door_open_single", #"vox_rush_door_open_single" );
        sndannouncervoxadd( #"door_open_mult", #"vox_rush_door_open_mult" );
        sndannouncervoxadd( #"door_open_all", #"vox_rush_door_open_all" );
        sndannouncervoxadd( #"carpenter", #"vox_rush_carpenter" );
        sndannouncervoxadd( #"insta_kill", #"vox_rush_instakill" );
        sndannouncervoxadd( #"double_points", #"vox_rush_doublepoints" );
        sndannouncervoxadd( #"nuke", #"vox_rush_nuke" );
        sndannouncervoxadd( #"full_ammo", #"vox_rush_max_ammo" );
        sndannouncervoxadd( #"fire_sale", #"vox_rush_firesale" );
        sndannouncervoxadd( #"bonus_points_team", #"vox_rush_bonus_points_team" );
        sndannouncervoxadd( #"bonus_points_player_shared", #"vox_rush_bonus_points_team" );
        sndannouncervoxadd( #"hero_weapon_power", #"hash_93327b9599b606d" );
        sndannouncervoxadd( #"hellhound", #"vox_rush_hellhound" );
        sndannouncervoxadd( #"nova_6", #"vox_rush_nova_6" );
        sndannouncervoxadd( #"zmb_tigers", #"vox_rush_zmb_tigers" );
        sndannouncervoxadd( #"tigers", #"vox_rush_tigers" );
        sndannouncervoxadd( #"catalyst", #"vox_rush_catalyst" );
        sndannouncervoxadd( #"catalysts", #"vox_rush_catalysts" );
        sndannouncervoxadd( #"stoker", #"vox_rush_stoker" );
        sndannouncervoxadd( #"stokers", #"vox_rush_stokers" );
        sndannouncervoxadd( #"blightfather", #"vox_rush_blightfather" );
        sndannouncervoxadd( #"blightfathers", #"vox_rush_blightfathers" );
        sndannouncervoxadd( #"marauder", #"vox_rush_marauder" );
        sndannouncervoxadd( #"marauders", #"vox_rush_marauders" );
        sndannouncervoxadd( #"destroyer", #"vox_rush_destroyer" );
        sndannouncervoxadd( #"destroyers", #"vox_rush_destroyers" );
        sndannouncervoxadd( #"warden", #"vox_rush_warden" );
        ...
        sndannouncervoxadd( #"electric_zombie", #"vox_rush_electric" );
    }
}
...
// Size: 0xa2
function function_713192b1( str_location, str_subcategory )
{
    ...
    if ( !isdefined( level.var_cbcee8da[ str_subcategory ] ) )
    {
        level.var_cbcee8da[ str_subcategory ] = 0;
    }
    
    if ( !isdefined( level.var_b2a9a8d7[ str_location ] ) )
    {
        level.var_b2a9a8d7[ str_location ] = str_subcategory;
    }
}
...
function location_vox( str_location )
{
    ...
    str_subcategory = level.var_b2a9a8d7[ str_location ];
    ...
    if ( !isdefined( self.var_cbcee8da[ str_subcategory ] ) )
    {
        self.var_cbcee8da[ str_subcategory ] = 0;
    }
    
    if ( !level.var_cbcee8da[ str_subcategory ] && !self.var_cbcee8da[ str_subcategory ] )
    {
        self.var_cbcee8da[ str_subcategory ] = 1;
        b_played = create_and_play_dialog( #"location_enter", str_subcategory );
        
        if ( isdefined( b_played ) && b_played )
        {
            level.var_cbcee8da[ str_subcategory ] = 1;
        }
    }
}
