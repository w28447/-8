...
function init_levelvars()
{
    ...
    zombie_utility::set_zombie_var( #"zombie_score_bonus_transform", 50 );
...
function function_1442d44f()
{
    ...
    zombie_utility::set_zombie_var( #"penalty_downed_point_step", var_c6ceb446[ #"plypenaltydownedpointstep" ], 1 );
...
function actor_damage_override( inflictor, attacker, damage, flags, meansofdeath, weapon, vpoint, vdir, shitloc, psoffsettime, boneindex, surfacetype )
{
    ...
    damage = zm_faction_buffs::actor_damage_override( inflictor, attacker, damage, flags, meansofdeath, weapon, vpoint, vdir, shitloc, psoffsettime, boneindex, surfacetype );
...
function actor_damage_override_wrapper( inflictor, attacker, damage, flags, meansofdeath, weapon, vpoint, vdir, shitloc, vdamageorigin, psoffsettime, boneindex, modelindex, surfacetype, vsurfacenormal )
{
    ...
    if ( !willbekilled || !( isdefined( self.dont_die_on_me ) && self.dont_die_on_me ) )
    {
        ...
        if ( params.idamage > 0 || zm_trial_no_missed_shots::is_active() )
        {
