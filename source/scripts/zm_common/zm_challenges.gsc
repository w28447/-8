...
function round_tracking()
{
    ...
    while ( true )
    {
        ...
        {
            /#
                self debug_print( "<dev string:x61>" );
            #/
        ...
        {
            /#
                self debug_print( "<dev string:x9c>" );
            #/
        ...
        {
            /#
                self debug_print( "<dev string:xd4>" );
            #/
...
function death_check_for_challenge_updates( e_attacker )
{
    ...
    /#
        e_attacker debug_print( "<dev string:x10f>" );
    #/
    ...
    switch ( w_damage.inventorytype )
    {
        ...
        case #"primary":
            ...
            {
                e_attacker contracts::increment_zm_contract( #"contract_zm_hip_fire_kills" );
            }
    ...
    switch ( self.archetype )
    {
        case #"catalyst":
            ...
            {
                /#
                    e_attacker debug_print( "<dev string:x1cb>" );
                #/
    ...
    {
        /#
            e_attacker debug_print( "<dev string:x1fd>" );
        #/
        ...
        {
            /#
                e_attacker debug_print( "<dev string:x224>" );
            #/
        ...
        {
            /#
                e_attacker debug_print( "<dev string:x261>" );
            #/
    ...
    {
        /#
            e_attacker debug_print( "<dev string:x293>" );
        #/
    ...
    {
        /#
            e_attacker debug_print( "<dev string:x2b7>" );
        #/
    ...
    {
        /#
            e_attacker debug_print( "<dev string:x305>" );
        #/
    ...
    {
        e_attacker contracts::increment_zm_contract( #"contract_zm_wonder_weapon_kills" );
    }
    ...
    if ( w_damage.rootweapon.name == #"smg_handling_t8_dw" || w_damage.rootweapon.name == #"smg_handling_t8_lh" || w_damage.rootweapon.name == #"smg_handling_t8_upgraded_dw" || w_damage.rootweapon.name == #"smg_handling_t8_upgraded_lh" )
    {
        /#
    ...
    {
        /#
            e_attacker debug_print( "<dev string:x618>" );
        #/
    ...
    {
        /#
            e_attacker debug_print( "<dev string:x640>" );
        #/
    ...
    {
        /#
            e_attacker debug_print( "<dev string:x663>" );
        #/
    ...
    {
        /#
            e_attacker debug_print( "<dev string:x68a>" );
        #/
    ...
    {
        /#
            e_attacker debug_print( "<dev string:x6b4>" );
        #/
    ...
    {
        /#
            e_attacker debug_print( "<dev string:x6dc>" );
        #/
    ...
    {
        /#
            e_attacker debug_print( "<dev string:x706>" );
        #/
    ...
    if ( zm_loadout::is_hero_weapon( w_damage ) || zm_hero_weapon::function_6a32b8f( w_damage ) )
    {
        ...
        {
            /#
                e_attacker debug_print( "<dev string:x72b>" );
            #/
            ...
            {
                /#
                    e_attacker debug_print( "<dev string:x75e>" );
                #/
        ...
        if ( w_damage == getweapon( #"hero_hammer_lv1" ) || w_damage == getweapon( #"hero_hammer_lv2" ) || w_damage == getweapon( #"hero_hammer_lv3" ) || w_damage == getweapon( #"hero_minigun_t8_lv1" ) || w_damage == getweapon( #"hero_minigun_t8_lv2" ) || w_damage == getweapon( #"hero_minigun_t8_lv3" ) || w_damage == getweapon( #"hero_minigun_t8_lv2_Grenade" ) || w_damage == getweapon( #"hero_minigun_t8_lv3_Grenade" ) )
        {
            /#
                e_attacker debug_print( "<dev string:x799>" );
            #/
            
            e_attacker zm_stats::increment_challenge_stat( #"hash_3e5b9b81d573d194" );
            
            if ( w_damage == getweapon( #"hero_hammer_lv3" ) || w_damage == getweapon( #"hero_minigun_t8_lv3" ) || w_damage == getweapon( #"hero_minigun_t8_lv3_Grenade" ) || w_damage == getweapon( #"hero_minigun_t8_lv2_Grenade" ) && e_attacker hasweapon( getweapon( #"hero_minigun_t8_lv3" ) ) )
            {
                /#
                    e_attacker debug_print( "<dev string:x75e>" );
                #/
        ...
        {
            /#
                e_attacker debug_print( "<dev string:x7c6>" );
            #/
        ...
        {
            /#
                e_attacker debug_print( "<dev string:x7f1>" );
            #/
...
function spent_points_tracking()
{
    ...
    while ( true )
    {
        ...
        player.var_152810ff[ 0 ] += n_points;
        
        /#
            player debug_print( "<dev string:x826>" );
        #/
...
/#
    ...
    {
        self debug_print( "<dev string:x84b>" );
    }
...
function function_73696786()
{
    ...
    while ( true )
    {
        ...
        {
            /#
                self debug_print( "<dev string:x897>" );
            #/
...
function function_12a35616()
{
    ...
    while ( true )
    {
        ...
        {
            /#
                self debug_print( "<dev string:x8c5>" );
            #/
...
function function_a9f6b8ef()
{
    ...
    {
        /#
            player debug_print( "<dev string:x8ed>" );
        #/
...
/#
    ...
    function debug_print( str_line )
    {
        ...
        {
            println( "<dev string:x914>" + self.entity_num + "<dev string:x91e>" + str_line );
        }
    }
...
function function_9a9ab6f6( var_1c48b665 )
{
    ...
    foreach ( var_6c7a7f72 in array( #"darkops_zod_ee", #"darkops_towers_ee", #"darkops_escape_ee" ) )
    {
    ...
    /#
        self debug_print( "<dev string:x923>" );
    #/
...
function private function_b892d1da()
{
    ...
    /#
        self debug_print( "<dev string:x952>" );
    #/
...
function function_bf0be8f1()
{
    ...
    /#
        self debug_print( "<dev string:x987>" );
    #/
...
function function_e40c9d13()
{
    ...
    /#
        self debug_print( "<dev string:x9b9>" );
    #/
...
{
    /#
        self debug_print( "<dev string:x9fa>" );
    #/
