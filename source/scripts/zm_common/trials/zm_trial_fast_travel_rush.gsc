...
#namespace zm_trial_fast_travel_rush;

// Namespace zm_trial_fast_travel_rush/zm_trial_fast_travel_rush
// Params 0, eflags: 0x2
// Checksum 0x99dbd862, Offset: 0xb8
// Size: 0x3c
function autoexec __init__system__()
{
    system::register( #"zm_trial_fast_travel_rush", &__init__, undefined, undefined );
}
