    ...
    if ( isbot( self ) )
    {
        ...
        if ( isdefined( level.var_8ca3c62 ) )
        {
            ...
            else if ( level.var_8ca3c62 == 3 )
            {
                ...
                ct_utils::get_player() ct_utils::ingame_objective_set_points( var_dbb92bad );
            }
            else if ( level.var_8ca3c62 == 5 )
            {
...
function function_f5f15107()
{
    ...
    ct_utils::get_player() ct_utils::ingame_objective_set_points( 8 );
