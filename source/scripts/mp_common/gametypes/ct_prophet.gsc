...
#using scripts\mp_common\gametypes\ct_prophet_tutorial;
...
function function_7c4ef26b( predictedspawn )
{
    if ( level.ctdifficulty == 0 )
    {
        self ct_prophet_tutorial::player_spawned_callback();
        return;
    }
...
function function_671e5ede()
{
    ...
    if ( var_468ef41 )
    {
        level thread spawn_robots( 1, level.var_a62b1ae0.origin );
    }
...
// Size: 0xb6
function spawn_robots( var_468ef41, var_8b84b3ce )
{
    while ( var_468ef41 > 0 )
    {
