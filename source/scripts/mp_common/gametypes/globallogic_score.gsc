...
// Size: 0x394
function giveplayermomentumnotification( score, label, descvalue, countstowardrampage, weapon, combatefficiencybonus = 0, eventindex, event, playersaffected )
{
...
// Size: 0x314
function giveplayermomentum( event, player, victim, descvalue, weapon, playersaffected )
{
...
// Size: 0x346
function giveplayerscore( event, player, victim, descvalue, weapon = level.weaponnone, playersaffected )
{
    scorediff = 0;
