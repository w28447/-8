...
function function_c5958b54()
{
    ...
    switch ( level.var_12323003 )
    {
        ...
        case #"conf":
        case #"conf_hc":
            var_c421e6b = #"contract_mp_play_kill_confirmed";
            break;
        case #"control":
        case #"control_hc":
        ...
        case #"ctf":
        case #"ctf_hc":
            var_c421e6b = #"contract_mp_play_capture_the_flag";
            break;
        case #"dem_hc":
        case #"dem":
        ...
        case #"dm_hc":
        case #"dm":
            var_c421e6b = #"contract_mp_play_free_for_all";
            break;
        case #"dom":
        case #"dom_hc":
        ...
        case #"gun":
        case #"gun_hc":
            var_c421e6b = #"contract_mp_play_gun_game";
            break;
        case #"infect_hc":
        case #"infect":
    ...
    {
        self function_fd9fb79b( #"contract_mp_play_bare_bones" );
    }
}
...
/#
    ...
    function function_50a60581( var_1d89ece6 )
    {
        ...
        util::function_3f749abc( var_78a6fb52 + "<dev string:x937>", var_c8d599b5 + #"contract_mp_play_kill_confirmed" );
        util::function_3f749abc( var_78a6fb52 + "<dev string:x94b>", var_c8d599b5 + #"contract_mp_play_capture_the_flag" );
        util::function_3f749abc( var_78a6fb52 + "<dev string:x963>", var_c8d599b5 + #"contract_mp_play_demolition" );
        util::function_3f749abc( var_78a6fb52 + "<dev string:x975>", var_c8d599b5 + #"contract_mp_play_free_for_all" );
        ...
        util::function_3f749abc( var_78a6fb52 + "<dev string:x9ac>", var_c8d599b5 + #"contract_mp_play_gun_game" );
