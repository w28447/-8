...
function function_cdeb9089( attacker, victim, spawnbeaconweapon, var_fb972b2b )
{
    ...
    {
        scoreevents::processscoreevent( #"spawn_beacon_objective_defense", attacker.var_7c18e526, undefined, spawnbeaconweapon );
    }
}
...
// Size: 0x51c
function playerspawnedfromspawnbeacon( spawnbeacon, var_d8f817bc )
{
    if ( !isdefined( spawnbeacon ) )
    {
        return;
