...
function on_player_damage( params )
{
    if ( self is_reviving_any() )
    {
        if ( isdefined( self.reviving_player ) && isdefined( self.reviving_player.var_d75a6ff5 ) )
        {
            ...
            {
                self.reviving_player.var_d75a6ff5.reviver_killed = 1;
            }
        }
    }
}
