...
function __init__()
{
    ...
    level.var_8cb8d474[ #"free" ][ 0 ] = #"draft_player_struct_0";
    level.var_8cb8d474[ #"free" ][ 2 ] = #"draft_player_struct_1";
    level.var_8cb8d474[ #"free" ][ 1 ] = #"draft_player_struct_2";
    level.var_8cb8d474[ #"free" ][ 3 ] = #"draft_player_struct_3";
    level.var_8cb8d474[ #"free" ][ 4 ] = #"draft_player_struct_4";
...
function function_6b532f83( localclientnum, var_de58f286, sessionmode )
{
    ...
    if ( isdefined( var_de58f286.activecharacter ) && player_role::is_valid( var_de58f286.activecharacter.charactertype ) )
    {
        ...
        else if ( player_role::is_valid( var_de58f286.focusedcharacterindex ) )
        {
            ...
            {
                anim_intro_name = weapongroupanim[ #"preready_to_select" ][ gender ];
        ...
        else
        {
            if ( !var_de58f286.var_91065a59 )
            {
                ...
                {
                    anim_intro_name = weapongroupanim[ #"select_to_preready" ][ gender ];
                }
