...
#using scripts\zm\perk\zm_perk_mod_quick_revive;
...
function init()
{
    ...
    clientfield::register( "scriptmover", "" + #"charon_portal_fx", 16000, 1, "int" );
    clientfield::register( "toplayer", "" + #"hash_e2692f239454272", 16000, 1, "int" );
    clientfield::register( "allplayers", "" + #"charon_teleport_postfx", 16000, 1, "int" );
    clientfield::register( "allplayers", "" + #"ouranos_teleport_postfx", 16000, 1, "int" );
    clientfield::register( "allplayers", "" + #"gaia_teleport_postfx", 16000, 1, "int" );
    clientfield::register( "allplayers", "" + #"hemera_teleport_postfx", 16000, 1, "int" );
    clientfield::register( "scriptmover", "" + #"hash_23ba81a7c071845d", 16000, 1, "int" );
    clientfield::register( "scriptmover", "" + #"gaia_portal_fx", 16000, 1, "int" );
    clientfield::register( "scriptmover", "" + #"gaia_sprout_fx", 16000, getminbitcountfornum( 3 ), "int" );
    ...
    clientfield::register( "scriptmover", "" + #"gaia_chaos_glow", 16000, 1, "int" );
    clientfield::register( "scriptmover", "" + #"gaia_chaos_destroy", 16000, 1, "int" );
    ...
    callback::on_player_loadout_changed( &function_6ef2b98f );
...
function function_7e94450c()
{
    ...
    {
        e_brick thread scene::play( #"p8_fxanim_zm_red_ww_shell_rubble_bundle", "Shot 1", e_brick );
    }
    else
    {
        e_brick thread scene::play( #"p8_fxanim_zm_red_ww_shell_mound_bundle", "Shot 1", e_brick );
    }
...
function function_809767d( str_hand )
{
    ...
    switch ( str_hand )
    {
        case #"light":
            ...
            var_f172b16e = "" + #"hemera_teleport_postfx";
        ...
        case #"death":
            ...
            var_f172b16e = "" + #"charon_teleport_postfx";
        ...
        case #"air":
            ...
            var_f172b16e = "" + #"ouranos_teleport_postfx";
        ...
        case #"earth":
            ...
            var_f172b16e = "" + #"gaia_teleport_postfx";
    ...
    var_a1327d58 flag::init( #"flag_ww_quests_portal_active" );
...
function function_841236e4( w_weapon, var_b6bc44ed )
{
    ...
    {
        self notify( #"light_energy_dropped", { #b_success:0 } );
        var_caa76b60 = #"light";
    }
...
function function_9f665c5d( e_player )
{
    ...
    if ( zm_utility::can_use( e_player, 1 ) || e_player getcurrentweapon() === level.w_sprout )
    {
        ...
        if ( s_shrine.targetname === "s_ww_quests_death_box_interact" )
        {
            ...
            else if ( w_wonder_weapon === s_shrine.var_884c4b3a && s_shrine flag::get( #"flag_ww_quests_portal_active" ) )
            {
        ...
        {
            if ( w_wonder_weapon === s_shrine.var_884c4b3a && s_shrine flag::get( #"flag_ww_quests_portal_active" ) )
            {
        ...
        if ( w_current === s_shrine.var_884c4b3a && !s_shrine flag::get( #"flag_ww_quests_portal_active" ) && !e_player flag::get( #"hash_8cdde8e6a8607f1" ) && e_player getcurrentweapon() != level.w_sprout && !e_player flag::get( "carrying_light_energy" ) )
        {
...
function function_75fd2345()
{
    ...
    while ( true )
    {
        ...
        if ( zm_utility::can_use( e_player ) || e_player getcurrentweapon() === level.w_sprout )
        {
            ...
            {
                if ( self.stub.related_parent flag::get( #"flag_ww_quests_portal_active" ) )
                {
                    self.stub.related_parent notify( #"trigger_activated_portal", { #e_who:e_player } );
                    continue;
                }
...
{
    e_player endon( #"disconnect", #"light_energy_dropped" );
    ...
    while ( true )
    {
        ...
        {
            e_player notify( #"light_energy_dropped", { #b_success:1 } );
...
{
    e_player endon( #"disconnect" );
    s_result = e_player waittill( #"light_energy_dropped", #"fake_death" );
...
function function_9c79eeed( e_player )
{
    ...
    if ( self.var_20a6106d.size <= 0 )
    {
        ...
        self.var_a1327d58 flag::set( #"flag_ww_quests_portal_active" );
...
{
    self endon( #"light_energy_dropped" );
    n_duration = 1;
    ...
    if ( !isdefined( var_40bb500f.target ) )
    {
        ...
        switch ( s_original.targetname )
        {
            ...
            case #"s_ww_ouranos_arrow_serpent":
                ...
                var_e3ed6c41 = #"p8_fxanim_zm_red_ouranos_feather_03_bundle";
...
function function_68080923( var_52666e80, mdl_tree )
{
    level endon( #"end_game" );
    level flag::wait_till( "all_players_spawned" );
    self clientfield::set( "" + #"gaia_chaos_glow", 1 );
...
function function_ac211843( b_failed )
{
    ...
    {
        wait 45;
        var_cb2f80a0 scene::play( #"p8_fxanim_zm_red_gaia_sprout_bundle", "regrow", var_cb2f80a0 );
    }
    else
    {
        var_cb2f80a0 scene::play( #"p8_fxanim_zm_red_gaia_sprout_bundle", "grow", var_cb2f80a0 );
    }
...
function function_41cb93cc( e_player )
{
    ...
    callback::on_player_loadout_changed( &function_3b0917e6 );
...
function function_1c5aedd8( e_player )
{
    ...
    else if ( isdefined( s_result.str_result === "planted" ) && s_result.str_result === "planted" )
    {
        ...
        level.var_643e7b15 clientfield::set( "" + #"gaia_sprout_fx", s_quest.var_8baa00ae );
    ...
    {
        e_player zm_weapons::give_full_ammo( s_quest.w_uncharged_hand );
    }
    else
    {
...
function function_88edd220( e_player, w_charged )
{
    ...
    e_player disableweaponcycling();
    e_player waittill( #"weapon_change_complete" );
    n_max_ammo = e_player getclipsize( w_charged );
...
function function_530d7ea0( var_bcf66490, e_player )
{
    ...
    self.var_a1327d58 flag::clear( #"flag_ww_quests_portal_active" );
}
...
function function_2d281542( var_bcf66490 )
{
    ...
    {
        wait 1.5;
        level.var_643e7b15 clientfield::set( "" + #"gaia_sprout_fx", 0 );
        level thread scene::play( "p8_fxanim_zm_red_gaia_portal_bundle", "grow" );
        level waittill( #"rob_in_wreath" );
        self.mdl_portal clientfield::set( "" + #"gaia_portal_fx", var_bcf66490 );
        return;
    }
    
    if ( self.var_a1327d58 flag::get( #"flag_ww_quests_portal_active" ) )
    {
...
function is_soul_capture( var_88206a50, e_zombie )
{
    ...
    if ( isdefined( e_zombie.attacker ) && isplayer( e_zombie.attacker ) || isdefined( e_zombie.damageinflictor ) && isplayer( e_zombie.damageinflictor ) )
    {
        ...
        {
            if ( !isdefined( var_88206a50.var_96f1a1e1 ) && e_zombie.archetype == #"catalyst" && e_zombie.subarchetype == str_archetype )
            {
...
function pack_portal_fx( s_pap_interact )
{
    ...
    if ( isdefined( self.var_4d50be8e ) )
    {
        ...
        playsoundatposition( #"zmb_portal_close", s_pap_interact.origin );
        return;
    }
    
    if ( isdefined( self.var_285af63c ) )
    {
        self.var_285af63c clientfield::set( "" + #"gaia_portal_fx", 0 );
    }
}
...
function function_f2081007( e_player, s_pap_interact )
{
    ...
    {
        self.mdl_return_portal clientfield::set( "" + #"gaia_portal_fx", 0 );
        self.var_285af63c clientfield::set( "" + #"gaia_portal_fx", 0 );
    }
}
