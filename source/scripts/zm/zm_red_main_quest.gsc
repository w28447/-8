...
function init_clientfield()
{
    ...
    clientfield::register( "toplayer", "" + #"play_earth_selected", 16000, 1, "int" );
    clientfield::register( "toplayer", "" + #"play_air_selected", 16000, 1, "int" );
    clientfield::register( "toplayer", "" + #"play_light_selected", 16000, 1, "int" );
    ...
    clientfield::register( "actor", "" + #"play_earth_uncharged", 16000, 1, "int" );
    clientfield::register( "actor", "" + #"play_earth_charged", 16000, 1, "int" );
    clientfield::register( "actor", "" + #"play_air_uncharged", 16000, 1, "int" );
    clientfield::register( "actor", "" + #"play_air_charged", 16000, 1, "int" );
    clientfield::register( "actor", "" + #"play_light_uncharged", 16000, 1, "int" );
    clientfield::register( "actor", "" + #"play_light_charged", 16000, 1, "int" );
    var_ff76a259 = getminbitcountfornum( 5 );
    clientfield::register( "world", "" + #"play_death_spotlight", 16000, var_ff76a259, "int" );
    clientfield::register( "world", "" + #"play_earth_spotlight", 16000, var_ff76a259, "int" );
    clientfield::register( "world", "" + #"play_air_spotlight", 16000, var_ff76a259, "int" );
    clientfield::register( "world", "" + #"play_light_spotlight", 16000, var_ff76a259, "int" );
    ...
    while ( !var_8f1e485e )
    {
        ...
        if ( isdefined( s_result.weapon.isriotshield ) && s_result.weapon.isriotshield )
        {
            ...
            if ( distancesquared( self.origin, s_target.origin ) < var_7d07543f )
            {
                ...
                v_weapon_forward = self getweaponforwarddir();
                n_dot = vectordot( v_weapon_forward, v_normalize );
...
function function_8b20a029()
{
    ...
    var_99fea1a4 thread rotate_gear();
    ...
    var_cff0c83d thread rotate_gear();
    ...
    if ( level.a_mdl_statues.size >= 3 )
    {
        ...
        level.var_20622c6 thread rotate_gear();
...
function function_310741f7( str_difficulties, n_time_limit )
{
    level endon( #"end_game", #"shoot_roots" + "_ended_early" );
    s_prophecy = level.var_cc9c60d2;
...
function function_ca906c66( e_player )
{
    ...
    if ( e_player zm_characters::is_character( array( #"prt_zm_bruno", #"prt_zm_bruno_dlc0" ) ) )
    {
        if ( zm_utility::is_player_valid( e_player ) )
        {
...
function take_ankh_setup( b_skipped )
{
    ...
    e_player thread zm_vo::function_a2bd5a0c( #"vox_ra_altar_ankh_pickup" );
...
// Size: 0x21a
function function_c2d50fdc( t_beam )
{
    level endon( #"end_game", #"defend_ra" + "_ended_early", #"hash_4140f0472ba137c" );
    self endon( #"disconnect" );
    t_beam endon( #"death" );
...
function init_play()
{
    ...
    var_38e73d19[ #"earth" ] = "" + #"play_earth_selected";
    var_38e73d19[ #"air" ] = "" + #"play_air_selected";
    var_38e73d19[ #"light" ] = "" + #"play_light_selected";
    ...
    var_ed2fbe40[ #"earth" ] = "" + #"play_earth_spotlight";
    var_ed2fbe40[ #"air" ] = "" + #"play_air_spotlight";
    var_ed2fbe40[ #"light" ] = "" + #"play_light_spotlight";
...
function function_790e49a5( str_ww, b_uncharged )
{
    switch ( str_ww )
    {
        ...
        case #"earth":
            if ( b_uncharged )
            {
                var_84c10792 = "" + #"play_earth_uncharged";
            }
            else
            {
                var_84c10792 = "" + #"play_earth_charged";
            }
        ...
        case #"air":
            if ( b_uncharged )
            {
                var_84c10792 = "" + #"play_air_uncharged";
            }
            else
            {
                var_84c10792 = "" + #"play_air_charged";
            }
        ...
        case #"light":
            if ( b_uncharged )
            {
                var_84c10792 = "" + #"play_light_uncharged";
            }
            else
            {
                var_84c10792 = "" + #"play_light_charged";
            }
...
{
    a_e_players = [];
    e_stanton = function_153ee6c7( array( #"prt_zm_stanton", #"prt_zm_stanton_dlc0" ) );
    e_bruno = function_153ee6c7( array( #"prt_zm_bruno", #"prt_zm_bruno_dlc0" ) );
...
function mid_igc_setup( b_skipped )
{
    ...
    if ( !isdefined( e_stanton ) )
    {
        ...
        e_stanton zm_characters::set_character( array( #"prt_zm_stanton", #"prt_zm_stanton_dlc0" ) );
        e_stanton init_bot();
    }
    ...
    if ( !isdefined( e_bruno ) )
    {
        ...
        e_bruno zm_characters::set_character( array( #"prt_zm_bruno", #"prt_zm_bruno_dlc0" ) );
        e_bruno init_bot();
    }
...
function mid_igc_cleanup( b_skipped, var_19e802fa )
{
    ...
    zm_vo::function_769aa73b( "post_mid_banter", array( #"prt_zm_bruno", #"prt_zm_bruno_dlc0" ), array( #"prt_zm_stanton", #"prt_zm_stanton_dlc0" ) );
...
function function_dcc3c705()
{
    ...
    if ( !self zm_characters::is_character( array( #"prt_zm_stanton", #"prt_zm_stanton_dlc0" ) ) )
    {
        return;
    }
