...
function function_744712bc( s_params )
{
    if ( !isdefined( level.var_558993a0 ) && isplayer( s_params.eattacker ) && ( self zm_zonemgr::entity_in_zone( "zone_infirmary" ) || self zm_zonemgr::entity_in_zone( "zone_infirmary_roof" ) ) )
    {
        ...
        waitframe( 1 );
        level notify( #"spawned_ghost_zombie", { #ai_ghost:level.var_558993a0 } );
        return;
    }
...
function function_59945272( s_params )
{
    if ( !isdefined( level.var_7b71cdb7 ) && isplayer( s_params.eattacker ) && ( self zm_zonemgr::entity_in_zone( "zone_cafeteria" ) || self zm_zonemgr::entity_in_zone( "zone_cafeteria_end" ) ) )
    {
        ...
        level notify( #"spawned_ghost_zombie", { #ai_ghost:level.var_7b71cdb7 } );
    }
}
...
function function_2992f8fe( e_ghost, var_5b9ba5a5 )
{
    ...
    while ( true )
    {
        ...
        {
            if ( !( isdefined( level.first_ghost_spotted ) && level.first_ghost_spotted ) )
            {
                level.first_ghost_spotted = 1;
...
function function_995231f6( s_params )
{
    if ( !isdefined( level.var_acc853e7 ) && isplayer( s_params.eattacker ) && ( self zm_zonemgr::entity_in_zone( "zone_library" ) || self zm_zonemgr::entity_in_zone( "zone_start" ) ) )
    {
        ...
        level notify( #"spawned_ghost_zombie", { #ai_ghost:level.var_acc853e7 } );
    }
}
...
function private function_b80b6749()
{
    ...
    level thread function_629fa2c8( #"ghost_banjo_pickup", level.var_9d950ce5.e_activator );
...
function function_58808acb( e_player )
{
    ...
    level thread function_629fa2c8( #"ghost_banjo_downed", e_speaker );
}
...
function private function_580723de( b_shown = 1, e_player )
{
    ...
    if ( isdefined( e_player ) )
    {
        level.var_7c9cd6ae = util::spawn_model( #"p8_zm_esc_banjo_ghost", e_player gettagorigin( "tag_stowed_back" ), e_player gettagangles( "tag_stowed_back" ) );
...
function private function_34e153c7()
{
    ...
    var_e1b1210d playsound( #"zmb_giggles_3_64_monitor_off" );
...
function function_a9c796c9( var_ad361c37 )
{
    ...
    if ( var_ad361c37 )
    {
        self playsound( #"zmb_giggles_3_64_monitor_on" );
        self playloopsound( #"zmb_giggles_3_64_monitor_lp" );
        return;
    }
    
    self stoploopsound();
    self playsound( #"zmb_giggles_3_64_monitor_off" );
}
...
function private function_3f41df11( var_aa11c23c )
{
    ...
    a_str_monitors = array( #"p8_zm_esc_comm_monitor_sml_01_screen_symbol_01", #"p8_zm_esc_comm_monitor_sml_01_screen_symbol_02", #"p8_zm_esc_comm_monitor_sml_01_screen_symbol_03", #"p8_zm_esc_comm_monitor_sml_01_screen_symbol_04", #"p8_zm_esc_comm_monitor_sml_01_screen_symbol_05", #"p8_zm_esc_comm_monitor_sml_01_screen_symbol_06", #"p8_zm_esc_comm_monitor_sml_01_screen_symbol_07", #"hash_7b808500f6070c8d", #"hash_7b808400f6070ada", #"hash_7b7cf700f603e56c", #"hash_7b7cf800f603e71f", #"hash_7b7cf900f603e8d2" );
    ...
    while ( isdefined( self.t_interact ) )
    {
        ...
        if ( isplayer( s_result.activator ) )
        {
            ...
            self playsound( #"zmb_giggles_3_64_monitor_interact" );
...
function private function_dc164d78()
{
    ...
    while ( var_56eace20 <= level.var_6ab72806 )
    {
        ...
        if ( !( isdefined( s_result.b_success ) && s_result.b_success ) )
        {
            ...
            {
                s_result.e_player playlocalsound( #"zmb_vocals_brutus_laugh" );
            }
    ...
    playsoundatposition( #"zmb_giggles_3_64_light_success", ( 0, 0, 0 ) );
    return true;
}
...
function private function_ca9ddf1b()
{
    ...
    while ( isdefined( var_e1b1210d.t_interact ) )
    {
        ...
        if ( isplayer( s_result.activator ) )
        {
            ...
            var_e1b1210d playsound( #"zmb_giggles_3_64_terminal_on" );
            var_e1b1210d playloopsound( #"zmb_giggles_3_64_terminal_lp" );
...
function private function_629fa2c8( var_5b9ba5a5, e_player )
{
    ...
    switch ( var_5b9ba5a5 )
    {
        ...
        case #"hash_1e0663f4102106fa":
            ...
            break;
        case #"ghost_banjo_pickup":
            str_vo_line = #"vox_m_quest_banjo_pickup";
            break;
        case #"ghost_banjo_downed":
...
function private function_252499a3( v_pos )
{
    ...
    while ( isdefined( mdl_orb ) )
    {
        ...
        if ( isplayer( s_result.activator ) )
        {
            playsoundatposition( #"zmb_orb_pickup", mdl_orb.origin );
