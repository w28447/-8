...
function function_e217ba73( v_pos, v_velocity )
{
    ...
    e_grenade = level.var_52d4b640 magicgrenadetype( getweapon( #"eq_frag_grenade" ), v_pos + ( 0, 0, 16 ), v_velocity );
    ...
    while ( !level flag::get( "flag_player_grabbed_catalyst_material" ) )
    {
        ...
        if ( b_success )
        {
            ...
            if ( isdefined( var_45acb524 ) )
            {
                ...
                {
                    var_de7057ea = var_45acb524.origin + ( 0, 0, 640 );
                    level.var_52d4b640 clientfield::set( "" + #"hash_7ef82b98770c5c0d", 0 );
...
function function_afb9c21c( var_74f1c6f6 )
{
    ...
    while ( true )
    {
        ...
        if ( level.var_12469d5 !== s_waitresult.attacker )
        {
...
function function_cfffc455()
{
    ...
    mdl_bile = util::spawn_model( #"hash_36f02781e6db9e53", v_loc + ( 0, 0, 1 ) );
    util::wait_network_frame();
...
function function_42c889b7( e_player )
{
    ...
    level waittill( #"spawn_crimson_scene" );
...
function function_bc8c390e()
{
    ...
    foreach ( var_bcc0d06a in var_7846fbf )
    {
        ...
        var_bcc0d06a.var_b92834ee = util::spawn_model( "tag_origin", var_bcc0d06a.origin + ( 0, 0, -16 ) );
