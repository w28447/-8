...
#using scripts\zm\zm_white_ww_quest_mk2v;
#using scripts\zm\zm_white_ww_quest_mk2x;
#using scripts\zm\zm_white_ww_quest_mk2y;
#using scripts\zm\zm_white_ww_quest_mk2z;
...
function init()
{
    ...
    level.s_ww_interact.a_s_slots[ 0 ] = { #n_state:1, #var_2153c223:level.a_w_ray_guns[ 4 ] };
    level.s_ww_interact.a_s_slots[ 1 ] = { #n_state:1, #var_2153c223:level.a_w_ray_guns[ 6 ] };
    level.s_ww_interact.a_s_slots[ 2 ] = { #n_state:1, #var_2153c223:level.a_w_ray_guns[ 8 ] };
    level.s_ww_interact.a_s_slots[ 3 ] = { #n_state:1, #var_2153c223:level.a_w_ray_guns[ 10 ] };
    a_s_ww_pickup = struct::get_array( "ww_pickup" );
    level.a_s_ww_pickup = array::sort_by_script_int( a_s_ww_pickup, 1 );
...
function function_6e0328a9()
{
    ...
    self.e_tv.name = level.var_8200dc81.name;
    self.e_tv zm_vo::vo_stop();
    self.e_tv zm_hms_util::function_6a0d675d( #"hash_6827b81ddbd26677", 0, 0 );
    
    if ( level flag::get( #"ww_code_acquired" ) )
    {
        wait 1;
        self.e_tv zm_hms_util::function_6a0d675d( #"hash_ce23c02d2c80867", 0, 0 );
    }
}
...
function function_256cc56e()
{
    ...
    zm_white_ww_quest_mk2v::start_quest();
    zm_white_ww_quest_mk2x::start_quest();
    zm_white_ww_quest_mk2y::start_quest();
    zm_white_ww_quest_mk2z::start_quest();
}

// Namespace zm_white_ww_quest_weapon/zm_white_ww_quest_weapon
// Params 1
// Checksum 0x641ec9f9, Offset: 0x1a68
// Size: 0x4b8, Type: bool
...
function function_117157d7()
{
    ...
    foreach ( s_ww_pickup in level.a_s_ww_pickup )
    {
        if ( self zm_white_computer_system::function_bcec00bc( s_ww_pickup.origin, 15, 0 ) )
        {
