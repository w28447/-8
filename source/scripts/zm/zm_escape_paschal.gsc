...
function init_clientfield()
{
    ...
    clientfield::register( "scriptmover", "" + #"lighthouse_red_beam", 1, getminbitcountfornum( 5 ), "int" );
...
function function_1af254ac()
{
    ...
    while ( true )
    {
        ...
        if ( isplayer( s_result.activator ) && isalive( s_result.activator ) )
        {
            ...
            playsoundatposition( #"zmb_orb_pickup", self.origin );
...
function function_cf51e21a()
{
    var_d388f9de = struct::get( #"s_warden_box" );
    var_d388f9de thread scene::play();
    playsoundatposition( #"zmb_sparky_switch", var_d388f9de.origin );
    wait 0.5;
    var_db15362c = var_d388f9de.scene_ents[ #"prop 1" ];
    var_db15362c clientfield::set( "" + #"hash_376c030aee1d6ccb", 2 );
    var_d7cbafba = struct::get( #"hash_32ae80e5cfea37c3" );
...
function function_1f975a04()
{
    ...
    e_player thread zm_vo::function_a2bd5a0c( #"vox_m_quest_attic_react" );
}
...
function function_fc4ee98b()
{
    ...
    zm_vo::vo_stop_all( e_player.origin, 512 );
    e_player thread zm_vo::function_a2bd5a0c( #"vox_m_quest_light_react" );
        ...
        if ( b_play_vo )
        {
            ...
            if ( b_play_vo )
            {
                ...
                if ( b_play_vo && util::get_active_players().size > 1 )
                {
                    ...
                    {
                        zm_vo::vo_stop_all( var_b63113d5.origin, 512 );
...
function private function_dc04e77e()
{
    ...
    s_seagull.mdl_seagull = util::spawn_model( #"c_t8_aml_seagull_body1_ghost", s_seagull.origin, s_seagull.angles );
...
// Size: 0x48e
function function_5d904e7d( s_bird_loc, var_a6c68ee8 = 1, var_cc91eb05 = 0 )
{
    n_item = randomint( 3 );
    level.s_bird_loc = s_bird_loc;
    ...
    s_bird_loc.mdl_bird = util::spawn_model( #"c_t8_aml_seagull_body1_ghost", s_bird.origin, s_bird.angles );
    ...
    while ( true )
    {
        if ( self.currentweapon == level.var_4e845c84 || self.currentweapon == level.var_58e17ce3 )
        {
            ...
            if ( isdefined( str_current_zone ) && isdefined( a_str_active_zones ) )
            {
                ...
                {
                    level.s_bird_loc.mdl_bird playsoundtoplayer( #"zmb_ghost_seagull", self );
                    wait 5;
                }
            }
        }
...
function private function_750df71a()
{
    ...
    while ( isdefined( var_21841d64 ) )
    {
        ...
        {
            level notify( #"kronorium_picked_up", { #e_player:s_result.activator } );
        ...
        if ( b_say )
        {
            ...
            if ( b_say )
            {
                ...
                if ( b_say && util::get_active_players().size > 1 )
                {
                    ...
                    {
                        zm_vo::vo_stop_all( var_95b25b2e.origin, 512 );
    ...
    while ( true )
    {
        if ( ( self.currentweapon == level.var_4e845c84 || self.currentweapon == level.var_58e17ce3 ) && !( isdefined( self.var_32a62723 ) && self.var_32a62723 ) )
        {
            if ( isdefined( level.s_bird_loc.mdl_bird ) && distancesquared( level.s_bird_loc.mdl_bird.origin, self.origin ) < 262144 )
            {
                ...
                if ( n_trace > 0.65 )
                {
                    zm_vo::vo_stop_all( self.origin, 512 );
                    self.var_32a62723 = self zm_vo::function_a2bd5a0c( #"vox_m_quest_icarus", 0, 1, 9999 );
                }
            }
        }
...
{
    self zm_vo::vo_stop_all( self.origin, 512 );
...
function function_9465204c( e_activator )
{
    ...
    zm_vo::vo_stop_all( e_activator.origin, 512 );
    ...
    if ( b_say && isalive( e_activator ) && !e_activator zm_characters::is_character( array( #"prt_zm_richtofen", #"prt_zm_richtofen_ofc", #"prt_zm_richtofen_whi_novials" ) ) )
    {
        ...
        {
            zm_vo::vo_stop_all( e_richtofen.origin, 768 );
        ...
        switch ( cmd )
        {
            ...
            case #"hash_39361a1fa06167ab":
                ...
                foreach ( s_loc in var_20279738 )
                {
                    ...
                    s_loc.mdl_bird_test = util::spawn_model( #"c_t8_aml_seagull_body1_ghost", a_s_birds[ 0 ].origin, a_s_birds[ 0 ].angles );
...
function private function_9e1e3766()
{
    ...
    if ( isdefined( var_3270baa7[ 0 ] ) )
    {
        ...
        var_3270baa7[ 0 ] notify( #"trigger", { #activator:a_e_players[ 0 ], #is_forced:1 } );
    }
...
function private function_ddc5b4e9()
{
    ...
    level.var_7a548c75 = util::spawn_model( #"c_t8_aml_seagull_body1_ghost", s_seagull.origin, s_seagull.angles );
...
function private function_2e3734e2()
{
    ...
    level.var_dc4013b0 thread brutus_patrol( level.s_brutus_spawn );
...
// Size: 0x1bc
function private brutus_patrol( s_brutus_spawn )
{
...
function function_9b417108( str_target, str_teleport_name, var_39e3a318 = 0 )
{
    ...
    if ( level.var_dc4013b0 ai::get_behavior_attribute( "scripted_mode" ) )
    {
        ...
        level.var_dc4013b0 brutus_patrol( level.s_brutus_spawn );
    }
}
...
function private function_26609819()
{
    ...
    while ( true )
    {
        ...
        {
            ai_dog = zombie_dog_util::spawn_single_dog( 1, undefined );
            waitframe( 1 );
        }
...
// Size: 0x15c
function private kill_brutus_patrolling()
{
    level endon( #"hash_6048c3f423fd987" );
...
function private function_8562a40f()
{
    ...
    level.var_7a548c75 playsound( #"zmb_ghost_seagull" );
    ...
    {
        e_activator playsound( #"zmb_orb_pickup" );
    }
}
...
function function_bdaf22e8( a_ents )
{
    ...
    zm_vo::vo_stop_all( a_ents[ #"brutus" ].origin, 1024 );
    
    foreach ( e_player in util::get_players() )
    {
        e_player zm_vo::vo_stop_all( e_player.origin, 512 );
    }
...
function private function_27097e44()
{
    if ( util::get_active_players().size == 1 )
    {
        ...
        {
            zm_vo::vo_stop_all( util::get_active_players()[ 0 ].origin, 512 );
    ...
    zm_vo::vo_stop_all( e_random_player.origin, 512 );
...
function private function_ddf8f11()
{
    ...
    e_random_player = array::random( util::get_active_players() );
    zm_vo::vo_stop_all( e_random_player.origin, 512 );
    e_random_player zm_vo::function_a2bd5a0c( #"vox_m_quest_ward_stun", 0, 1, 999 );
}
...
// Size: 0x164
function function_f1659bd5( n_interacts, var_a9d2fdec )
{
...
function function_4ff97a71( var_386f3ef3 )
{
    ...
    zm_vo::vo_stop_all( var_386f3ef3.origin, 512 );
...
function function_37d4f9( var_f6d24584, n_brutus = 0, var_b8fc6ea2 = 0, var_49770f00 = 0, n_zombies_max )
{
    ...
    if ( !isdefined( n_zombies_max ) )
    {
        ...
        a_s_brutus_location = struct::get_array( #"c29_brutus_location", "variantname" );
...
function function_7cfcac59()
{
    ...
    if ( isdefined( var_e083ecbd ) )
    {
        ...
        {
            zm_vo::vo_stop_all( level.var_4f538b17.origin, 512 );
        }
    }
...
function function_360daff1()
{
    ...
    if ( level.var_a36cbfaf == -2 )
    {
        ...
        mdl_portal playsoundtoteam( #"vox_m_quest_ward_port_ward_0", util::get_active_players()[ 0 ].team );
        wait soundgetplaybacktime( #"vox_m_quest_ward_port_ward_0" ) * 0.001;
...
function function_9e723e9( n_time = 3, var_57feea38 = 0 )
{
    ...
    if ( !isdefined( s_beam.mdl_beam ) )
    {
        ...
        s_beam.mdl_beam clientfield::set( "" + #"lighthouse_red_beam", 1 );
    ...
    if ( var_57feea38 )
    {
        s_beam.mdl_beam clientfield::set( "" + #"lighthouse_red_beam", level.var_3d98e258 );
        wait n_time;
    }
    ...
    if ( !var_57feea38 )
    {
        s_beam.mdl_beam clientfield::set( "" + #"lighthouse_red_beam", n_clientfield );
        wait 0.1;
    }
    ...
    if ( isdefined( var_52036da7 ) && var_52036da7 )
    {
        ...
        s_beam.mdl_beam clientfield::set( "" + #"lighthouse_red_beam", 5 );
    }
}
