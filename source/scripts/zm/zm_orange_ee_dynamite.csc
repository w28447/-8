...
function init()
{
    ...
    level._effect[ #"dynamite_zombie_explosion" ] = #"zm_ai/fx8_dynamite_zombie_explode";
    clientfield::register( "scriptmover", "" + #"dynamite_explosion_fx", 24000, 1, "counter", &play_dynamite_explosion_fx, 0, 0 );
    clientfield::register( "actor", "" + #"dynamite_zombie_aura_fx", 24000, 1, "int", &play_dynamite_zombie_aura_fx, 0, 0 );
