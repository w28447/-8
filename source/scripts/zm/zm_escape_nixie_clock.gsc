...
function function_fb0bd6b9()
{
    ...
    t_nixie_door = getent( "nixie_door_trigger", "targetname" );
    t_nixie_door thread _goodlighting_hangar_a();
...
function _goodlighting_hangar_a()
{
    ...
    playsoundatposition( #"evt_nixie_clock_open", self.origin );
...
function function_ba25a76f( n_max_time, var_62002857 = 0 )
{
    ...
    while ( n_total_time < n_max_time )
    {
        ...
        mdl_tube playsound( #"evt_nixie_clock_scroll" );
        var_cddd0f11 = n_part;
        wait 0.1;
...
function private function_15aa00e7()
{
    ...
    playsoundatposition( #"zmb_vocals_brutus_laugh", var_43b4f0a.origin );
...
function private function_f50cec70()
{
    ...
    level.var_988ed695++;
    zm_vo::vo_stop_all( s_result.e_grabber.origin, 512 );
