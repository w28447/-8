...
{
    zm_utility::function_c492c4d6( #"bathhouse", #"s_defend_area_obj_bathhouse", array( #"zone_bathhouse_outside", #"zone_bathhouse_inside" ), array( #"temple", #"spartan", #"serpent", #"forge" ), #"hash_51132818e4c5d547", #"hash_5fbf18c7a76fd791", #"hash_797bd344ce29484a", &function_fbb4cc60 );
    zm_utility::function_c492c4d6( #"offering", #"s_defend_area_obj_offering", array( #"zone_offering" ), array( #"temple", #"spartan", #"serpent", #"forge" ), #"hash_64e7a9268225aa04", #"hash_2e6557c6e7a7c024", #"hash_797bd344ce29484a", &function_fbb4cc60 );
    zm_utility::function_c492c4d6( #"amphitheater", #"s_defend_area_obj_amphitheater", array( #"zone_amphitheater" ), array( #"bathhouse", #"temple", #"offering", #"center" ), #"hash_7726ad6d8b5ad02c", #"hash_c90e11aa231f05c", #"hash_797bd344ce29484a", &function_fbb4cc60 );
    ...
    zm_utility::function_c492c4d6( #"spartan", #"s_defend_area_obj_spartan", array( #"zone_spartan_monument_east", #"zone_spartan_monument_west", #"zone_spartan_monument_upper" ), array( #"offering", #"bathhouse", #"serpent", #"forge" ), #"hash_4cd3593f18ffe83f", #"hash_7a8bc638c30d31d9", #"hash_797bd344ce29484a", &function_fbb4cc60 );
    zm_utility::function_c492c4d6( #"serpent", #"s_defend_area_obj_serpent", array( #"zone_serpent_pass_center", #"zone_serpent_pass_upper", #"zone_serpent_pass_lower" ), array( #"center", #"amphitheater", #"spartan", #"bathhouse" ), #"hash_25760f552752078b", #"hash_315f9683804aa985", #"hash_242a68e3a5256bb2", &function_1716cce9 );
    zm_utility::function_c492c4d6( #"forge", #"s_defend_area_obj_forge", array( #"zone_cliff_tombs_forge", #"zone_cliff_tombs_upper", #"zone_cliff_tombs_center", #"zone_cliff_tombs_lower" ), array( #"center", #"amphitheater", #"temple", #"offering" ), #"hash_145f1e36dfff4c6b", #"hash_dcf5f6182603525", #"hash_242a68e3a5256bb2", &function_1716cce9 );
    zm_utility::function_c492c4d6( #"center", #"s_defend_area_obj_center", array( #"zone_drakaina_arena" ), array( #"forge", #"serpent", #"amphitheater", #"spartan" ), #"hash_1232ccbc481cfd1", #"hash_3d822ba844073707", #"hash_242a68e3a5256bb2", &function_1716cce9 );
