...
{
    zm_sq::register( #"zm_jordans_painting", #"step_1", #"jordans_painting_step_1", &jordans_painting_init_step_1, &jordans_painting_cleanup_step_1 );
    zm_sq::register( #"zm_jordans_reward", #"step_1", #"jordans_reward_step_1", &jordans_reward_init_step_1, &jordans_reward_cleanup_step_1 );
    zm_sq::register( #"zm_jordans_reward", #"step_2", #"jordans_reward_step_2", &jordans_reward_init_step_2, &jordans_reward_cleanup_step_2 );
    zm_sq::register( #"zm_jordans_reward", #"step_3", #"jordans_reward_step_3", &jordans_reward_init_step_3, &jordans_reward_cleanup_step_3 );
    zm_sq::register( #"zm_jordans_reward", #"step_4", #"jordans_reward_step_4", &jordans_reward_init_step_4, &jordans_reward_cleanup_step_4 );
    zm_sq::register( #"zm_jordans_reward", #"step_5", #"jordans_reward_step_5", &jordans_reward_init_step_5, &jordans_reward_cleanup_step_5 );
}
...
// Size: 0x2a4
function jordans_reward_init_step_1( var_a276c861 )
{
...
// Size: 0x1aa
function jordans_reward_cleanup_step_1( var_a276c861, ended_early )
{
...
// Size: 0x264
function jordans_reward_init_step_2( var_a276c861 )
{
    if ( !var_a276c861 )
    {
        ...
        while ( level.var_d4854b67 < level.var_1c929a74.size )
        {
            ...
            if ( s_waitresult.candle_index === level.var_d4854b67 )
            {
                level.var_d4854b67++;
                continue;
            }
            ...
            foreach ( var_c453fc76 in level.var_1c929a74 )
            {
                if ( var_c453fc76.script_int != s_waitresult.candle_index )
                {
                    var_c453fc76 function_5a7f565a();
                }
            }
...
// Size: 0xb4
function jordans_reward_cleanup_step_2( var_a276c861, ended_early )
{
    foreach ( var_c453fc76 in level.var_1c929a74 )
    {
...
function function_b094be90( var_5cae7dc6 = 0 )
{
    if ( !self.b_lit )
    {
        ...
        self.b_lit = 1;
        level notify( #"hash_13411a5231901c2e", { #candle_index:self.script_int } );
        self notify( #"candle_relit" );
    }
...
// Size: 0x556
function jordans_reward_init_step_3( var_a276c861 )
{
    if ( !var_a276c861 )
    {
        ...
        while ( level.var_352e1e6f < level.var_a690f86.size )
        {
            ...
            if ( s_waitresult.phonograph_index === level.var_352e1e6f && s_waitresult.activator === level.var_a690f86[ s_waitresult.phonograph_index ].e_activator )
            {
                playsoundatposition( #"hash_ef68ee749dfd885" + level.var_352e1e6f, level.var_a690f86[ s_waitresult.phonograph_index ].origin );
                level.var_352e1e6f++;
                zm_unitrigger::unregister_unitrigger( level.var_a690f86[ s_waitresult.phonograph_index ].s_unitrigger_stub );
                level.var_a690f86[ s_waitresult.phonograph_index ] notify( #"step_done" );
                continue;
            }
            
            if ( isdefined( s_waitresult.phonograph_index ) )
            {
                playsoundatposition( #"hash_4ec26fe871550c11", level.var_a690f86[ s_waitresult.phonograph_index ].origin );
            }
...
// Size: 0x134
function jordans_reward_cleanup_step_3( var_a276c861, ended_early )
{
    foreach ( var_29c75f3 in level.var_a690f86 )
    {
...
function function_4c925e67()
{
    ...
    while ( true )
    {
        ...
        if ( isplayer( s_waitresult.activator ) && isdefined( level.var_3a4aa2ab ) && level.var_3a4aa2ab )
        {
            ...
            level notify( #"hash_df5cf4747eb1cf1", { #phonograph_index:var_a690f86.script_int, #activator:s_waitresult.activator } );
        }
    }
}
...
// Size: 0x2c0
function jordans_reward_init_step_4( var_a276c861 )
{
    if ( !var_a276c861 )
    {
...
// Size: 0xfa
function jordans_reward_cleanup_step_4( var_a276c861, ended_early )
{
...
// Size: 0xb2, Type: bool
function function_9215e9d( t_unitrigger, var_711067a4 )
{
...
// Size: 0x194
function jordans_reward_init_step_5( var_a276c861 )
{
...
// Size: 0x14
function jordans_reward_cleanup_step_5( var_a276c861, ended_early )
{
...
// Size: 0x34, Type: bool
function function_f84421eb( e_player_1, e_player_2, b_lowest_first )
{
    return e_player_1.var_c859fa3a > e_player_2.var_c859fa3a;
}
...
{
    self val::set( #"placeholder_jump_scare", #"freezecontrols" );
    self val::set( #"placeholder_jump_scare", "ignoreme", 1 );
    self val::set( #"placeholder_jump_scare", "takedamage", 0 );
    ...
    if ( isdefined( self ) )
    {
        self val::reset( #"placeholder_jump_scare", #"freezecontrols" );
        self val::reset( #"placeholder_jump_scare", "ignoreme" );
        self val::reset( #"placeholder_jump_scare", "takedamage" );
...
// Size: 0xbc
function jordans_painting_init_step_1( var_a276c861 )
{
...
// Size: 0x14
function jordans_painting_cleanup_step_1( var_a276c861, ended_early )
{
...
// Size: 0xdc
function function_e92918f6( t_unitrigger, s_lookat )
{
...
// Size: 0x5c, Type: bool
function function_533ca98d( t_unitrigger, var_1611e2c0 )
{
    ...
    function function_3ddf07f4()
    {
        ...
        foreach ( var_54887c6a in var_538ff835 )
        {
            if ( isdefined( var_54887c6a ) )
            {
                ...
                {
                    /#
                        iprintlnbold( "<dev string:x67>" + var_54887c6a.n_player_num + "<dev string:xac>" + var_54887c6a.var_c859fa3a + "<dev string:xc6>" );
                    #/
                }
            }
        }
