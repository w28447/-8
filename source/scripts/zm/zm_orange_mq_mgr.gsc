...
function main()
{
    ...
    zm_sq::register( #"main_quest", #"step_8_campfire_2", #"main_quest_step8", &zm_orange_mq_campfire::function_13dda28a, &zm_orange_mq_campfire::function_a874e5d0 );
    ...
    zm_sq::register( #"main_quest", #"step_10_blood_3", #"main_quest_step10", &zm_orange_mq_blood::function_8d43b840, &zm_orange_mq_blood::function_2d9e1e29 );
    zm_sq::register( #"main_quest", #"step_11_campfire_3", #"main_quest_step11", &zm_orange_mq_campfire::function_13dda28a, &zm_orange_mq_campfire::function_a874e5d0 );
    ...
    zm_sq::register( #"main_quest", #"step_13_hell", #"main_quest_step13", &zm_orange_mq_hell::function_5309464a, &zm_orange_mq_hell::function_ae270d9e );
