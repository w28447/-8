...
{
    if ( !level flag::get( #"circuit_step_started" ) || level flag::get( #"circuit_step_complete" ) )
    {
...
function function_778aec95()
{
    ...
    while ( self.var_a1edb69e < 10 )
    {
        ...
        while ( b_using && ( !level flag::get( #"circuit_step_started" ) || level flag::get( #"circuit_step_complete" ) ) )
        {
            if ( isdefined( e_who ) )
            {
...
function function_27a8604b( str_identifier )
{
    ...
    if ( level.var_bcaf8591 >= 4 )
    {
        ...
        level.e_vent_screen function_ccc74648( "string_06" );
    }
...
function function_751e9580()
{
    ...
    if ( level.var_154aee78 <= zm_round_logic::get_round_number() && level.var_bcaf8591 > 0 && ( !level flag::get( #"circuit_step_started" ) || level flag::get( #"circuit_step_complete" ) ) )
    {
        ...
        if ( level.var_154aee78 <= zm_round_logic::get_round_number() )
        {
            ...
            level.var_bcaf8591 -= 1;
            level function_7b706d1d( var_e09dd0ac );
            level.e_vent_screen function_ccc74648( "string_05" );
            waitframe( 1 );
...
function function_feab1e8a()
{
    ...
    level.e_vent_screen function_ccc74648( "string_01" );
}
...
function function_2330b278()
{
    ...
    level zm_white_util::function_6f635c39( "bunker_power_event_storage" );
    level zm_white_util::function_6f635c39( "bunker_power_event_solitary" );
    level.e_vent_screen function_ccc74648( "string_03" );
        ...
        if ( !player_is_touching )
        {
            switch ( var_e6da0a39 )
            {
                case 0:
                    ...
                    level.e_vent_screen function_ccc74648( "strong_04" );
                    break;
                case 1:
...
{
    level.e_vent_screen = getent( "vent_screen", "targetname" );
}
...
function function_3698d819()
{
    while ( true )
    {
        ...
        level.e_vent_screen function_ccc74648( "string_03" );
        wait 10;
        level.e_vent_screen function_ccc74648( "string_04" );
        wait 10;
        level.e_vent_screen function_ccc74648( "string_05" );
        wait 10;
        level.e_vent_screen function_ccc74648( "string_06" );
