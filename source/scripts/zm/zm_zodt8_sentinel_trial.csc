...
// Size: 0x124
function artifact_element_fx( localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump )
{
    switch ( newval )
    {
        case 1:
...
function camera_snow( localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump )
{
    ...
    if ( isdefined( self.var_77f256b5 ) )
    {
...
function function_2d798d9a( localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump )
{
    if ( newval )
    {
        ...
        while ( isdefined( self ) )
        {
            ...
            n_y_move = randomintrange( -64, 64 );
            n_z_move = randomintrange( -64, 64 );
            self moveto( self.origin + ( n_x_move, n_y_move, n_z_move ), randomintrange( 10, 20 ) );
...
// Size: 0x236
function water_ragdolls( localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump )
{
    if ( newval )
    {
...
// Size: 0xb0
function cold_time_fx( localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump )
{
...
// Size: 0xd4
function planet_glyph_activate( localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump )
{
    if ( newval )
    {
...
function function_b59986cf( localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump )
{
    ...
    if ( isdefined( self.var_32a8bada ) )
    {
