...
function init_flags()
{
    ...
    level flag::init( #"clock_step_complete" );
    
    for ( i = 0; i < 5 ; i++ )
    {
        level flag::init( #"clock_correct_" + i );
    }
    ...
    level flag::init( #"boss_preamble_started" );
...
function function_ba863dca()
{
    ...
    level.var_8bc5329[ 1 ][ #"flag" ] = #"canister_step_complete";
    function_f46a1855();
    level.var_8bc5329[ 2 ] = [];
    ...
    level.var_8bc5329[ 3 ][ #"flag" ] = #"server_step_complete";
...
function setclock( n_hour, n_minute, is_fast )
{
    ...
    if ( var_21d43c4d < var_ed5a0a1a )
    {
        ...
        var_97ee4db9 += var_21d43c4d * 6;
        var_f797d4af += var_21d43c4d / 2;
    }
    else
    {
        var_97ee4db9 += ( var_21d43c4d - var_ed5a0a1a ) * 6;
        var_f797d4af += ( var_21d43c4d - var_ed5a0a1a ) / 2;
    }
...
function function_c3a3c077( e_player )
{
    /#
        ...
        {
            debug2dtext( ( 960, 135, 0 ), "<dev string:x45>", ( 1, 1, 0 ), 1, ( 0, 0, 0 ), 0.5, 2, 50 );
        }
    #/
...
function function_5391159f()
{
    ...
    while ( !level flag::get( #"clock_step_complete" ) )
    {
        s_result = self.s_unitrigger.var_415347ee waittill( #"damage" );
        
        if ( s_result.mod === "MOD_MELEE" && !( isdefined( s_result.weapon.isheroweapon ) && s_result.weapon.isheroweapon ) && self.s_unitrigger.is_rotating === 0 && level flag::get( #"hash_58b6a09577af5b6d" ) && !level flag::get( #"clock_step_complete" ) && self.s_unitrigger.var_9c74d1b8 === 0 )
        {
            ...
            if ( self.s_unitrigger.n_hour == self.s_unitrigger.var_ab28dca && self.s_unitrigger.n_minute == self.s_unitrigger.var_af1cfded && self.s_unitrigger.is_selected == 1 )
            {
                ...
                if ( var_abbc737b )
                {
                    ...
                    {
                        level flag::set( #"clock_correct_" + self.s_unitrigger.n_position );
                    }
            ...
            {
                level flag::clear( #"clock_correct_" + self.s_unitrigger.n_position );
        ...
        if ( self.s_unitrigger.is_rotating == 0 )
        {
            ...
            else
            {
                ...
                /#
                    if ( level flag::get( "<dev string:x38>" ) )
                    {
                        println( "<dev string:x5c>" + self.s_unitrigger.n_position + "<dev string:x74>" + self.s_unitrigger.n_hour + "<dev string:x7f>" + self.s_unitrigger.n_minute + "<dev string:x83>" + self.s_unitrigger.var_ab28dca + "<dev string:x7f>" + self.s_unitrigger.var_af1cfded );
                    }
                #/
...
function function_5d874e07()
{
    ...
    level flag::set( #"clock_step_complete" );
}
...
{
    level endon( #"clock_step_complete" );
...
{
    if ( isplayer( s_params.eattacker ) && level flag::get( #"hash_13e9bb1de846d022" ) && !level flag::get( #"clock_step_complete" ) )
    {
    ...
    for ( i = 0; i < 6 ; i++ )
    {
        if ( level.a_s_code[ i ].is_selected === 1 )
        {
            ...
            else
            {
                ...
                var_2760389a += level.a_s_code[ i ].n_hour;
            }
            ...
            var_2760389a += level.a_s_code[ i ].n_minute;
...
function function_5a971787( e_player )
{
    ...
    {
        /#
            if ( level flag::get( "<dev string:x38>" ) && self.stub.is_selected == 1 )
            {
                debug2dtext( ( 720, 135, 0 ), "<dev string:x98>" + self.stub.n_position + "<dev string:xac>" + self.stub.var_ab28dca + "<dev string:x7f>" + self.stub.var_af1cfded, ( 1, 1, 0 ), 1, ( 0, 0, 0 ), 0.5, 1, 50 );
            }
        #/
...
function zm_white_main_quest_step1_setup( var_5ea5c94d )
{
    if ( !var_5ea5c94d )
    {
        ...
        {
            level.e_face_screen playsound( #"evt_computer_boot_up" );
        ...
        level.var_eac33019 function_2b5d562e( "static" );
        level flag::wait_till( #"clock_step_complete" );
    }
}
...
function zm_white_main_quest_step1_cleanup( var_5ea5c94d, ended_early )
{
    ...
    {
        level flag::set( #"clock_step_complete" );
        level flag::set( #"enable_countermeasure_1" );
        level flag::set( #"enable_countermeasure_2" );
        level flag::set( #"enable_countermeasure_3" );
        level flag::set( #"enable_countermeasure_4" );
        level flag::set( #"enable_countermeasure_5" );
        level flag::set( #"enable_countermeasure_6" );
    }
...
{
    level endon( #"end_game", #"mq_computer_activated", #"clock_step_complete" );
...
function zm_white_main_quest_step2_setup( var_5ea5c94d )
{
    if ( !var_5ea5c94d )
    {
        ...
        level zm_hms_util::pause_zombies( 1, 0 );
        level zm_hms_util::vo_stop_all();
        level.var_5dd0d3ff zm_hms_util::function_6a0d675d( #"vox_s2_intro", 0, 0 );
        level zm_hms_util::vo_stop_all();
...
function zm_white_main_quest_step2_cleanup( var_5ea5c94d, ended_early )
{
    if ( var_5ea5c94d || ended_early )
    {
        ...
        zm_white_computer_system::function_a3442c46( "1" );
        return;
    }
...
function zm_white_main_quest_step3_setup( var_5ea5c94d )
{
    if ( !var_5ea5c94d )
    {
        ...
        level zm_hms_util::pause_zombies( 1, 0 );
        level zm_hms_util::vo_stop_all();
        level.var_5dd0d3ff zm_hms_util::function_6a0d675d( #"vox_s3_intro", 0, 0, 1 );
        ...
        level flag::wait_till( #"canister_step_complete" );
    }
}
...
function zm_white_main_quest_step3_cleanup( var_5ea5c94d, ended_early )
{
    if ( var_5ea5c94d || ended_early )
    {
        level flag::set( #"canister_step_complete" );
        zm_white_computer_system::function_a3442c46( "2" );
        return;
    }
...
function zm_white_main_quest_step4_setup( var_5ea5c94d )
{
    if ( !var_5ea5c94d )
    {
        ...
        level zm_hms_util::pause_zombies( 1, 0 );
        level zm_hms_util::vo_stop_all();
        level.var_5dd0d3ff zm_hms_util::function_6a0d675d( #"vox_s4_intro", 0, 0, 1 );
        ...
        level flag::wait_till( #"server_step_complete" );
    }
}
...
function zm_white_main_quest_step4_cleanup( var_5ea5c94d, ended_early )
{
    if ( var_5ea5c94d || ended_early )
    {
        level flag::set( #"server_step_complete" );
        zm_white_computer_system::function_a3442c46( "3" );
        return;
    }
    ...
    {
        level zm_hms_util::vo_stop_all();
        level.var_5dd0d3ff zm_hms_util::function_6a0d675d( #"vox_s4_end", 0, 0 );
        zm_white_computer_system::function_a3442c46( "3" );
        level zm_hms_util::vo_stop_all();
...
function zm_white_main_quest_step5_setup( var_5ea5c94d )
{
    if ( !var_5ea5c94d )
    {
        ...
        level zm_hms_util::pause_zombies( 1, 0 );
        level zm_hms_util::vo_stop_all();
        level.var_5dd0d3ff thread zm_hms_util::function_6a0d675d( #"vox_s5_intro", 0, 0 );
        wait 12.75;
...
function zm_white_main_quest_step5_cleanup( var_5ea5c94d, ended_early )
{
    if ( var_5ea5c94d || ended_early )
    {
        ...
        zm_white_computer_system::function_a3442c46( "4" );
        return;
    }
...
function zm_white_main_quest_step6_setup( var_5ea5c94d )
{
    if ( !var_5ea5c94d )
    {
        ...
        level zm_hms_util::pause_zombies( 1, 0 );
        level zm_hms_util::vo_stop_all();
        level.var_5dd0d3ff zm_hms_util::function_6a0d675d( #"vox_s6_intro", 0, 0, 1 );
...
function zm_white_main_quest_step6_cleanup( var_5ea5c94d, ended_early )
{
    if ( var_5ea5c94d || ended_early )
    {
        level flag::set( #"mannequin_step_complete" );
        zm_white_computer_system::function_a3442c46( "5" );
        return;
    }
...
function zm_white_main_quest_step7_setup( var_5ea5c94d )
{
    if ( !var_5ea5c94d )
    {
        ...
        wait 1;
        level flag::set( #"boss_preamble_started" );
...
function play_outro()
{
    ...
    level thread lui::play_movie( #"zm_white_outro", "fullscreen", 1, 0, 0, #"e7f9394efa6092dc415ee0f0bbaa6598776bb52e2d4188488a873079ea76ae8c00000000000000ff", 157, 0 );
...
function zm_white_mq_crawler_setup( var_5ea5c94d )
{
    if ( !var_5ea5c94d )
    {
        level flag::set( #"crawler_step_started" );
...
function function_777fb794()
{
    ...
    while ( !level flag::get( #"crawler_step_complete" ) )
    {
        ...
        if ( isdefined( e_crawler ) )
        {
            ...
            level.var_48b5d413 += 1;
            level thread function_4acd3e02();
            
            /#
                iprintlnbold( "<dev string:x140>" );
            #/
...
{
    self endon( #"death" );
    self endon( #"wither_reached_goal" );
    self.var_8ad92463 = 0;
...
function function_bf602089()
{
    ...
    while ( !b_complete )
    {
        ...
        {
            b_complete = 1;
            self notify( #"wither_reached_goal" );
        }
...
function zm_white_mq_canister_setup( var_5ea5c94d )
{
    if ( !var_5ea5c94d )
    {
        level flag::set( #"canister_step_started" );
...
function function_3937a01d( e_player = undefined, is_adam = 0 )
{
    ...
    if ( level.var_1409b3a9 === 1 )
    {
        ...
        if ( level flag::get( #"canister_step_started" ) && !level flag::get( #"hash_4ad92dd97af40a26" ) && level flag::get( #"hash_bd08d5649673cd1" ) && level.var_5e2c12d8 === 0 )
        {
...
function function_931fd8c2()
{
    ...
    while ( true )
    {
        ...
        if ( level flag::get( #"canister_step_started" ) && !level flag::get( #"hash_4ad92dd97af40a26" ) && isplayer( s_result.attacker ) && level.var_1409b3a9 )
        {
...
{
    level flag::set( #"circuit_step_started" );
    var_c718a93c = level zm_white_portals::function_688df525();
...
{
    var_b1de144e = level flag::get( #"circuit_step_started" );
...
function zm_white_mq_server_setup( var_5ea5c94d )
{
    if ( !var_5ea5c94d )
    {
        level flag::set( #"server_step_started" );
...
function function_f340b18e()
{
    ...
    /#
        iprintlnbold( "<dev string:x22b>" + level.var_f13364b4.var_c8629019 + "<dev string:x243>" + level.var_f13364b4.var_becc7ced + "<dev string:x243>" + level.var_f13364b4.var_5beab72b );
    #/
    
    level waittill( #"hash_66ee9231ad909f7e" );
    
    /#
        iprintlnbold( "<dev string:x248>" );
    #/
    ...
    level thread zm_white_computer_system::function_6591945d();
...
// Size: 0x84
function zm_white_mq_mannequin_setup( var_5ea5c94d )
{
    if ( !var_5ea5c94d )
    {
        level flag::set( #"mannequin_step_started" );
        level mannequin_step();
        level flag::wait_till( #"mannequin_step_complete" );
        zm_white_computer_system::function_a3442c46( "5" );
    }
}
...
// Size: 0x140
function zm_white_mq_mannequin_cleanup( var_5ea5c94d, ended_early )
{
    e_mccain = getent( "atlas_ct", "targetname" );
...
function function_dd76c634()
{
    ...
    while ( !level flag::get( #"mannequin_step_complete" ) )
    {
        n_next_round += 1;
...
{
    level endon( #"orb_reached_destination" );
    b_placed = 0;
    level.var_ffda9f5d = 0;
    
    while ( !level flag::get( #"orb_reached_destination" ) )
    {
        results = self waittill( #"trigger_activated" );
        ...
        if ( level flag::get( #"hash_7c2ae917559738ec" ) && !level flag::get( #"orb_reached_destination" ) )
        {
...
function mannequin_activate( n_difficulty )
{
    ...
    while ( !self.is_complete )
    {
        ...
        /#
            ...
            if ( level flag::get( "<dev string:x38>" ) && isdefined( str_zone ) )
            {
                debug2dtext( ( 720, 135, 0 ), "<dev string:x2be>" + str_zone + "<dev string:x2d6>", ( 1, 1, 0 ), 1, ( 0, 0, 0 ), 0.5, 1, 1000 );
            }
        #/
...
function function_9840ec4a( str_type, e_who )
{
    ...
    {
        level zm_hms_util::vo_stop_all();
        level.var_5dd0d3ff zm_hms_util::function_6a0d675d( #"vox_s6_head", 0, 0 );
    }
}
...
function orb_start()
{
    ...
    if ( isdefined( e_wisp ) && isdefined( nd_start ) && isdefined( var_ef55363f ) )
    {
        ...
        var_f8b0325d = array( #"orb_path_completed", #"orb_path_aborted" );
        n_spawn_round = zm_round_logic::get_round_number();
        ...
        if ( isdefined( var_9d62fe6f ) )
        {
            ...
            {
                if ( zm_round_logic::get_round_number() >= n_spawn_round )
                {
                    ...
                    if ( is_player_touching )
                    {
                        ...
                        else
                        {
                            ...
                            n_spawn_round = zm_round_logic::get_round_number() + 1;
                            
                            /#
                                iprintlnbold( "<dev string:x310>" );
                            #/
                            
                            level flag::clear( #"orb_path_aborted" );
                            vh_wisp clientfield::set( "fx8_power_wisp_lg", 0 );
...
{
    level endon( #"orb_path_completed", #"orb_path_aborted", #"orb_reached_destination" );
    var_7b286c7b = 0;
    n_speed = 6;
    ...
    if ( isdefined( self.var_ef55363f ) )
    {
        ...
        level flag::set( #"orb_path_aborted" );
    }
}
...
{
    self waittill( #"number_line_end" );
    level notify( #"orb_reached_destination" );
    level flag::set( #"orb_reached_destination" );
