...
function __init__()
{
    ...
    clientfield::register( "allplayers", "" + #"ethereal_melee_3p", 13000, 1, "counter", &function_8f9318d5, 0, 0 );
    clientfield::register( "allplayers", "" + #"hash_4de2dbcd551f1fb7", 13000, 1, "counter", &function_680538e2, 0, 0 );
    level._effect[ #"ethereal_melee_1p" ] = #"zombie/fx8_perk_ethereal_razor_1p";
    level._effect[ #"ethereal_melee_3p" ] = #"zombie/fx8_perk_ethereal_razor_3p";
    level._effect[ #"hash_5200740c0a0b2719" ] = #"hash_2a3552f078e23d4e";
    level._effect[ #"hash_4de2dbcd551f1fb7" ] = #"hash_4741ce659d06a390";
    level._effect[ #"ethereal_melee_impact" ] = #"impacts/fx8_knife_impact_blood";
...
function function_58c4bf12( localclientnum )
{
    ...
    while ( true )
    {
        ...
        if ( str_notetrack === "razor_fx_on" && self hasperk( localclientnum, #"specialty_etherealrazor" ) )
        {
            ...
            {
                self.var_9f0aad27 = playviewmodelfx( localclientnum, level._effect[ #"ethereal_melee_1p" ], "tag_weapon_right" );
            }
            else
            {
                self.var_9f0aad27 = playviewmodelfx( localclientnum, level._effect[ #"ethereal_melee_1p" ], "tag_weapon_left" );
            }
