...
function function_610d3790( einflictor, victim, idamage, weapon )
{
    ...
    if ( isactor( einflictor ) )
    {
        ...
        {
            scoreevents::processscoreevent( #"swat_team_area_defense", attacker, victim, getweapon( #"swat_team" ) );
        }
        else
        {
            ...
            {
                scoreevents::processscoreevent( #"swat_team_area_clear", attacker, victim, getweapon( #"swat_team" ) );
            }
        }
