// gamedata/ddl/generated/groups.ddl
...
version 14 {
    ...
    struct leaderboard {
        ...
        string(16) sorttype;
        // offset 0x2a0, size 0x1
        bool initialized;
        // offset 0x2a1, size 0x1
        bool isarena;
        // offset 0x2a2, size 0x1
        bool ishardcore;
        // offset 0x2a3, size 0x5
        uint:1 __pad[5];
    };
    ...
    // idx 0 members 6 size 0x5868
    // offset 0x0, size 0x100
    string(32) ownername;
    // offset 0x100, size 0x7f8
    string(255) message;
    // offset 0x8f8, size 0x280
    string(80) description;
    // offset 0xb78, size 0x2a8
    leaderboard leaderboard;
    // offset 0xe20, size 0x4a08
    emblem emblem;
    // offset 0x5828, size 0x40
...
version 8 {
    ...
    // offset 0xb78, size 0x2a8
    leaderboard leaderboard;
    // offset 0xe20, size 0x47b0
    emblem emblem;
    // offset 0x55d0, size 0x40
    uint64 creationtimestamp;
}
...
version 7 {
    ...
    // offset 0xb78, size 0x2a8
    leaderboard leaderboard;
    // offset 0xe20, size 0x4558
    emblem emblem;
    // offset 0x5378, size 0x40
    uint64 creationtimestamp;
}
