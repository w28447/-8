// gamedata/ddl/generated/emblem.ddl
// metatable "hash_893afe727f288726"
...
version 16 {
    ...
    // idx 0 members 9 size 0x3900
    // offset 0x0, size 0x40
    uint64 xuid;
    // offset 0x40, size 0x20
    uint version;
    // offset 0x60, size 0x80
    string(16) emblemname;
    // offset 0xe0, size 0x20
    uint createtime;
    // offset 0x100, size 0x37bc
    hash_4e00feaf81ba241c emblem;
    // offset 0x38bc, size 0x2
    int:2 isused;
    // offset 0x38be, size 0x2
    int:2 readonly;
    // offset 0x38c0, size 0x20
    uint layercount;
    // offset 0x38e0, size 0x20
    int sortindex;
}
...
version 12 {
    ...
    // offset 0xe0, size 0x20
    uint createtime;
    // offset 0x100, size 0x3771
    hash_4e00feaf81ba241c emblem;
    // offset 0x3871, size 0x2
    int:2 isused;
    // offset 0x3873, size 0x2
    int:2 readonly;
    // offset 0x3875, size 0x20
    uint layercount;
    // offset 0x3895, size 0x20
    int sortindex;
}
...
version 11 {
    ...
    // offset 0xe0, size 0x20
    uint createtime;
    // offset 0x100, size 0x37b1
    hash_4e00feaf81ba241c emblem;
    // offset 0x38b1, size 0x2
    int:2 isused;
    // offset 0x38b3, size 0x2
    int:2 readonly;
    // offset 0x38b5, size 0x20
    uint layercount;
    // offset 0x38d5, size 0x20
    int sortindex;
}
...
version 10 {
    ...
    // offset 0xe0, size 0x20
    uint createtime;
    // offset 0x100, size 0x35a4
    hash_4e00feaf81ba241c emblem;
    // offset 0x36a4, size 0x2
    int:2 isused;
    // offset 0x36a6, size 0x2
    int:2 readonly;
    // offset 0x36a8, size 0x20
    uint layercount;
    // offset 0x36c8, size 0x20
    int sortindex;
}
...
version 9 {
    ...
    // offset 0xe0, size 0x20
    uint createtime;
    // offset 0x100, size 0x3559
    hash_4e00feaf81ba241c emblem;
    // offset 0x3659, size 0x2
    int:2 isused;
    // offset 0x365b, size 0x2
    int:2 readonly;
    // offset 0x365d, size 0x20
    uint layercount;
    // offset 0x367d, size 0x20
    int sortindex;
}
...
version 7 {
    ...
    uint createtime;
    // offset 0xc0, size 0x3559
    hash_4e00feaf81ba241c emblem;
    // offset 0x3619, size 0x2
    int:2 isused;
    // offset 0x361b, size 0x2
    int:2 readonly;
    // offset 0x361d, size 0x20
    uint layercount;
    // offset 0x363d, size 0x20
    int sortindex;
}
